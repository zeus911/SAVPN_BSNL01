...
String defaultErrorMessage = com.hp.ov.activator.activatorUiNLS.MsgHandler.getString("1283", "An error has been found");
...
var leftAreaWidth = document.body.clientWidth;
</script>
<%
if ( errorMessage == null || errorMessage.equals("") ) {
  errorMessage = defaultErrorMessage;
}
String message = errorMessage + (exceptionMessage != null && !exceptionMessage.equals("") ? "<br><br>*"+exceptionMessage : "");
%>
<script>
	var alert = new HPSAAlert('<%=errtitle%>','<%= message %>');
	if (leftAreaWidth<=0) {
        leftAreaWidth = 400;
    }
	alert.setBounds(leftAreaWidth, 120);
