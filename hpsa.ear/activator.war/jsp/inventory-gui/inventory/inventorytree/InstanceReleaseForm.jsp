...
<body background="/activator/images/inventory-gui/fondo.gif" style="overflow:auto;" onmousemove="logoutTimerReset();" onkeydown="logoutTimerReset();">
	<center>	
		<html:form action="/inventory/InstanceReleaseCommitAction.do">
...
<%
String  confrimtitle=com.hp.ov.activator.activatorUiNLS.MsgHandler.getString("510", "Confirm");
String cmassage=com.hp.ov.activator.activatorUiNLS.MsgHandler.getString("538", "Are you sure you want to release this bean");
String accept=com.hp.ov.activator.activatorUiNLS.MsgHandler.getString("508", "Accept");
String Scancel=com.hp.ov.activator.activatorUiNLS.MsgHandler.getString("509", "Cancel");

%>
<script>
			var confirm = new HPSAConfirm('<%=confrimtitle%>','<%=cmassage%>', '<%=accept%>', '<%=Scancel%>');
