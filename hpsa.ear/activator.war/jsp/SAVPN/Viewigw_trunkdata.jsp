...
String refreshTree = (String) request.getAttribute(igw_trunkdataConstants.REFRESH_TREE);
%>

<html>
  <head>
    <title><bean:message bundle="igw_trunkdataApplicationResources" key="<%= igw_trunkdataConstants.JSP_VIEW_TITLE %>"/></title>
...
<h2 style="width:100%; text-align:center;">
  <bean:message bundle="igw_trunkdataApplicationResources" key="jsp.view.title"/>
</h2> 
