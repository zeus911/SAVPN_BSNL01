...
String formAction = "/CreationCommitigw_qosAction.do?datasource=" + datasource + "&rimid=" + rimid;
...
<html>
  <head>
    ...
    {
      window.document.igw_qosForm.action = '/activator<%=moduleConfig%>/CreationFormigw_qosAction.do?datasource=<%= datasource %>&rimid=<%= rimid %>&_location_=' + focusthis;
      window.document.igw_qosForm.submit();
    }
    function performCommit()
    {
      window.document.igw_qosForm.action = '/activator<%=moduleConfig%>/CreationCommitigw_qosAction.do?datasource=<%= datasource %>&rimid=<%= rimid %>';
      window.document.igw_qosForm.submit();
    }
    function init()
    {
...
<h2 style="width:100%; text-align:center;">
  <bean:message bundle="igw_qosApplicationResources" key="jsp.creation.title"/>
</h2> 
