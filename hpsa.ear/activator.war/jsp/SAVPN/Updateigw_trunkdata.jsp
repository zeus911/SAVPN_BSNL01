...
String formAction = "/UpdateCommitigw_trunkdataAction.do?datasource=" + datasource + "&rimid=" + rimid;
...
if ( pk == null || pk.equals("") ) {
  pk =    request.getParameter("trunkdata_id") ;
}
...
<html>
  <head>
    ...
    {
      window.document.igw_trunkdataForm.action = '/activator<%=moduleConfig%>/UpdateFormigw_trunkdataAction.do?datasource=<%= datasource %>&rimid=<%= rimid %>&_pk_=<%=pk %>&_location_=' + focusthis;
      window.document.igw_trunkdataForm.submit();
    }
    function performCommit()
    {
      window.document.igw_trunkdataForm.action = '/activator<%=moduleConfig%>/UpdateCommitigw_trunkdataAction.do?datasource=<%= datasource %>&rimid=<%= rimid %>&_pk_=<%=pk %>';
      window.document.igw_trunkdataForm.submit();
    }
    function init()
    {
...
if(beanigw_trunkdata==null)
   beanigw_trunkdata = (com.hp.ov.activator.vpn.inventory.igw_trunkdata) request.getSession().getAttribute(igw_trunkdataConstants.IGW_TRUNKDATA_BEAN);
...
<h2 style="width:100%; text-align:center;">
  <bean:message bundle="igw_trunkdataApplicationResources" key="jsp.update.title"/>
</h2> 
      ...
      <html:hidden property="refreshTreeRimid" value="<%= (String)request.getParameter(\"refreshTreeRimid\") %>"/>
              ...
              <table:cell>
                                                      <html:hidden property="trunkdata_id" value="<%= TRUNKDATA_ID %>"/>
                                                        <html:text disabled="true" property="trunkdata_id" size="24" value="<%= TRUNKDATA_ID %>"/>
                                                </table:cell>
              <table:cell>
              ...
              <table:cell>
                                                      <html:hidden property="parent_trunkdata" value="<%= PARENT_TRUNKDATA %>"/>
                                                        <html:text disabled="true" property="parent_trunkdata" size="24" value="<%= PARENT_TRUNKDATA %>"/>
                                                </table:cell>
              <table:cell>
