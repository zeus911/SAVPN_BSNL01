...
String formAction = "/CreationCommitigw_trunktypeAction.do?datasource=" + datasource + "&rimid=" + rimid;
...
<html>
  <head>
    ...
    {
      window.document.igw_trunktypeForm.action = '/activator<%=moduleConfig%>/CreationFormigw_trunktypeAction.do?datasource=<%= datasource %>&rimid=<%= rimid %>&_location_=' + focusthis;
      window.document.igw_trunktypeForm.submit();
    }
    function performCommit()
    {
      window.document.igw_trunktypeForm.action = '/activator<%=moduleConfig%>/CreationCommitigw_trunktypeAction.do?datasource=<%= datasource %>&rimid=<%= rimid %>';
      window.document.igw_trunktypeForm.submit();
    }
    function init()
    {
...
<h2 style="width:100%; text-align:center;">
  <bean:message bundle="igw_trunktypeApplicationResources" key="jsp.creation.title"/>
</h2> 
