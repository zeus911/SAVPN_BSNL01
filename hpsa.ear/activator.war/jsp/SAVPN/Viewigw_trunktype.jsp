...
String refreshTree = (String) request.getAttribute(igw_trunktypeConstants.REFRESH_TREE);
%>

<html>
  <head>
    <title><bean:message bundle="igw_trunktypeApplicationResources" key="<%= igw_trunktypeConstants.JSP_VIEW_TITLE %>"/></title>
...
<h2 style="width:100%; text-align:center;">
  <bean:message bundle="igw_trunktypeApplicationResources" key="jsp.view.title"/>
</h2> 
