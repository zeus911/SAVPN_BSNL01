...
<html>
  <head>
    <title><bean:message bundle="GISVPNApplicationResources" key="<%= GISVPNConstants.JSP_DELETE_TITLE %>"/></title>
    ...
    {
      window.document.GISVPNForm.action = '/activator<%=moduleConfig%>/DeleteCommitGISVPNAction.do?datasource=<%= datasource %>&rimid=<%= rimid %>';
      window.document.GISVPNForm.submit();
    }
    function init()
    {
      var confirm = new HPSAConfirm('Confirm','<bean:message bundle="GISVPNApplicationResources" key="delete.confirm"/>', '<bean:message bundle="InventoryResources" key="confirm.ok_button.label"/>', '<bean:message bundle="InventoryResources" key="confirm.cancel_button.label"/>');
...
<h2 style="width:100%; text-align:center;">
    <bean:message bundle="GISVPNApplicationResources" key="jsp.delete.title"/>
</h2> 
...
%>
    ...
    <html:form action="/DeleteCommitGISVPNAction.do">
