...
ArrayList al = (ArrayList) session.getAttribute(request.getParameter(GISVPNConstants.TAB_NAME));
String useRandomColor="1";
String mainColor ="1";

String datasource = request.getParameter(GISVPNConstants.DATASOURCE);
String tabName = request.getParameter(GISVPNConstants.TAB_NAME);
...
String dummy___hide = null;

StringBuffer requestURI = new StringBuffer("/activator/jsp/inventory/SearchListGISVPN.jsp?");
...
if ( form != null ) {
  ...
  dummy___hide = form.getDummy___hide();
  ...
  if ( dummy___hide != null )
    requestURI.append("dummy___hide=" + dummy___hide);
    ...
    dummy___hide = request.getParameter("dummy___hide");
...
<html>
  <head>
    <title><bean:message bundle="GISVPNApplicationResources" key="<%= GISVPNConstants.JSP_RESULTS_TITLE %>"/></title>
  ...
  <bean:message bundle="GISVPNApplicationResources" key="jsp.search.results.title"/>
</h2> 

<display:table id="elementSearch" style="width:100%" requestURI="SearchCommitGISVPNAction.do" name="<%= searchListName %>" pagesize="10" export="true" sort="list" partialList="true" size="resultSize" decorator="com.hp.ov.activator.mwfm.servlet.inventory.inventorytree.taglib.displaytag.decorator.InventoryBuilderTableDecorator">

<%
        if ( ServiceId___hide == null || ServiceId___hide.equals("null") ) {
%>
      <display:column property="serviceid" sortable="true" titleKey="GISVPNApplicationResources:field.serviceid.alias" headerClass="tableTitle" class="tableCell"/>
<%
        }
        if ( CustomerId___hide == null || CustomerId___hide.equals("null") ) {
%>
      <display:column property="customerid" sortable="true" titleKey="GISVPNApplicationResources:field.customerid.alias" headerClass="tableTitle" class="tableCell"/>
<%
        }
        if ( ContactPerson___hide == null || ContactPerson___hide.equals("null") ) {
%>
      <display:column property="contactperson" sortable="true" titleKey="GISVPNApplicationResources:field.contactperson.alias" headerClass="tableTitle" class="tableCell"/>
<%
        }
        if ( ServiceName___hide == null || ServiceName___hide.equals("null") ) {
%>
      <display:column property="servicename" sortable="true" titleKey="GISVPNApplicationResources:field.servicename.alias" headerClass="tableTitle" class="tableCell"/>
<%
        }
        if ( InitiationDate___hide == null || InitiationDate___hide.equals("null") ) {
%>
      <display:column property="initiationdate" sortable="true" titleKey="GISVPNApplicationResources:field.initiationdate.alias" headerClass="tableTitle" class="tableCell"/>
<%
        }
        if ( ActivationDate___hide == null || ActivationDate___hide.equals("null") ) {
%>
      <display:column property="activationdate" sortable="true" titleKey="GISVPNApplicationResources:field.activationdate.alias" headerClass="tableTitle" class="tableCell"/>
<%
        }
        if ( ModificationDate___hide == null || ModificationDate___hide.equals("null") ) {
%>
      <display:column property="modificationdate" sortable="true" titleKey="GISVPNApplicationResources:field.modificationdate.alias" headerClass="tableTitle" class="tableCell"/>
<%
        }
        if ( QoSProfile_PE___hide == null || QoSProfile_PE___hide.equals("null") ) {
%>
      <display:column property="qosprofile_pe" sortable="true" titleKey="GISVPNApplicationResources:field.qosprofile_pe.alias" headerClass="tableTitle" class="tableCell"/>
<%
        }
        if ( QoSProfile_CE___hide == null || QoSProfile_CE___hide.equals("null") ) {
%>
      <display:column property="qosprofile_ce" sortable="true" titleKey="GISVPNApplicationResources:field.qosprofile_ce.alias" headerClass="tableTitle" class="tableCell"/>
<%
        }
        if ( State___hide == null || State___hide.equals("null") ) {
%>
      <display:column property="state" sortable="true" titleKey="GISVPNApplicationResources:field.state.alias" headerClass="tableTitle" class="tableCell"/>
<%
        }
        if ( Type___hide == null || Type___hide.equals("null") ) {
%>
      <display:column property="type" sortable="true" titleKey="GISVPNApplicationResources:field.type.alias" headerClass="tableTitle" class="tableCell"/>
<%
        }
        if ( AddressFamily___hide == null || AddressFamily___hide.equals("null") ) {
%>
      <display:column property="addressfamily" sortable="true" titleKey="GISVPNApplicationResources:field.addressfamily.alias" headerClass="tableTitle" class="tableCell"/>
<%
        }
        if ( VPNTopologyType___hide == null || VPNTopologyType___hide.equals("null") ) {
%>
      <display:column property="vpntopologytype" sortable="true" titleKey="GISVPNApplicationResources:field.vpntopologytype.alias" headerClass="tableTitle" class="tableCell"/>
<%
        }
        if ( Multicast___hide == null || Multicast___hide.equals("null") ) {
%>
      <display:column property="multicast" sortable="true" titleKey="GISVPNApplicationResources:field.multicast.alias" headerClass="tableTitle" class="tableCell"/>
<%
        }
        if ( ParentId___hide == null || ParentId___hide.equals("null") ) {
%>
      <display:column property="parentid" sortable="true" titleKey="GISVPNApplicationResources:field.parentid.alias" headerClass="tableTitle" class="tableCell"/>
<%
        }
        if ( Comments___hide == null || Comments___hide.equals("null") ) {
%>
      <display:column property="comments" sortable="true" titleKey="GISVPNApplicationResources:field.comments.alias" headerClass="tableTitle" class="tableCell"/>
<%
        }
        if ( dummy___hide == null || dummy___hide.equals("null") ) {
%>
      <display:column property="dummy" sortable="true" titleKey="GISVPNApplicationResources:field.dummy.alias" headerClass="tableTitle" class="tableCell"/>
<%
    }
%>
</display:table>
...
String backAction = "SearchFormGISVPNAction.do?datasource=" + datasource + "&tab_name=" + tabName + "&vi=" + viParameter + "&view=" + viewParameter + "&ndid=" + ndidParameter;
%>
...
%>
                ...
                <html:hidden property="comments___hide" value="<%= form.getComments___hide() %>"/>
                                  <html:hidden property="dummy" value="<%= form.getDummy() %>"/>
                <html:hidden property="dummy___hide" value="<%= form.getDummy___hide() %>"/>
          <%
}
  else {    
%>
                ...
                <html:hidden property="comments___hide" value="<%= request.getParameter(\"comments___hide\") %>"/>
                                  <html:hidden property="dummy" value="<%= request.getParameter(\"dummy\") %>"/>
                <html:hidden property="dummy___hide" value="<%= request.getParameter(\"dummy___hide\") %>"/>
          <%
  }
%>
    <input type="submit" value="<%= backMessage %>" onclick="window.document.GISVPNForm.submit()"/>
  </html:form>
