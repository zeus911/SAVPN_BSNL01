...
String formAction = "/CreationCommitigw_trunkAction.do?datasource=" + datasource + "&rimid=" + rimid;
...
<html>
  <head>
    ...
    {
      window.document.igw_trunkForm.action = '/activator<%=moduleConfig%>/CreationFormigw_trunkAction.do?datasource=<%= datasource %>&rimid=<%= rimid %>&_location_=' + focusthis;
      window.document.igw_trunkForm.submit();
    }
    function performCommit()
    {
      window.document.igw_trunkForm.action = '/activator<%=moduleConfig%>/CreationCommitigw_trunkAction.do?datasource=<%= datasource %>&rimid=<%= rimid %>';
      window.document.igw_trunkForm.submit();
    }
    function init()
    {
...
<h2 style="width:100%; text-align:center;">
  <bean:message bundle="igw_trunkApplicationResources" key="jsp.creation.title"/>
</h2> 
