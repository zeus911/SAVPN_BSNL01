...
String tabName = (String) request.getParameter(GISVPNConstants.TAB_NAME);
...
<script>
function clearForm() {
var formObj = document.GISVPNFormSearch;
  ...
  var checkfalse=false;
                    if(document.getElementsByName("serviceid___hide")[0].checked) {
                            ...
                            if(document.getElementsByName("parentid___hide")[0].checked) {
                                      ...
                                      if(document.getElementsByName("dummy___hide")[0].checked) {
              checkfalse=true;
                    }
                            }
                                      }
            ...
            if(checkfalse){
    alert("<bean:message bundle="GISVPNApplicationResources" key="<%= GISVPNConstants.JSP_SEARCH_NO_SHOW %>"/>");
  }else{
    window.document.GISVPNFormSearch.action = '/activator<%=moduleConfig%>/SearchCommitGISVPNAction.do?datasource=<%= datasource %>&tab_name=<%= tabName %>&vi=<%= viParameter%>&view=<%= viewParameter %>&ndid=<%= ndidParameter %>';
    window.document.GISVPNFormSearch.submit();
  }
  }
</script>
...
if (session == null || session.getValue(GISVPNConstants.USER) == null) {
  response.sendRedirect(GISVPNConstants.NULL_SESSION);
  return;
}
...
<%
      String ServiceId = form.getServiceid();
            ...
            String ParentId = form.getParentid();
              ...
              String dummy = form.getDummy();
      
%>

<h2 style="width:100%; text-align:center;">
  <bean:message bundle="GISVPNApplicationResources" key="jsp.search.title"/>
</h2> 
...
<div style="color:#ff0000;">
      <html:errors bundle="GISVPNApplicationResources" property="ServiceId"/>
        ...
        <html:errors bundle="GISVPNApplicationResources" property="__count"/>
        <html:errors bundle="GISVPNApplicationResources" property="dummy"/>
  <html:errors bundle="InventoryResources" property="warning"/>
</div>
<% String searchFormAction = "/SearchCommitGISVPNAction.do?datasource="+datasource+"&tab_name="+tabName+"&vi="+ viParameter+"&view="+ viewParameter +"&ndid="+ ndidParameter ;%>
      ...
      <table:header>
        ...
        <table:cell>
          <bean:message bundle="InventoryResources" key="description.heading"/>
            ...
            <table:cell>
              <bean:message bundle="GISVPNApplicationResources" key="field.qosprofile_ce.alias"/>
            ...
            <table:cell>
              <bean:message bundle="GISVPNApplicationResources" key="field.qosprofile_ce.description"/>
                          </table:cell>
          </table:row>
                                <table:row>
            <table:cell>
            ...
            <table:cell>
              <center>
                <html:checkbox property="dummy___hide" value="true"/>
              </center>
            </table:cell>
            ...
            <table:cell>
                              <html:text property="dummy" size="16" value="<%= dummy %>"/>
                                          </table:cell>
