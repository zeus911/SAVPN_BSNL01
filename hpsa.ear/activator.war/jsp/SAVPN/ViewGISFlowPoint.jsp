...
String refreshTree = (String) request.getAttribute(GISFlowPointConstants.REFRESH_TREE);
%>

<html>
  <head>
    <title><bean:message bundle="GISFlowPointApplicationResources" key="<%= GISFlowPointConstants.JSP_VIEW_TITLE %>"/></title>
...
<h2 style="width:100%; text-align:center;">
  <bean:message bundle="GISFlowPointApplicationResources" key="jsp.view.title"/>
</h2> 
