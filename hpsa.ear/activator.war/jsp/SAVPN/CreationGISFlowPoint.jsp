...
String formAction = "/CreationCommitGISFlowPointAction.do?datasource=" + datasource + "&rimid=" + rimid;
...
<html>
  <head>
    ...
    {
      window.document.GISFlowPointForm.action = '/activator<%=moduleConfig%>/CreationFormGISFlowPointAction.do?datasource=<%= datasource %>&rimid=<%= rimid %>&_location_=' + focusthis;
      window.document.GISFlowPointForm.submit();
    }
    function performCommit()
    {
      window.document.GISFlowPointForm.action = '/activator<%=moduleConfig%>/CreationCommitGISFlowPointAction.do?datasource=<%= datasource %>&rimid=<%= rimid %>';
      window.document.GISFlowPointForm.submit();
    }
    function init()
    {
...
<h2 style="width:100%; text-align:center;">
  <bean:message bundle="GISFlowPointApplicationResources" key="jsp.creation.title"/>
</h2> 
