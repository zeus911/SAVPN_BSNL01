...
String formAction = "/CreationCommitServiceAction.do?datasource=" + datasource + "&rimid=" + rimid;
...
<html>
  <head>
    ...
    {
      window.document.ServiceForm.action = '/activator<%=moduleConfig%>/CreationFormServiceAction.do?datasource=<%= datasource %>&rimid=<%= rimid %>&_location_=' + focusthis;
      window.document.ServiceForm.submit();
    }
    function performCommit()
    {
      window.document.ServiceForm.action = '/activator<%=moduleConfig%>/CreationCommitServiceAction.do?datasource=<%= datasource %>&rimid=<%= rimid %>';
      window.document.ServiceForm.submit();
    }
    function init()
    {
...
<h2 style="width:100%; text-align:center;">
  <bean:message bundle="ServiceApplicationResources" key="jsp.creation.title"/>
</h2> 
