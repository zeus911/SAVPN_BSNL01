...
String tabName = (String) request.getParameter(SwitchConstants.TAB_NAME);
...
<script>
function clearForm() {
var formObj = document.SwitchFormSearch;
  ...
  var checkfalse=false;
                    if(document.getElementsByName("networkid___hide")[0].checked) {
                            ...
                            if(document.getElementsByName("nnmi_lastupdate___hide")[0].checked) {
                                                                        ...
                                                                        if(checkfalse){
    alert("<bean:message bundle="SwitchApplicationResources" key="<%= SwitchConstants.JSP_SEARCH_NO_SHOW %>"/>");
  }else{
    window.document.SwitchFormSearch.action = '/activator<%=moduleConfig%>/SearchCommitSwitchAction.do?datasource=<%= datasource %>&tab_name=<%= tabName %>&vi=<%= viParameter%>&view=<%= viewParameter %>&ndid=<%= ndidParameter %>';
    window.document.SwitchFormSearch.submit();
  }
  }
</script>
...
if (session == null || session.getValue(SwitchConstants.USER) == null) {
  response.sendRedirect(SwitchConstants.NULL_SESSION);
  return;
}
...
<h2 style="width:100%; text-align:center;">
  <bean:message bundle="SwitchApplicationResources" key="jsp.search.title"/>
</h2> 
...
<div style="color:#ff0000;">
      <html:errors bundle="SwitchApplicationResources" property="NetworkId"/>
        ...
        <html:errors bundle="SwitchApplicationResources" property="NNMi_LastUpdate"/>
                <html:errors bundle="SwitchApplicationResources" property="__count"/>
        <html:errors bundle="SwitchApplicationResources" property="isDynamic"/>
  <html:errors bundle="InventoryResources" property="warning"/>
</div>
<% String searchFormAction = "/SearchCommitSwitchAction.do?datasource="+datasource+"&tab_name="+tabName+"&vi="+ viParameter+"&view="+ viewParameter +"&ndid="+ ndidParameter ;%>
