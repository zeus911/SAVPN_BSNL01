...
String refreshTree = (String) request.getAttribute(Sh_IdentifiersConstants.REFRESH_TREE);
%>

<html>
  <head>
    <title><bean:message bundle="Sh_IdentifiersApplicationResources" key="<%= Sh_IdentifiersConstants.JSP_VIEW_TITLE %>"/></title>
...
<h2 style="width:100%; text-align:center;">
  <bean:message bundle="Sh_IdentifiersApplicationResources" key="jsp.view.title"/>
</h2> 
