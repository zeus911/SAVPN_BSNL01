...
String formAction = "/CreationCommitQueue_MessageAction.do?datasource=" + datasource + "&rimid=" + rimid;
...
<html>
  <head>
    ...
    {
      window.document.Queue_MessageForm.action = '/activator<%=moduleConfig%>/CreationFormQueue_MessageAction.do?datasource=<%= datasource %>&rimid=<%= rimid %>&_location_=' + focusthis;
      window.document.Queue_MessageForm.submit();
    }
    function performCommit()
    {
      window.document.Queue_MessageForm.action = '/activator<%=moduleConfig%>/CreationCommitQueue_MessageAction.do?datasource=<%= datasource %>&rimid=<%= rimid %>';
      window.document.Queue_MessageForm.submit();
    }
    function init()
    {
...
<h2 style="width:100%; text-align:center;">
  <bean:message bundle="Queue_MessageApplicationResources" key="jsp.creation.title"/>
</h2> 
...
<html:form action="<%= formAction %>" style="text-align:center;">
    <table:table>
      ...
      <html:hidden property="refreshTreeRimid" value="<%= (String)request.getParameter(\"refreshTreeRimid\") %>"/>
              ...
              <table:cell>
                                                                        <html:textarea  property="message" cols="60" rows="10" value="<%= Message %>" style="resize:true;"/>
                                                </table:cell>
              <table:cell>
