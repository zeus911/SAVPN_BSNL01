...
String refreshTree = (String) request.getAttribute(ISPConstants.REFRESH_TREE);
%>

<html>
  <head>
    <title><bean:message bundle="ISPApplicationResources" key="<%= ISPConstants.JSP_VIEW_TITLE %>"/></title>
...
<h2 style="width:100%; text-align:center;">
  <bean:message bundle="ISPApplicationResources" key="jsp.view.title"/>
</h2> 
