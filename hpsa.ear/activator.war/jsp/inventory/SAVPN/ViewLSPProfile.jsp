...
String refreshTree = (String) request.getAttribute(LSPProfileConstants.REFRESH_TREE);
%>

<html>
  <head>
    <title><bean:message bundle="LSPProfileApplicationResources" key="<%= LSPProfileConstants.JSP_VIEW_TITLE %>"/></title>
...
<h2 style="width:100%; text-align:center;">
  <bean:message bundle="LSPProfileApplicationResources" key="jsp.view.title"/>
</h2> 
