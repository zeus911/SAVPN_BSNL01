...
String formAction = "/CreationCommitSh_FlowPointAction.do?datasource=" + datasource + "&rimid=" + rimid;
...
<html>
  <head>
    ...
    {
      window.document.Sh_FlowPointForm.action = '/activator<%=moduleConfig%>/CreationFormSh_FlowPointAction.do?datasource=<%= datasource %>&rimid=<%= rimid %>&_location_=' + focusthis;
      window.document.Sh_FlowPointForm.submit();
    }
    function performCommit()
    {
      window.document.Sh_FlowPointForm.action = '/activator<%=moduleConfig%>/CreationCommitSh_FlowPointAction.do?datasource=<%= datasource %>&rimid=<%= rimid %>';
      window.document.Sh_FlowPointForm.submit();
    }
    function init()
    {
...
<h2 style="width:100%; text-align:center;">
  <bean:message bundle="Sh_FlowPointApplicationResources" key="jsp.creation.title"/>
</h2> 
