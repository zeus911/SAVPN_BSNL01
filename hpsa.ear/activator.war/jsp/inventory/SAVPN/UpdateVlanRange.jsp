...
String formAction = "/UpdateCommitVlanRangeAction.do?datasource=" + datasource + "&rimid=" + rimid;
...
if ( pk == null || pk.equals("") ) {
  pk =    request.getParameter("vlanrangeid") + "||" + request.getParameter("usage") + "||" + request.getParameter("allocation") + "||" + request.getParameter("region") ;
}
...
<html>
  <head>
    ...
    {
      window.document.VlanRangeForm.action = '/activator<%=moduleConfig%>/UpdateFormVlanRangeAction.do?datasource=<%= datasource %>&rimid=<%= rimid %>&_pk_=<%=pk %>&_location_=' + focusthis;
      window.document.VlanRangeForm.submit();
    }
    function performCommit()
    {
      window.document.VlanRangeForm.action = '/activator<%=moduleConfig%>/UpdateCommitVlanRangeAction.do?datasource=<%= datasource %>&rimid=<%= rimid %>&_pk_=<%=pk %>';
      window.document.VlanRangeForm.submit();
    }
    function init()
    {
...
if(beanVlanRange==null)
   beanVlanRange = (com.hp.ov.activator.vpn.inventory.VlanRange) request.getSession().getAttribute(VlanRangeConstants.VLANRANGE_BEAN);
...
<h2 style="width:100%; text-align:center;">
  <bean:message bundle="VlanRangeApplicationResources" key="jsp.update.title"/>
</h2> 
