...
ArrayList al = (ArrayList) session.getAttribute(request.getParameter(Sh_NetworkElementConstants.TAB_NAME));
String useRandomColor="1";
String mainColor ="1";

String datasource = request.getParameter(Sh_NetworkElementConstants.DATASOURCE);
String tabName = request.getParameter(Sh_NetworkElementConstants.TAB_NAME);
...
StringBuffer requestURI = new StringBuffer("/activator/jsp/inventory/SearchListSh_NetworkElement.jsp?");
...
<html>
  <head>
    <title><bean:message bundle="Sh_NetworkElementApplicationResources" key="<%= Sh_NetworkElementConstants.JSP_RESULTS_TITLE %>"/></title>
  ...
  <bean:message bundle="Sh_NetworkElementApplicationResources" key="jsp.search.results.title"/>
</h2> 

<display:table id="elementSearch" style="width:100%" requestURI="SearchCommitSh_NetworkElementAction.do" name="<%= searchListName %>" pagesize="10" export="true" sort="list" partialList="true" size="resultSize" decorator="com.hp.ov.activator.mwfm.servlet.inventory.inventorytree.taglib.displaytag.decorator.InventoryBuilderTableDecorator">

<%
        if ( NetworkElementID___hide == null || NetworkElementID___hide.equals("null") ) {
%>
      <display:column property="networkelementid" sortable="true" titleKey="Sh_NetworkElementApplicationResources:field.networkelementid.alias" headerClass="tableTitle" class="tableCell"/>
<%
        }
        if ( NetworkID___hide == null || NetworkID___hide.equals("null") ) {
%>
      <display:column property="networkid" sortable="true" titleKey="Sh_NetworkElementApplicationResources:field.networkid.alias" headerClass="tableTitle" class="tableCell"/>
<%
        }
        if ( Name___hide == null || Name___hide.equals("null") ) {
%>
      <display:column property="name" sortable="true" titleKey="Sh_NetworkElementApplicationResources:field.name.alias" headerClass="tableTitle" class="tableCell"/>
<%
        }
        if ( Description___hide == null || Description___hide.equals("null") ) {
%>
      <display:column property="description" sortable="true" titleKey="Sh_NetworkElementApplicationResources:field.description.alias" headerClass="tableTitle" class="tableCell"/>
<%
        }
        if ( Location___hide == null || Location___hide.equals("null") ) {
%>
      <display:column property="location" sortable="true" titleKey="Sh_NetworkElementApplicationResources:field.location.alias" headerClass="tableTitle" class="tableCell"/>
<%
        }
        if ( IP___hide == null || IP___hide.equals("null") ) {
%>
      <display:column property="ip" sortable="true" titleKey="Sh_NetworkElementApplicationResources:field.ip.alias" headerClass="tableTitle" class="tableCell"/>
<%
        }
        if ( management_IP___hide == null || management_IP___hide.equals("null") ) {
%>
      <display:column property="management_ip" sortable="true" titleKey="Sh_NetworkElementApplicationResources:field.management_ip.alias" headerClass="tableTitle" class="tableCell"/>
<%
        }
        if ( ManagementInterface___hide == null || ManagementInterface___hide.equals("null") ) {
%>
      <display:column property="managementinterface" sortable="true" titleKey="Sh_NetworkElementApplicationResources:field.managementinterface.alias" headerClass="tableTitle" class="tableCell"/>
<%
        }
        if ( UsernameEnabled___hide == null || UsernameEnabled___hide.equals("null") ) {
%>
      <display:column property="usernameenabled" sortable="true" titleKey="Sh_NetworkElementApplicationResources:field.usernameenabled.alias" headerClass="tableTitle" class="tableCell"/>
<%
        }
        if ( Username___hide == null || Username___hide.equals("null") ) {
%>
      <display:column property="username" sortable="true" titleKey="Sh_NetworkElementApplicationResources:field.username.alias" headerClass="tableTitle" class="tableCell"/>
<%
        }
        if ( Vendor___hide == null || Vendor___hide.equals("null") ) {
%>
      <display:column property="vendor" sortable="true" titleKey="Sh_NetworkElementApplicationResources:field.vendor.alias" headerClass="tableTitle" class="tableCell"/>
<%
        }
        if ( OSversion___hide == null || OSversion___hide.equals("null") ) {
%>
      <display:column property="osversion" sortable="true" titleKey="Sh_NetworkElementApplicationResources:field.osversion.alias" headerClass="tableTitle" class="tableCell"/>
<%
        }
        if ( ElementType___hide == null || ElementType___hide.equals("null") ) {
%>
      <display:column property="elementtype" sortable="true" titleKey="Sh_NetworkElementApplicationResources:field.elementtype.alias" headerClass="tableTitle" class="tableCell"/>
<%
        }
        if ( SerialNumber___hide == null || SerialNumber___hide.equals("null") ) {
%>
      <display:column property="serialnumber" sortable="true" titleKey="Sh_NetworkElementApplicationResources:field.serialnumber.alias" headerClass="tableTitle" class="tableCell"/>
<%
        }
        if ( Role___hide == null || Role___hide.equals("null") ) {
%>
      <display:column property="role" sortable="true" titleKey="Sh_NetworkElementApplicationResources:field.role.alias" headerClass="tableTitle" class="tableCell"/>
<%
        }
        if ( State___hide == null || State___hide.equals("null") ) {
%>
      <display:column property="state" sortable="true" titleKey="Sh_NetworkElementApplicationResources:field.state.alias" headerClass="tableTitle" class="tableCell"/>
<%
        }
        if ( LifeCycleState___hide == null || LifeCycleState___hide.equals("null") ) {
%>
      <display:column property="lifecyclestate" sortable="true" titleKey="Sh_NetworkElementApplicationResources:field.lifecyclestate.alias" headerClass="tableTitle" class="tableCell"/>
<%
        }
        if ( Backup___hide == null || Backup___hide.equals("null") ) {
%>
      <display:column property="backup" sortable="true" titleKey="Sh_NetworkElementApplicationResources:field.backup.alias" headerClass="tableTitle" class="tableCell"/>
<%
        }
        if ( SchPolicyName___hide == null || SchPolicyName___hide.equals("null") ) {
%>
      <display:column property="schpolicyname" sortable="true" titleKey="Sh_NetworkElementApplicationResources:field.schpolicyname.alias" headerClass="tableTitle" class="tableCell"/>
<%
        }
        if ( ROCommunity___hide == null || ROCommunity___hide.equals("null") ) {
%>
      <display:column property="rocommunity" sortable="true" titleKey="Sh_NetworkElementApplicationResources:field.rocommunity.alias" headerClass="tableTitle" class="tableCell"/>
<%
        }
        if ( RWCommunity___hide == null || RWCommunity___hide.equals("null") ) {
%>
      <display:column property="rwcommunity" sortable="true" titleKey="Sh_NetworkElementApplicationResources:field.rwcommunity.alias" headerClass="tableTitle" class="tableCell"/>
<%
        }
        if ( Managed___hide == null || Managed___hide.equals("null") ) {
%>
      <display:column property="managed" sortable="true" titleKey="Sh_NetworkElementApplicationResources:field.managed.alias" headerClass="tableTitle" class="tableCell"/>
<%
        }
        if ( Present___hide == null || Present___hide.equals("null") ) {
%>
      <display:column property="present" sortable="true" titleKey="Sh_NetworkElementApplicationResources:field.present.alias" headerClass="tableTitle" class="tableCell"/>
<%
        }
        if ( Marker___hide == null || Marker___hide.equals("null") ) {
%>
      <display:column property="marker" sortable="true" titleKey="Sh_NetworkElementApplicationResources:field.marker.alias" headerClass="tableTitle" class="tableCell"/>
<%
        }
        if ( UploadStatus___hide == null || UploadStatus___hide.equals("null") ) {
%>
      <display:column property="uploadstatus" sortable="true" titleKey="Sh_NetworkElementApplicationResources:field.uploadstatus.alias" headerClass="tableTitle" class="tableCell"/>
<%
        }
        if ( DBPrimaryKey___hide == null || DBPrimaryKey___hide.equals("null") ) {
%>
      <display:column property="dbprimarykey" sortable="true" titleKey="Sh_NetworkElementApplicationResources:field.dbprimarykey.alias" headerClass="tableTitle" class="tableCell"/>
<%
    }
%>
</display:table>
...
String backAction = "SearchFormSh_NetworkElementAction.do?datasource=" + datasource + "&tab_name=" + tabName + "&vi=" + viParameter + "&view=" + viewParameter + "&ndid=" + ndidParameter;
%>
...
%>
    <input type="submit" value="<%= backMessage %>" onclick="window.document.Sh_NetworkElementForm.submit()"/>
  </html:form>
