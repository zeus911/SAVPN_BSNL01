...
String formAction = "/UpdateCommitSh_QoSProfileAction.do?datasource=" + datasource + "&rimid=" + rimid;
...
<html>
  <head>
    ...
    {
      window.document.Sh_QoSProfileForm.action = '/activator<%=moduleConfig%>/UpdateFormSh_QoSProfileAction.do?datasource=<%= datasource %>&rimid=<%= rimid %>&_pk_=<%=pk %>&_location_=' + focusthis;
      window.document.Sh_QoSProfileForm.submit();
    }
    function performCommit()
    {
      window.document.Sh_QoSProfileForm.action = '/activator<%=moduleConfig%>/UpdateCommitSh_QoSProfileAction.do?datasource=<%= datasource %>&rimid=<%= rimid %>&_pk_=<%=pk %>';
      window.document.Sh_QoSProfileForm.submit();
    }
    function init()
    {
...
if(beanSh_QoSProfile==null)
   beanSh_QoSProfile = (com.hp.ov.activator.vpn.inventory.Sh_QoSProfile) request.getSession().getAttribute(Sh_QoSProfileConstants.SH_QOSPROFILE_BEAN);
...
<h2 style="width:100%; text-align:center;">
  <bean:message bundle="Sh_QoSProfileApplicationResources" key="jsp.update.title"/>
</h2> 
