...
String refreshTree = (String) request.getAttribute(PolicyMappingConstants.REFRESH_TREE);
%>

<html>
  <head>
    <title><bean:message bundle="PolicyMappingApplicationResources" key="<%= PolicyMappingConstants.JSP_VIEW_TITLE %>"/></title>
...
<h2 style="width:100%; text-align:center;">
  <bean:message bundle="PolicyMappingApplicationResources" key="jsp.view.title"/>
</h2> 
