...
String refreshTree = (String) request.getAttribute(Sh_L3AccessFlowConstants.REFRESH_TREE);
%>

<html>
  <head>
    <title><bean:message bundle="Sh_L3AccessFlowApplicationResources" key="<%= Sh_L3AccessFlowConstants.JSP_VIEW_TITLE %>"/></title>
...
<h2 style="width:100%; text-align:center;">
  <bean:message bundle="Sh_L3AccessFlowApplicationResources" key="jsp.view.title"/>
</h2> 
