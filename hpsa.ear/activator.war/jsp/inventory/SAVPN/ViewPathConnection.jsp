...
String refreshTree = (String) request.getAttribute(PathConnectionConstants.REFRESH_TREE);
%>

<html>
  <head>
    <title><bean:message bundle="PathConnectionApplicationResources" key="<%= PathConnectionConstants.JSP_VIEW_TITLE %>"/></title>
...
<h2 style="width:100%; text-align:center;">
  <bean:message bundle="PathConnectionApplicationResources" key="jsp.view.title"/>
</h2> 
