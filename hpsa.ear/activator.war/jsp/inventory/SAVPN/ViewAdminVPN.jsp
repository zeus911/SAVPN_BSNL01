...
String refreshTree = (String) request.getAttribute(AdminVPNConstants.REFRESH_TREE);
%>

<html>
  <head>
    <title><bean:message bundle="AdminVPNApplicationResources" key="<%= AdminVPNConstants.JSP_VIEW_TITLE %>"/></title>
...
<h2 style="width:100%; text-align:center;">
  <bean:message bundle="AdminVPNApplicationResources" key="jsp.view.title"/>
</h2> 
