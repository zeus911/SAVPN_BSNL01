...
String formAction = "/CreationCommitSh_ServiceAction.do?datasource=" + datasource + "&rimid=" + rimid;
...
<html>
  <head>
    ...
    {
      window.document.Sh_ServiceForm.action = '/activator<%=moduleConfig%>/CreationFormSh_ServiceAction.do?datasource=<%= datasource %>&rimid=<%= rimid %>&_location_=' + focusthis;
      window.document.Sh_ServiceForm.submit();
    }
    function performCommit()
    {
      window.document.Sh_ServiceForm.action = '/activator<%=moduleConfig%>/CreationCommitSh_ServiceAction.do?datasource=<%= datasource %>&rimid=<%= rimid %>';
      window.document.Sh_ServiceForm.submit();
    }
    function init()
    {
...
<h2 style="width:100%; text-align:center;">
  <bean:message bundle="Sh_ServiceApplicationResources" key="jsp.creation.title"/>
</h2> 
