...
String formAction = "/UpdateCommitSh_VPNFPMembershipAction.do?datasource=" + datasource + "&rimid=" + rimid;
...
if ( pk == null || pk.equals("") ) {
  pk =    request.getParameter("vpnid") + "||" + request.getParameter("flowpointid") ;
}
...
<html>
  <head>
    ...
    {
      window.document.Sh_VPNFPMembershipForm.action = '/activator<%=moduleConfig%>/UpdateFormSh_VPNFPMembershipAction.do?datasource=<%= datasource %>&rimid=<%= rimid %>&_pk_=<%=pk %>&_location_=' + focusthis;
      window.document.Sh_VPNFPMembershipForm.submit();
    }
    function performCommit()
    {
      window.document.Sh_VPNFPMembershipForm.action = '/activator<%=moduleConfig%>/UpdateCommitSh_VPNFPMembershipAction.do?datasource=<%= datasource %>&rimid=<%= rimid %>&_pk_=<%=pk %>';
      window.document.Sh_VPNFPMembershipForm.submit();
    }
    function init()
    {
...
if(beanSh_VPNFPMembership==null)
   beanSh_VPNFPMembership = (com.hp.ov.activator.vpn.inventory.Sh_VPNFPMembership) request.getSession().getAttribute(Sh_VPNFPMembershipConstants.SH_VPNFPMEMBERSHIP_BEAN);
...
<h2 style="width:100%; text-align:center;">
  <bean:message bundle="Sh_VPNFPMembershipApplicationResources" key="jsp.update.title"/>
</h2> 
...
<input type="hidden" name="_update_commit_" value="true"/> 
    <table:table>
      ...
      <html:hidden property="refreshTreeRimid" value="<%= (String)request.getParameter(\"refreshTreeRimid\") %>"/>
              ...
              <table:cell>
                                                      <html:hidden property="flowpointid" value="<%= FlowPointId %>"/>
                                                        <html:text disabled="true" property="flowpointid" size="24" value="<%= FlowPointId %>"/>
                                                </table:cell>
              <table:cell>
