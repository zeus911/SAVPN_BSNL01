...
String refreshTree = (String) request.getAttribute(DeactivationMappingConstants.REFRESH_TREE);
%>

<html>
  <head>
    <title><bean:message bundle="DeactivationMappingApplicationResources" key="<%= DeactivationMappingConstants.JSP_VIEW_TITLE %>"/></title>
...
<h2 style="width:100%; text-align:center;">
  <bean:message bundle="DeactivationMappingApplicationResources" key="jsp.view.title"/>
</h2> 
