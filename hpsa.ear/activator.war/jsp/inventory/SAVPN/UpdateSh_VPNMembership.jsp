...
String formAction = "/UpdateCommitSh_VPNMembershipAction.do?datasource=" + datasource + "&rimid=" + rimid;
...
<html>
  <head>
    ...
    {
      window.document.Sh_VPNMembershipForm.action = '/activator<%=moduleConfig%>/UpdateFormSh_VPNMembershipAction.do?datasource=<%= datasource %>&rimid=<%= rimid %>&_pk_=<%=pk %>&_location_=' + focusthis;
      window.document.Sh_VPNMembershipForm.submit();
    }
    function performCommit()
    {
      window.document.Sh_VPNMembershipForm.action = '/activator<%=moduleConfig%>/UpdateCommitSh_VPNMembershipAction.do?datasource=<%= datasource %>&rimid=<%= rimid %>&_pk_=<%=pk %>';
      window.document.Sh_VPNMembershipForm.submit();
    }
    function init()
    {
...
if(beanSh_VPNMembership==null)
   beanSh_VPNMembership = (com.hp.ov.activator.vpn.inventory.Sh_VPNMembership) request.getSession().getAttribute(Sh_VPNMembershipConstants.SH_VPNMEMBERSHIP_BEAN);
...
<h2 style="width:100%; text-align:center;">
  <bean:message bundle="Sh_VPNMembershipApplicationResources" key="jsp.update.title"/>
</h2> 
