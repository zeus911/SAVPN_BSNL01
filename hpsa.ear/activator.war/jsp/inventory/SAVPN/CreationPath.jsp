...
String formAction = "/CreationCommitPathAction.do?datasource=" + datasource + "&rimid=" + rimid;
...
<html>
  <head>
    ...
    {
      window.document.PathForm.action = '/activator<%=moduleConfig%>/CreationFormPathAction.do?datasource=<%= datasource %>&rimid=<%= rimid %>&_location_=' + focusthis;
      window.document.PathForm.submit();
    }
    function performCommit()
    {
      window.document.PathForm.action = '/activator<%=moduleConfig%>/CreationCommitPathAction.do?datasource=<%= datasource %>&rimid=<%= rimid %>';
      window.document.PathForm.submit();
    }
    function init()
    {
...
<h2 style="width:100%; text-align:center;">
  <bean:message bundle="PathApplicationResources" key="jsp.creation.title"/>
</h2> 
