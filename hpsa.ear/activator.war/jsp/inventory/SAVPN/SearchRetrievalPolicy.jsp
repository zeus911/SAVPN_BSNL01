...
String tabName = (String) request.getParameter(RetrievalPolicyConstants.TAB_NAME);
...
<script>
function clearForm() {
var formObj = document.RetrievalPolicyFormSearch;
...
if (element.type == 'select-one') { element.selectedIndex = -1; }
  ...
  var checkfalse=false;
                    if(document.getElementsByName("retrievalpolicyname___hide")[0].checked) {
                            if(document.getElementsByName("firstmethod___hide")[0].checked) {
                            if(document.getElementsByName("secondmethod___hide")[0].checked) {
                            if(document.getElementsByName("thirdmethod___hide")[0].checked) {
              checkfalse=true;
                    }
                            }
                            }
            ...
            if(checkfalse){
    alert("<bean:message bundle="RetrievalPolicyApplicationResources" key="<%= RetrievalPolicyConstants.JSP_SEARCH_NO_SHOW %>"/>");
  }else{
    window.document.RetrievalPolicyFormSearch.action = '/activator<%=moduleConfig%>/SearchCommitRetrievalPolicyAction.do?datasource=<%= datasource %>&tab_name=<%= tabName %>&vi=<%= viParameter%>&view=<%= viewParameter %>&ndid=<%= ndidParameter %>';
    window.document.RetrievalPolicyFormSearch.submit();
  }
  }
</script>
...
if (session == null || session.getValue(RetrievalPolicyConstants.USER) == null) {
  response.sendRedirect(RetrievalPolicyConstants.NULL_SESSION);
  return;
}
...
<%
      String RetrievalPolicyName = form.getRetrievalpolicyname();
            String FirstMethod = form.getFirstmethod();
            String SecondMethod = form.getSecondmethod();
            String ThirdMethod = form.getThirdmethod();
      
%>

<h2 style="width:100%; text-align:center;">
  <bean:message bundle="RetrievalPolicyApplicationResources" key="jsp.search.title"/>
</h2> 
...
<% String searchFormAction = "/SearchCommitRetrievalPolicyAction.do?datasource="+datasource+"&tab_name="+tabName+"&vi="+ viParameter+"&view="+ viewParameter +"&ndid="+ ndidParameter ;%>
      ...
      <table:header>
        ...
        <table:cell>
          <bean:message bundle="InventoryResources" key="description.heading"/>
            ...
            <table:cell>
              <center>
                <html:checkbox property="firstmethod___hide" value="true"/>
              </center>
            </table:cell>
            ...
            <table:cell>
                              <html:text property="firstmethod" size="16" value="<%= FirstMethod %>"/>
                                          </table:cell>
            ...
            <table:cell>
              <center>
                <html:checkbox property="secondmethod___hide" value="true"/>
              </center>
            </table:cell>
            ...
            <table:cell>
                              <html:text property="secondmethod" size="16" value="<%= SecondMethod %>"/>
                                          </table:cell>
            ...
            <table:cell>
              <center>
                <html:checkbox property="thirdmethod___hide" value="true"/>
              </center>
            </table:cell>
            ...
            <table:cell>
                              <html:text property="thirdmethod" size="16" value="<%= ThirdMethod %>"/>
                                          </table:cell>
