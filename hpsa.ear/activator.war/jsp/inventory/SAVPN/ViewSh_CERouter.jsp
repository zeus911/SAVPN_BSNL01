...
String refreshTree = (String) request.getAttribute(Sh_CERouterConstants.REFRESH_TREE);
%>

<html>
  <head>
    <title><bean:message bundle="Sh_CERouterApplicationResources" key="<%= Sh_CERouterConstants.JSP_VIEW_TITLE %>"/></title>
...
<h2 style="width:100%; text-align:center;">
  <bean:message bundle="Sh_CERouterApplicationResources" key="jsp.view.title"/>
</h2> 
