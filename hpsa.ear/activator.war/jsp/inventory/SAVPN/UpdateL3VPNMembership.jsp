...
String formAction = "/UpdateCommitL3VPNMembershipAction.do?datasource=" + datasource + "&rimid=" + rimid;
...
<html>
  <head>
    ...
    {
      window.document.L3VPNMembershipForm.action = '/activator<%=moduleConfig%>/UpdateFormL3VPNMembershipAction.do?datasource=<%= datasource %>&rimid=<%= rimid %>&_pk_=<%=pk %>&_location_=' + focusthis;
      window.document.L3VPNMembershipForm.submit();
    }
    function performCommit()
    {
      window.document.L3VPNMembershipForm.action = '/activator<%=moduleConfig%>/UpdateCommitL3VPNMembershipAction.do?datasource=<%= datasource %>&rimid=<%= rimid %>&_pk_=<%=pk %>';
      window.document.L3VPNMembershipForm.submit();
    }
    function init()
    {
...
if(beanL3VPNMembership==null)
   beanL3VPNMembership = (com.hp.ov.activator.vpn.inventory.L3VPNMembership) request.getSession().getAttribute(L3VPNMembershipConstants.L3VPNMEMBERSHIP_BEAN);
...
<h2 style="width:100%; text-align:center;">
  <bean:message bundle="L3VPNMembershipApplicationResources" key="jsp.update.title"/>
</h2> 
