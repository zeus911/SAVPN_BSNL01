...
ArrayList al = (ArrayList) session.getAttribute(request.getParameter(CERouterConstants.TAB_NAME));
String useRandomColor="1";
String mainColor ="1";

String datasource = request.getParameter(CERouterConstants.DATASOURCE);
String tabName = request.getParameter(CERouterConstants.TAB_NAME);
...
StringBuffer requestURI = new StringBuffer("/activator/jsp/inventory/SearchListCERouter.jsp?");
...
<html>
  <head>
    <title><bean:message bundle="CERouterApplicationResources" key="<%= CERouterConstants.JSP_RESULTS_TITLE %>"/></title>
  ...
  <bean:message bundle="CERouterApplicationResources" key="jsp.search.results.title"/>
</h2> 

<display:table id="elementSearch" style="width:100%" requestURI="SearchCommitCERouterAction.do" name="<%= searchListName %>" pagesize="10" export="true" sort="list" partialList="true" size="resultSize" decorator="com.hp.ov.activator.mwfm.servlet.inventory.inventorytree.taglib.displaytag.decorator.InventoryBuilderTableDecorator">

<%
        if ( NetworkId___hide == null || NetworkId___hide.equals("null") ) {
%>
      <display:column property="networkid" sortable="true" titleKey="CERouterApplicationResources:field.networkid.alias" headerClass="tableTitle" class="tableCell"/>
<%
        }
        if ( NetworkElementId___hide == null || NetworkElementId___hide.equals("null") ) {
%>
      <display:column property="networkelementid" sortable="true" titleKey="CERouterApplicationResources:field.networkelementid.alias" headerClass="tableTitle" class="tableCell"/>
<%
        }
        if ( Name___hide == null || Name___hide.equals("null") ) {
%>
      <display:column property="name" sortable="true" titleKey="CERouterApplicationResources:field.name.alias" headerClass="tableTitle" class="tableCell"/>
<%
        }
        if ( Description___hide == null || Description___hide.equals("null") ) {
%>
      <display:column property="description" sortable="true" titleKey="CERouterApplicationResources:field.description.alias" headerClass="tableTitle" class="tableCell"/>
<%
        }
        if ( Location___hide == null || Location___hide.equals("null") ) {
%>
      <display:column property="location" sortable="true" titleKey="CERouterApplicationResources:field.location.alias" headerClass="tableTitle" class="tableCell"/>
<%
        }
        if ( IP___hide == null || IP___hide.equals("null") ) {
%>
      <display:column property="ip" sortable="true" titleKey="CERouterApplicationResources:field.ip.alias" headerClass="tableTitle" class="tableCell"/>
<%
        }
        if ( Management_IP___hide == null || Management_IP___hide.equals("null") ) {
%>
      <display:column property="management_ip" sortable="true" titleKey="CERouterApplicationResources:field.management_ip.alias" headerClass="tableTitle" class="tableCell"/>
<%
        }
        if ( ManagementInterface___hide == null || ManagementInterface___hide.equals("null") ) {
%>
      <display:column property="managementinterface" sortable="true" titleKey="CERouterApplicationResources:field.managementinterface.alias" headerClass="tableTitle" class="tableCell"/>
<%
        }
        if ( PWPolicyEnabled___hide == null || PWPolicyEnabled___hide.equals("null") ) {
%>
      <display:column property="pwpolicyenabled" sortable="true" titleKey="CERouterApplicationResources:field.pwpolicyenabled.alias" headerClass="tableTitle" class="tableCell"/>
<%
        }
        if ( PWPolicy___hide == null || PWPolicy___hide.equals("null") ) {
%>
      <display:column property="pwpolicy" sortable="true" titleKey="CERouterApplicationResources:field.pwpolicy.alias" headerClass="tableTitle" class="tableCell"/>
<%
        }
        if ( UsernameEnabled___hide == null || UsernameEnabled___hide.equals("null") ) {
%>
      <display:column property="usernameenabled" sortable="true" titleKey="CERouterApplicationResources:field.usernameenabled.alias" headerClass="tableTitle" class="tableCell"/>
<%
        }
        if ( Username___hide == null || Username___hide.equals("null") ) {
%>
      <display:column property="username" sortable="true" titleKey="CERouterApplicationResources:field.username.alias" headerClass="tableTitle" class="tableCell"/>
<%
        }
        if ( Vendor___hide == null || Vendor___hide.equals("null") ) {
%>
      <display:column property="vendor" sortable="true" titleKey="CERouterApplicationResources:field.vendor.alias" headerClass="tableTitle" class="tableCell"/>
<%
        }
        if ( OSVersion___hide == null || OSVersion___hide.equals("null") ) {
%>
      <display:column property="osversion" sortable="true" titleKey="CERouterApplicationResources:field.osversion.alias" headerClass="tableTitle" class="tableCell"/>
<%
        }
        if ( ElementType___hide == null || ElementType___hide.equals("null") ) {
%>
      <display:column property="elementtype" sortable="true" titleKey="CERouterApplicationResources:field.elementtype.alias" headerClass="tableTitle" class="tableCell"/>
<%
        }
        if ( SerialNumber___hide == null || SerialNumber___hide.equals("null") ) {
%>
      <display:column property="serialnumber" sortable="true" titleKey="CERouterApplicationResources:field.serialnumber.alias" headerClass="tableTitle" class="tableCell"/>
<%
        }
        if ( Role___hide == null || Role___hide.equals("null") ) {
%>
      <display:column property="role" sortable="true" titleKey="CERouterApplicationResources:field.role.alias" headerClass="tableTitle" class="tableCell"/>
<%
        }
        if ( AdminState___hide == null || AdminState___hide.equals("null") ) {
%>
      <display:column property="adminstate" sortable="true" titleKey="CERouterApplicationResources:field.adminstate.alias" headerClass="tableTitle" class="tableCell"/>
<%
        }
        if ( LifeCycleState___hide == null || LifeCycleState___hide.equals("null") ) {
%>
      <display:column property="lifecyclestate" sortable="true" titleKey="CERouterApplicationResources:field.lifecyclestate.alias" headerClass="tableTitle" class="tableCell"/>
<%
        }
        if ( Backup___hide == null || Backup___hide.equals("null") ) {
%>
      <display:column property="backup" sortable="true" titleKey="CERouterApplicationResources:field.backup.alias" headerClass="tableTitle" class="tableCell"/>
<%
        }
        if ( SchPolicyName___hide == null || SchPolicyName___hide.equals("null") ) {
%>
      <display:column property="schpolicyname" sortable="true" titleKey="CERouterApplicationResources:field.schpolicyname.alias" headerClass="tableTitle" class="tableCell"/>
<%
        }
        if ( SkipActivation___hide == null || SkipActivation___hide.equals("null") ) {
%>
      <display:column property="skipactivation" sortable="true" titleKey="CERouterApplicationResources:field.skipactivation.alias" headerClass="tableTitle" class="tableCell"/>
<%
        }
        if ( ROCommunity___hide == null || ROCommunity___hide.equals("null") ) {
%>
      <display:column property="rocommunity" sortable="true" titleKey="CERouterApplicationResources:field.rocommunity.alias" headerClass="tableTitle" class="tableCell"/>
<%
        }
        if ( RWCommunity___hide == null || RWCommunity___hide.equals("null") ) {
%>
      <display:column property="rwcommunity" sortable="true" titleKey="CERouterApplicationResources:field.rwcommunity.alias" headerClass="tableTitle" class="tableCell"/>
<%
        }
        if ( Managed___hide == null || Managed___hide.equals("null") ) {
%>
      <display:column property="managed" sortable="true" titleKey="CERouterApplicationResources:field.managed.alias" headerClass="tableTitle" class="tableCell"/>
<%
        }
        if ( CE_LoopbackPool___hide == null || CE_LoopbackPool___hide.equals("null") ) {
%>
      <display:column property="ce_loopbackpool" sortable="true" titleKey="CERouterApplicationResources:field.ce_loopbackpool.alias" headerClass="tableTitle" class="tableCell"/>
<%
        }
        if ( NNMi_UUId___hide == null || NNMi_UUId___hide.equals("null") ) {
%>
      <display:column property="nnmi_uuid" sortable="true" titleKey="CERouterApplicationResources:field.nnmi_uuid.alias" headerClass="tableTitle" class="tableCell"/>
<%
        }
        if ( NNMi_Id___hide == null || NNMi_Id___hide.equals("null") ) {
%>
      <display:column property="nnmi_id" sortable="true" titleKey="CERouterApplicationResources:field.nnmi_id.alias" headerClass="tableTitle" class="tableCell"/>
<%
        }
        if ( NNMi_LastUpdate___hide == null || NNMi_LastUpdate___hide.equals("null") ) {
%>
      <display:column property="nnmi_lastupdate" sortable="true" titleKey="CERouterApplicationResources:field.nnmi_lastupdate.alias" headerClass="tableTitle" class="tableCell"/>
<%
    }
%>
</display:table>
...
String backAction = "SearchFormCERouterAction.do?datasource=" + datasource + "&tab_name=" + tabName + "&vi=" + viParameter + "&view=" + viewParameter + "&ndid=" + ndidParameter;
%>
...
%>
    <input type="submit" value="<%= backMessage %>" onclick="window.document.CERouterForm.submit()"/>
  </html:form>
