...
String formAction = "/UpdateCommitSh_L3FlowPointAction.do?datasource=" + datasource + "&rimid=" + rimid;
...
<html>
  <head>
    ...
    {
      window.document.Sh_L3FlowPointForm.action = '/activator<%=moduleConfig%>/UpdateFormSh_L3FlowPointAction.do?datasource=<%= datasource %>&rimid=<%= rimid %>&_pk_=<%=pk %>&_location_=' + focusthis;
      window.document.Sh_L3FlowPointForm.submit();
    }
    function performCommit()
    {
      window.document.Sh_L3FlowPointForm.action = '/activator<%=moduleConfig%>/UpdateCommitSh_L3FlowPointAction.do?datasource=<%= datasource %>&rimid=<%= rimid %>&_pk_=<%=pk %>';
      window.document.Sh_L3FlowPointForm.submit();
    }
    function init()
    {
...
if(beanSh_L3FlowPoint==null)
   beanSh_L3FlowPoint = (com.hp.ov.activator.vpn.inventory.Sh_L3FlowPoint) request.getSession().getAttribute(Sh_L3FlowPointConstants.SH_L3FLOWPOINT_BEAN);
...
<h2 style="width:100%; text-align:center;">
  <bean:message bundle="Sh_L3FlowPointApplicationResources" key="jsp.update.title"/>
</h2> 
