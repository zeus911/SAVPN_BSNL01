...
String refreshTree = (String) request.getAttribute(Sh_QoSProfileConstants.REFRESH_TREE);
%>

<html>
  <head>
    <title><bean:message bundle="Sh_QoSProfileApplicationResources" key="<%= Sh_QoSProfileConstants.JSP_VIEW_TITLE %>"/></title>
...
<h2 style="width:100%; text-align:center;">
  <bean:message bundle="Sh_QoSProfileApplicationResources" key="jsp.view.title"/>
</h2> 
