...
String formAction = "/UpdateCommitL2AccessFlowAction.do?datasource=" + datasource + "&rimid=" + rimid;
...
<html>
  <head>
    ...
    {
      window.document.L2AccessFlowForm.action = '/activator<%=moduleConfig%>/UpdateFormL2AccessFlowAction.do?datasource=<%= datasource %>&rimid=<%= rimid %>&_pk_=<%=pk %>&_location_=' + focusthis;
      window.document.L2AccessFlowForm.submit();
    }
    function performCommit()
    {
      window.document.L2AccessFlowForm.action = '/activator<%=moduleConfig%>/UpdateCommitL2AccessFlowAction.do?datasource=<%= datasource %>&rimid=<%= rimid %>&_pk_=<%=pk %>';
      window.document.L2AccessFlowForm.submit();
    }
    function init()
    {
...
if(beanL2AccessFlow==null)
   beanL2AccessFlow = (com.hp.ov.activator.vpn.inventory.L2AccessFlow) request.getSession().getAttribute(L2AccessFlowConstants.L2ACCESSFLOW_BEAN);
...
<h2 style="width:100%; text-align:center;">
  <bean:message bundle="L2AccessFlowApplicationResources" key="jsp.update.title"/>
</h2> 
