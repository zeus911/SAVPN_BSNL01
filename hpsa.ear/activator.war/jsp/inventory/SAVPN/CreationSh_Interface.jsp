...
String formAction = "/CreationCommitSh_InterfaceAction.do?datasource=" + datasource + "&rimid=" + rimid;
...
<html>
  <head>
    ...
    {
      window.document.Sh_InterfaceForm.action = '/activator<%=moduleConfig%>/CreationFormSh_InterfaceAction.do?datasource=<%= datasource %>&rimid=<%= rimid %>&_location_=' + focusthis;
      window.document.Sh_InterfaceForm.submit();
    }
    function performCommit()
    {
      window.document.Sh_InterfaceForm.action = '/activator<%=moduleConfig%>/CreationCommitSh_InterfaceAction.do?datasource=<%= datasource %>&rimid=<%= rimid %>';
      window.document.Sh_InterfaceForm.submit();
    }
    function init()
    {
...
<h2 style="width:100%; text-align:center;">
  <bean:message bundle="Sh_InterfaceApplicationResources" key="jsp.creation.title"/>
</h2> 
