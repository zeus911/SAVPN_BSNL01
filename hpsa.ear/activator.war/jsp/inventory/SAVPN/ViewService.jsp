...
String refreshTree = (String) request.getAttribute(ServiceConstants.REFRESH_TREE);
%>

<html>
  <head>
    <title><bean:message bundle="ServiceApplicationResources" key="<%= ServiceConstants.JSP_VIEW_TITLE %>"/></title>
...
<h2 style="width:100%; text-align:center;">
  <bean:message bundle="ServiceApplicationResources" key="jsp.view.title"/>
</h2> 
