...
String formAction = "/CreationCommitDLCIRangeAction.do?datasource=" + datasource + "&rimid=" + rimid;
...
<html>
  <head>
    ...
    {
      window.document.DLCIRangeForm.action = '/activator<%=moduleConfig%>/CreationFormDLCIRangeAction.do?datasource=<%= datasource %>&rimid=<%= rimid %>&_location_=' + focusthis;
      window.document.DLCIRangeForm.submit();
    }
    function performCommit()
    {
      window.document.DLCIRangeForm.action = '/activator<%=moduleConfig%>/CreationCommitDLCIRangeAction.do?datasource=<%= datasource %>&rimid=<%= rimid %>';
      window.document.DLCIRangeForm.submit();
    }
    function init()
    {
...
<h2 style="width:100%; text-align:center;">
  <bean:message bundle="DLCIRangeApplicationResources" key="jsp.creation.title"/>
</h2> 
