...
<html>
  <head>
    <title><bean:message bundle="IPHostApplicationResources" key="<%= IPHostConstants.JSP_DELETE_TITLE %>"/></title>
    ...
    {
      window.document.IPHostForm.action = '/activator<%=moduleConfig%>/DeleteCommitIPHostAction.do?datasource=<%= datasource %>&rimid=<%= rimid %>';
      window.document.IPHostForm.submit();
    }
    function init()
    {
      var confirm = new HPSAConfirm('Confirm','<bean:message bundle="IPHostApplicationResources" key="delete.confirm"/>', '<bean:message bundle="InventoryResources" key="confirm.ok_button.label"/>', '<bean:message bundle="InventoryResources" key="confirm.cancel_button.label"/>');
...
<h2 style="width:100%; text-align:center;">
    <bean:message bundle="IPHostApplicationResources" key="jsp.delete.title"/>
</h2> 
...
%>
    ...
    <html:form action="/DeleteCommitIPHostAction.do">
    <html:hidden property="refreshTreeRimid" value="<%= (String)request.getParameter(\"refreshTreeRimid\") %>"/>
                  <html:hidden property="ip" value="<%= String.valueOf(IP) %>"/>
              </html:form>
  </body>
</html>
