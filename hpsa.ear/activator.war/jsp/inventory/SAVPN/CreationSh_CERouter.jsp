...
String formAction = "/CreationCommitSh_CERouterAction.do?datasource=" + datasource + "&rimid=" + rimid;
...
<html>
  <head>
    ...
    {
      window.document.Sh_CERouterForm.action = '/activator<%=moduleConfig%>/CreationFormSh_CERouterAction.do?datasource=<%= datasource %>&rimid=<%= rimid %>&_location_=' + focusthis;
      window.document.Sh_CERouterForm.submit();
    }
    function performCommit()
    {
      window.document.Sh_CERouterForm.action = '/activator<%=moduleConfig%>/CreationCommitSh_CERouterAction.do?datasource=<%= datasource %>&rimid=<%= rimid %>';
      window.document.Sh_CERouterForm.submit();
    }
    function init()
    {
...
<h2 style="width:100%; text-align:center;">
  <bean:message bundle="Sh_CERouterApplicationResources" key="jsp.creation.title"/>
</h2> 
