...
String formAction = "/CreationCommitPolicyMappingAction.do?datasource=" + datasource + "&rimid=" + rimid;
...
<html>
  <head>
    ...
    {
      window.document.PolicyMappingForm.action = '/activator<%=moduleConfig%>/CreationFormPolicyMappingAction.do?datasource=<%= datasource %>&rimid=<%= rimid %>&_location_=' + focusthis;
      window.document.PolicyMappingForm.submit();
    }
    function performCommit()
    {
      window.document.PolicyMappingForm.action = '/activator<%=moduleConfig%>/CreationCommitPolicyMappingAction.do?datasource=<%= datasource %>&rimid=<%= rimid %>';
      window.document.PolicyMappingForm.submit();
    }
    function init()
    {
...
<h2 style="width:100%; text-align:center;">
  <bean:message bundle="PolicyMappingApplicationResources" key="jsp.creation.title"/>
</h2> 
