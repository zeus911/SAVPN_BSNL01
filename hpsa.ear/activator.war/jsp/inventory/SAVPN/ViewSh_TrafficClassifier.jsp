...
String refreshTree = (String) request.getAttribute(Sh_TrafficClassifierConstants.REFRESH_TREE);
%>

<html>
  <head>
    <title><bean:message bundle="Sh_TrafficClassifierApplicationResources" key="<%= Sh_TrafficClassifierConstants.JSP_VIEW_TITLE %>"/></title>
...
<h2 style="width:100%; text-align:center;">
  <bean:message bundle="Sh_TrafficClassifierApplicationResources" key="jsp.view.title"/>
</h2> 
