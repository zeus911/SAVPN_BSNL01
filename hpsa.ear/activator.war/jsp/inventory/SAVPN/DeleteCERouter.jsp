...
<html>
  <head>
    <title><bean:message bundle="CERouterApplicationResources" key="<%= CERouterConstants.JSP_DELETE_TITLE %>"/></title>
    ...
    {
      window.document.CERouterForm.action = '/activator<%=moduleConfig%>/DeleteCommitCERouterAction.do?datasource=<%= datasource %>&rimid=<%= rimid %>';
      window.document.CERouterForm.submit();
    }
    function init()
    {
      var confirm = new HPSAConfirm('Confirm','<bean:message bundle="CERouterApplicationResources" key="delete.confirm"/>', '<bean:message bundle="InventoryResources" key="confirm.ok_button.label"/>', '<bean:message bundle="InventoryResources" key="confirm.cancel_button.label"/>');
...
nfB.setMaximumFractionDigits(6);
      ...
      String NetworkId_key = beanCERouter.getNetworkid();
      ...
      String Location_key = beanCERouter.getLocation();
      ...
      String PWPolicy_key = beanCERouter.getPwpolicy();
      ...
      String Vendor_key = beanCERouter.getVendor();
      ...
      String OSVersion_key = beanCERouter.getOsversion();
      ...
      String ElementType_key = beanCERouter.getElementtype();
      ...
      String SchPolicyName_key = beanCERouter.getSchpolicyname();
...
<h2 style="width:100%; text-align:center;">
    <bean:message bundle="CERouterApplicationResources" key="jsp.delete.title"/>
</h2> 
...
%>
          ...
          <bean:message bundle="InventoryResources" key="description.heading"/>
            ...
            <table:cell>
              <bean:message bundle="CERouterApplicationResources" key="field.managedc.description"/>
                                                   ...
                                                   <%if(showCE_LoopbackPool){%>                                <table:row>
            <table:cell>  
    ...
    <html:form action="/DeleteCommitCERouterAction.do">
