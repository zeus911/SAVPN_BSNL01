...
String formAction = "/CreationCommitBackupRefAction.do?datasource=" + datasource + "&rimid=" + rimid;
...
<html>
  <head>
    ...
    {
      window.document.BackupRefForm.action = '/activator<%=moduleConfig%>/CreationFormBackupRefAction.do?datasource=<%= datasource %>&rimid=<%= rimid %>&_location_=' + focusthis;
      window.document.BackupRefForm.submit();
    }
    function performCommit()
    {
      window.document.BackupRefForm.action = '/activator<%=moduleConfig%>/CreationCommitBackupRefAction.do?datasource=<%= datasource %>&rimid=<%= rimid %>';
      window.document.BackupRefForm.submit();
    }
    function init()
    {
...
<h2 style="width:100%; text-align:center;">
  <bean:message bundle="BackupRefApplicationResources" key="jsp.creation.title"/>
</h2> 
...
<html:form action="<%= formAction %>" style="text-align:center;">
    <table:table>
      ...
      <html:hidden property="refreshTreeRimid" value="<%= (String)request.getParameter(\"refreshTreeRimid\") %>"/>
              ...
              <table:cell>
                                                                        <html:text  property="eqid" size="24" value="<%= eqid %>"/>
                                                </table:cell>
              <table:cell>
