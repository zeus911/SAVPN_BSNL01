...
String formAction = "/CreationCommitQueueAction.do?datasource=" + datasource + "&rimid=" + rimid;
...
<html>
  <head>
    ...
    {
      window.document.QueueForm.action = '/activator<%=moduleConfig%>/CreationFormQueueAction.do?datasource=<%= datasource %>&rimid=<%= rimid %>&_location_=' + focusthis;
      window.document.QueueForm.submit();
    }
    function performCommit()
    {
      window.document.QueueForm.action = '/activator<%=moduleConfig%>/CreationCommitQueueAction.do?datasource=<%= datasource %>&rimid=<%= rimid %>';
      window.document.QueueForm.submit();
    }
    function init()
    {
...
<h2 style="width:100%; text-align:center;">
  <bean:message bundle="QueueApplicationResources" key="jsp.creation.title"/>
</h2> 
