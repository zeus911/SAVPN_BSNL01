...
String formAction = "/CreationCommitRateLimitAction.do?datasource=" + datasource + "&rimid=" + rimid;
...
<html>
  <head>
    ...
    {
      window.document.RateLimitForm.action = '/activator<%=moduleConfig%>/CreationFormRateLimitAction.do?datasource=<%= datasource %>&rimid=<%= rimid %>&_location_=' + focusthis;
      window.document.RateLimitForm.submit();
    }
    function performCommit()
    {
      window.document.RateLimitForm.action = '/activator<%=moduleConfig%>/CreationCommitRateLimitAction.do?datasource=<%= datasource %>&rimid=<%= rimid %>';
      window.document.RateLimitForm.submit();
    }
    function init()
    {
...
<h2 style="width:100%; text-align:center;">
  <bean:message bundle="RateLimitApplicationResources" key="jsp.creation.title"/>
</h2> 
...
<html:form action="<%= formAction %>" style="text-align:center;">
    <table:table>
      ...
      <html:hidden property="refreshTreeRimid" value="<%= (String)request.getParameter(\"refreshTreeRimid\") %>"/>
              ...
              <table:cell>
                                                                        <html:text  property="ratelimitname" size="24" value="<%= RateLimitName %>"/>
                                                </table:cell>
              <table:cell>
