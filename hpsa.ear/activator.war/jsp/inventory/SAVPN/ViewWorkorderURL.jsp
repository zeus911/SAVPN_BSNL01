...
String refreshTree = (String) request.getAttribute(WorkorderURLConstants.REFRESH_TREE);
%>

<html>
  <head>
    <title><bean:message bundle="WorkorderURLApplicationResources" key="<%= WorkorderURLConstants.JSP_VIEW_TITLE %>"/></title>
...
<h2 style="width:100%; text-align:center;">
  <bean:message bundle="WorkorderURLApplicationResources" key="jsp.view.title"/>
</h2> 
