...
String refreshTree = (String) request.getAttribute(LSPParametersConstants.REFRESH_TREE);
%>

<html>
  <head>
    <title><bean:message bundle="LSPParametersApplicationResources" key="<%= LSPParametersConstants.JSP_VIEW_TITLE %>"/></title>
...
<h2 style="width:100%; text-align:center;">
  <bean:message bundle="LSPParametersApplicationResources" key="jsp.view.title"/>
</h2> 
