...
<html>
  <head>
    <title><bean:message bundle="AccessFlowApplicationResources" key="<%= AccessFlowConstants.JSP_DELETE_TITLE %>"/></title>
    ...
    {
      window.document.AccessFlowForm.action = '/activator<%=moduleConfig%>/DeleteCommitAccessFlowAction.do?datasource=<%= datasource %>&rimid=<%= rimid %>';
      window.document.AccessFlowForm.submit();
    }
    function init()
    {
      var confirm = new HPSAConfirm('Confirm','<bean:message bundle="AccessFlowApplicationResources" key="delete.confirm"/>', '<bean:message bundle="InventoryResources" key="confirm.ok_button.label"/>', '<bean:message bundle="InventoryResources" key="confirm.cancel_button.label"/>');
...
<h2 style="width:100%; text-align:center;">
    <bean:message bundle="AccessFlowApplicationResources" key="jsp.delete.title"/>
</h2> 
...
%>
    ...
    <html:form action="/DeleteCommitAccessFlowAction.do">
