...
String formAction = "/UpdateCommitSh_L3AccessFlowAction.do?datasource=" + datasource + "&rimid=" + rimid;
...
<html>
  <head>
    ...
    {
      window.document.Sh_L3AccessFlowForm.action = '/activator<%=moduleConfig%>/UpdateFormSh_L3AccessFlowAction.do?datasource=<%= datasource %>&rimid=<%= rimid %>&_pk_=<%=pk %>&_location_=' + focusthis;
      window.document.Sh_L3AccessFlowForm.submit();
    }
    function performCommit()
    {
      window.document.Sh_L3AccessFlowForm.action = '/activator<%=moduleConfig%>/UpdateCommitSh_L3AccessFlowAction.do?datasource=<%= datasource %>&rimid=<%= rimid %>&_pk_=<%=pk %>';
      window.document.Sh_L3AccessFlowForm.submit();
    }
    function init()
    {
...
if(beanSh_L3AccessFlow==null)
   beanSh_L3AccessFlow = (com.hp.ov.activator.vpn.inventory.Sh_L3AccessFlow) request.getSession().getAttribute(Sh_L3AccessFlowConstants.SH_L3ACCESSFLOW_BEAN);
...
<h2 style="width:100%; text-align:center;">
  <bean:message bundle="Sh_L3AccessFlowApplicationResources" key="jsp.update.title"/>
</h2> 
