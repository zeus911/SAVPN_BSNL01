...
<html>
  <head>
    <title><bean:message bundle="L3VPNApplicationResources" key="<%= L3VPNConstants.JSP_DELETE_TITLE %>"/></title>
    ...
    {
      window.document.L3VPNForm.action = '/activator<%=moduleConfig%>/DeleteCommitL3VPNAction.do?datasource=<%= datasource %>&rimid=<%= rimid %>';
      window.document.L3VPNForm.submit();
    }
    function init()
    {
      var confirm = new HPSAConfirm('Confirm','<bean:message bundle="L3VPNApplicationResources" key="delete.confirm"/>', '<bean:message bundle="InventoryResources" key="confirm.ok_button.label"/>', '<bean:message bundle="InventoryResources" key="confirm.cancel_button.label"/>');
...
<h2 style="width:100%; text-align:center;">
    <bean:message bundle="L3VPNApplicationResources" key="jsp.delete.title"/>
</h2> 
...
%>
    ...
    <html:form action="/DeleteCommitL3VPNAction.do">
