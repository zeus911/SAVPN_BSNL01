...
String tabName = (String) request.getParameter(L2VPNConstants.TAB_NAME);
...
<script>
function clearForm() {
var formObj = document.L2VPNFormSearch;
...
if (element.type == 'select-one') { element.selectedIndex = -1; }
  ...
  var checkfalse=false;
                    if(document.getElementsByName("serviceid___hide")[0].checked) {
                            ...
                            if(document.getElementsByName("fixed___hide")[0].checked) {
                      ...
                      if(checkfalse){
    alert("<bean:message bundle="L2VPNApplicationResources" key="<%= L2VPNConstants.JSP_SEARCH_NO_SHOW %>"/>");
  }else{
    window.document.L2VPNFormSearch.action = '/activator<%=moduleConfig%>/SearchCommitL2VPNAction.do?datasource=<%= datasource %>&tab_name=<%= tabName %>&vi=<%= viParameter%>&view=<%= viewParameter %>&ndid=<%= ndidParameter %>';
    window.document.L2VPNFormSearch.submit();
  }
  }
</script>
...
if (session == null || session.getValue(L2VPNConstants.USER) == null) {
  response.sendRedirect(L2VPNConstants.NULL_SESSION);
  return;
}
...
<h2 style="width:100%; text-align:center;">
  <bean:message bundle="L2VPNApplicationResources" key="jsp.search.title"/>
</h2> 
...
<div style="color:#ff0000;">
      <html:errors bundle="L2VPNApplicationResources" property="ServiceId"/>
        ...
        <html:errors bundle="L2VPNApplicationResources" property="__count"/>
  <html:errors bundle="InventoryResources" property="warning"/>
</div>
<% String searchFormAction = "/SearchCommitL2VPNAction.do?datasource="+datasource+"&tab_name="+tabName+"&vi="+ viParameter+"&view="+ viewParameter +"&ndid="+ ndidParameter ;%>
      ...
      <table:header>
        ...
        <table:cell>
          <bean:message bundle="InventoryResources" key="description.heading"/>
            ...
            <table:cell>
              <bean:message bundle="L2VPNApplicationResources" key="field.qosprofile_ce.alias"/>
            ...
            <table:cell>
              <bean:message bundle="L2VPNApplicationResources" key="field.qosprofile_ce.description"/>
                          </table:cell>
          </table:row>
                                <table:row>
            <table:cell>
              <center>
                <html:checkbox property="fixed___hide" value="true"/>
              </center>
            </table:cell>
