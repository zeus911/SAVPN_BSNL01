...
String formAction = "/UpdateCommitLSPProfileAction.do?datasource=" + datasource + "&rimid=" + rimid;
...
if ( pk == null || pk.equals("") ) {
  pk =    request.getParameter("lspprofilename") ;
}
...
<html>
  <head>
    ...
    {
      window.document.LSPProfileForm.action = '/activator<%=moduleConfig%>/UpdateFormLSPProfileAction.do?datasource=<%= datasource %>&rimid=<%= rimid %>&_pk_=<%=pk %>&_location_=' + focusthis;
      window.document.LSPProfileForm.submit();
    }
    function performCommit()
    {
      window.document.LSPProfileForm.action = '/activator<%=moduleConfig%>/UpdateCommitLSPProfileAction.do?datasource=<%= datasource %>&rimid=<%= rimid %>&_pk_=<%=pk %>';
      window.document.LSPProfileForm.submit();
    }
    function init()
    {
...
if(beanLSPProfile==null)
   beanLSPProfile = (com.hp.ov.activator.vpn.inventory.LSPProfile) request.getSession().getAttribute(LSPProfileConstants.LSPPROFILE_BEAN);
...
<h2 style="width:100%; text-align:center;">
  <bean:message bundle="LSPProfileApplicationResources" key="jsp.update.title"/>
</h2> 
      ...
      <html:hidden property="refreshTreeRimid" value="<%= (String)request.getParameter(\"refreshTreeRimid\") %>"/>
              ...
              <table:cell>
                                                      <html:hidden property="lspprofilename" value="<%= LSPProfileName %>"/>
                                                        <html:text disabled="true" property="lspprofilename" size="24" value="<%= LSPProfileName %>"/>
                                                </table:cell>
              <table:cell>
              ...
              <table:cell>
                                                      <html:hidden property="ct" value="<%= CT %>"/>
                                                          <%
                        String selValue=null;                                    
                    ...
                    <html:select disabled="true" property="ct" value="<%= selValue %>" >
              ...
              <table:cell>
                                                      <html:hidden property="bwalgorithm" value="<%= bwAlgorithm %>"/>
                                                          <%
                        String selValue=null;                                    
                    ...
                    <html:select disabled="true" property="bwalgorithm" value="<%= selValue %>" >
              ...
              <table:cell>
                                                      <html:hidden property="lspfilter" value="<%= LSPFilter %>"/>
                                                        <html:text disabled="true" property="lspfilter" size="24" value="<%= LSPFilter %>"/>
                                                </table:cell>
              <table:cell>
              ...
              <table:cell>
                                                      <html:hidden property="lspprofileversion" value="<%= LSPProfileVersion %>"/>
                                                        <html:text disabled="true" property="lspprofileversion" size="24" value="<%= LSPProfileVersion %>"/>
                                                </table:cell>
              <table:cell>
