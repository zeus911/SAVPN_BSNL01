...
String formAction = "/CreationCommitDelayedActivationAction.do?datasource=" + datasource + "&rimid=" + rimid;
...
<html>
  <head>
    ...
    {
      window.document.DelayedActivationForm.action = '/activator<%=moduleConfig%>/CreationFormDelayedActivationAction.do?datasource=<%= datasource %>&rimid=<%= rimid %>&_location_=' + focusthis;
      window.document.DelayedActivationForm.submit();
    }
    function performCommit()
    {
      window.document.DelayedActivationForm.action = '/activator<%=moduleConfig%>/CreationCommitDelayedActivationAction.do?datasource=<%= datasource %>&rimid=<%= rimid %>';
      window.document.DelayedActivationForm.submit();
    }
    function init()
    {
...
<h2 style="width:100%; text-align:center;">
  <bean:message bundle="DelayedActivationApplicationResources" key="jsp.creation.title"/>
</h2> 
...
<html:form action="<%= formAction %>" style="text-align:center;">
    <table:table>
      ...
      <html:hidden property="refreshTreeRimid" value="<%= (String)request.getParameter(\"refreshTreeRimid\") %>"/>
              ...
              <table:cell>
                                                                        <html:text  property="daname" size="24" value="<%= DAName %>"/>
                                                </table:cell>
              <table:cell>
