...
String tabName = (String) request.getParameter(Sh_IPNetConstants.TAB_NAME);
...
<script>
function clearForm() {
var formObj = document.Sh_IPNetFormSearch;
...
if (element.type == 'select-one') { element.selectedIndex = -1; }
  ...
  var checkfalse=false;
                    if(document.getElementsByName("ipnetaddr___hide")[0].checked) {
                      ...
                      if(checkfalse){
    alert("<bean:message bundle="Sh_IPNetApplicationResources" key="<%= Sh_IPNetConstants.JSP_SEARCH_NO_SHOW %>"/>");
  }else{
    window.document.Sh_IPNetFormSearch.action = '/activator<%=moduleConfig%>/SearchCommitSh_IPNetAction.do?datasource=<%= datasource %>&tab_name=<%= tabName %>&vi=<%= viParameter%>&view=<%= viewParameter %>&ndid=<%= ndidParameter %>';
    window.document.Sh_IPNetFormSearch.submit();
  }
  }
</script>
...
if (session == null || session.getValue(Sh_IPNetConstants.USER) == null) {
  response.sendRedirect(Sh_IPNetConstants.NULL_SESSION);
  return;
}
...
<h2 style="width:100%; text-align:center;">
  <bean:message bundle="Sh_IPNetApplicationResources" key="jsp.search.title"/>
</h2> 
...
<div style="color:#ff0000;">
      <html:errors bundle="Sh_IPNetApplicationResources" property="IPNetAddr"/>
        ...
        <html:errors bundle="Sh_IPNetApplicationResources" property="__count"/>
  <html:errors bundle="InventoryResources" property="warning"/>
</div>
<% String searchFormAction = "/SearchCommitSh_IPNetAction.do?datasource="+datasource+"&tab_name="+tabName+"&vi="+ viParameter+"&view="+ viewParameter +"&ndid="+ ndidParameter ;%>
      ...
      <table:header>
        ...
        <table:cell>
          <bean:message bundle="InventoryResources" key="description.heading"/>
            ...
            <table:cell>
              <bean:message bundle="Sh_IPNetApplicationResources" key="field.ipnetaddrstr.alias"/>
            ...
            <table:cell>
              <bean:message bundle="Sh_IPNetApplicationResources" key="field.ipnetaddrstr.description"/>
                          </table:cell>
          </table:row>
                                <table:row>
            <table:cell>
