...
String tabName = (String) request.getParameter(VlanRangeConstants.TAB_NAME);
...
<script>
function clearForm() {
var formObj = document.VlanRangeFormSearch;
...
if (element.type == 'select-one') { element.selectedIndex = -1; }
  ...
  var checkfalse=false;
                    if(document.getElementsByName("vlanrangeid___hide")[0].checked) {
            ...
            if(checkfalse){
    alert("<bean:message bundle="VlanRangeApplicationResources" key="<%= VlanRangeConstants.JSP_SEARCH_NO_SHOW %>"/>");
  }else{
    window.document.VlanRangeFormSearch.action = '/activator<%=moduleConfig%>/SearchCommitVlanRangeAction.do?datasource=<%= datasource %>&tab_name=<%= tabName %>&vi=<%= viParameter%>&view=<%= viewParameter %>&ndid=<%= ndidParameter %>';
    window.document.VlanRangeFormSearch.submit();
  }
  }
</script>
...
if (session == null || session.getValue(VlanRangeConstants.USER) == null) {
  response.sendRedirect(VlanRangeConstants.NULL_SESSION);
  return;
}
...
<%
      String VlanRangeID = form.getVlanrangeid();
...
<h2 style="width:100%; text-align:center;">
  <bean:message bundle="VlanRangeApplicationResources" key="jsp.search.title"/>
</h2> 
...
<% String searchFormAction = "/SearchCommitVlanRangeAction.do?datasource="+datasource+"&tab_name="+tabName+"&vi="+ viParameter+"&view="+ viewParameter +"&ndid="+ ndidParameter ;%>
      ...
      <table:header>
        ...
        <table:cell>
          <bean:message bundle="InventoryResources" key="description.heading"/>
            ...
            <table:cell>
              <center>
                <html:checkbox property="vlanrangeid___hide" value="true"/>
              </center>
            </table:cell>

            <table:cell>
              <bean:message bundle="VlanRangeApplicationResources" key="field.vlanrangeid.alias"/>
            
            </table:cell>
            
            <table:cell>
                              <html:text property="vlanrangeid" size="16" value="<%= VlanRangeID %>"/>
                                          </table:cell>

            <table:cell>
              <bean:message bundle="VlanRangeApplicationResources" key="field.vlanrangeid.description"/>
                          </table:cell>
          </table:row>
                                <table:row>
            <table:cell>
