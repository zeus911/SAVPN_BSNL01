...
<html>
  <head>
    <title><bean:message bundle="Sh_SiteApplicationResources" key="<%= Sh_SiteConstants.JSP_DELETE_TITLE %>"/></title>
    ...
    {
      window.document.Sh_SiteForm.action = '/activator<%=moduleConfig%>/DeleteCommitSh_SiteAction.do?datasource=<%= datasource %>&rimid=<%= rimid %>';
      window.document.Sh_SiteForm.submit();
    }
    function init()
    {
      var confirm = new HPSAConfirm('Confirm','<bean:message bundle="Sh_SiteApplicationResources" key="delete.confirm"/>', '<bean:message bundle="InventoryResources" key="confirm.ok_button.label"/>', '<bean:message bundle="InventoryResources" key="confirm.cancel_button.label"/>');
...
<h2 style="width:100%; text-align:center;">
    <bean:message bundle="Sh_SiteApplicationResources" key="jsp.delete.title"/>
</h2> 
...
%>
    ...
    <html:form action="/DeleteCommitSh_SiteAction.do">
