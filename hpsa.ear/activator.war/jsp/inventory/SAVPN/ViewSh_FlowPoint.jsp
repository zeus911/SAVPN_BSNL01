...
String refreshTree = (String) request.getAttribute(Sh_FlowPointConstants.REFRESH_TREE);
%>

<html>
  <head>
    <title><bean:message bundle="Sh_FlowPointApplicationResources" key="<%= Sh_FlowPointConstants.JSP_VIEW_TITLE %>"/></title>
...
<h2 style="width:100%; text-align:center;">
  <bean:message bundle="Sh_FlowPointApplicationResources" key="jsp.view.title"/>
</h2> 
