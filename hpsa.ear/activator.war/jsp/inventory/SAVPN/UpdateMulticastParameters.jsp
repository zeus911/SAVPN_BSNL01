...
String formAction = "/UpdateCommitMulticastParametersAction.do?datasource=" + datasource + "&rimid=" + rimid;
...
<html>
  <head>
    ...
    {
      window.document.MulticastParametersForm.action = '/activator<%=moduleConfig%>/UpdateFormMulticastParametersAction.do?datasource=<%= datasource %>&rimid=<%= rimid %>&_pk_=<%=pk %>&_location_=' + focusthis;
      window.document.MulticastParametersForm.submit();
    }
    function performCommit()
    {
      window.document.MulticastParametersForm.action = '/activator<%=moduleConfig%>/UpdateCommitMulticastParametersAction.do?datasource=<%= datasource %>&rimid=<%= rimid %>&_pk_=<%=pk %>';
      window.document.MulticastParametersForm.submit();
    }
    function init()
    {
...
if(beanMulticastParameters==null)
   beanMulticastParameters = (com.hp.ov.activator.vpn.inventory.MulticastParameters) request.getSession().getAttribute(MulticastParametersConstants.MULTICASTPARAMETERS_BEAN);
...
nfB.setMaximumFractionDigits(6);
              ...
              String IDName = beanMulticastParameters.getIdname();
...
<h2 style="width:100%; text-align:center;">
  <bean:message bundle="MulticastParametersApplicationResources" key="jsp.update.title"/>
</h2> 
...
<input type="hidden" name="_update_commit_" value="true"/> 
    <table:table>
      ...
      <html:hidden property="refreshTreeRimid" value="<%= (String)request.getParameter(\"refreshTreeRimid\") %>"/>
              ...
              <table:cell>
                                  <html:checkbox  property="advancedjunipermulticast" value="true"/>
                  <html:hidden  property="advancedjunipermulticast" value="false"/>
                              </table:cell>
              <table:cell>
