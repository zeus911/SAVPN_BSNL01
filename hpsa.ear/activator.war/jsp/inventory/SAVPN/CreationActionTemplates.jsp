...
String formAction = "/CreationCommitActionTemplatesAction.do?datasource=" + datasource + "&rimid=" + rimid;
...
<html>
  <head>
    ...
    {
      window.document.ActionTemplatesForm.action = '/activator<%=moduleConfig%>/CreationFormActionTemplatesAction.do?datasource=<%= datasource %>&rimid=<%= rimid %>&_location_=' + focusthis;
      window.document.ActionTemplatesForm.submit();
    }
    function performCommit()
    {
      window.document.ActionTemplatesForm.action = '/activator<%=moduleConfig%>/CreationCommitActionTemplatesAction.do?datasource=<%= datasource %>&rimid=<%= rimid %>';
      window.document.ActionTemplatesForm.submit();
    }
    function init()
    {
...
<h2 style="width:100%; text-align:center;">
  <bean:message bundle="ActionTemplatesApplicationResources" key="jsp.creation.title"/>
</h2> 
...
<html:form action="<%= formAction %>" style="text-align:center;">
    <table:table>
      ...
      <html:hidden property="refreshTreeRimid" value="<%= (String)request.getParameter(\"refreshTreeRimid\") %>"/>
              ...
              <table:cell>
                                                                        <html:select  property="elementtype" value="<%= ElementType %>" onchange="sendthis('elementtype');">
              ...
              <table:cell>
                                                                        <html:text  property="activationname" size="24" value="<%= ActivationName %>"/>
                                                </table:cell>
              <table:cell>
