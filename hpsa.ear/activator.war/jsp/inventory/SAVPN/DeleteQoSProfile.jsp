...
<html>
  <head>
    <title><bean:message bundle="QoSProfileApplicationResources" key="<%= QoSProfileConstants.JSP_DELETE_TITLE %>"/></title>
    ...
    {
      window.document.QoSProfileForm.action = '/activator<%=moduleConfig%>/DeleteCommitQoSProfileAction.do?datasource=<%= datasource %>&rimid=<%= rimid %>';
      window.document.QoSProfileForm.submit();
    }
    function init()
    {
      var confirm = new HPSAConfirm('Confirm','<bean:message bundle="QoSProfileApplicationResources" key="delete.confirm"/>', '<bean:message bundle="InventoryResources" key="confirm.ok_button.label"/>', '<bean:message bundle="InventoryResources" key="confirm.cancel_button.label"/>');
...
<h2 style="width:100%; text-align:center;">
    <bean:message bundle="QoSProfileApplicationResources" key="jsp.delete.title"/>
</h2> 
...
%>
    ...
    <html:form action="/DeleteCommitQoSProfileAction.do">
