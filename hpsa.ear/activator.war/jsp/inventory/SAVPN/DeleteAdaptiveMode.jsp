...
<html>
  <head>
    <title><bean:message bundle="AdaptiveModeApplicationResources" key="<%= AdaptiveModeConstants.JSP_DELETE_TITLE %>"/></title>
    ...
    {
      window.document.AdaptiveModeForm.action = '/activator<%=moduleConfig%>/DeleteCommitAdaptiveModeAction.do?datasource=<%= datasource %>&rimid=<%= rimid %>';
      window.document.AdaptiveModeForm.submit();
    }
    function init()
    {
      var confirm = new HPSAConfirm('Confirm','<bean:message bundle="AdaptiveModeApplicationResources" key="delete.confirm"/>', '<bean:message bundle="InventoryResources" key="confirm.ok_button.label"/>', '<bean:message bundle="InventoryResources" key="confirm.cancel_button.label"/>');
...
<h2 style="width:100%; text-align:center;">
    <bean:message bundle="AdaptiveModeApplicationResources" key="jsp.delete.title"/>
</h2> 
...
%>
    ...
    <html:form action="/DeleteCommitAdaptiveModeAction.do">
