...
String formAction = "/UpdateCommitSwitchAction.do?datasource=" + datasource + "&rimid=" + rimid;
...
<html>
  <head>
    ...
    {
      window.document.SwitchForm.action = '/activator<%=moduleConfig%>/UpdateFormSwitchAction.do?datasource=<%= datasource %>&rimid=<%= rimid %>&_pk_=<%=pk %>&_location_=' + focusthis;
      window.document.SwitchForm.submit();
    }
    function performCommit()
    {
      window.document.SwitchForm.action = '/activator<%=moduleConfig%>/UpdateCommitSwitchAction.do?datasource=<%= datasource %>&rimid=<%= rimid %>&_pk_=<%=pk %>';
      window.document.SwitchForm.submit();
    }
    function init()
    {
...
if(beanSwitch==null)
   beanSwitch = (com.hp.ov.activator.vpn.inventory.Switch) request.getSession().getAttribute(SwitchConstants.SWITCH_BEAN);
      ...
      ArrayList PWPolicyListOfValues = (ArrayList) request.getAttribute(SwitchConstants.PWPOLICY_LIST_OF_VALUES);
              ...
              boolean UsernameEnabled = new Boolean(beanSwitch.getUsernameenabled()).booleanValue();
                ...
                String Password = beanSwitch.getPassword();
                  ...
                  String PasswordCurrent = "" + beanSwitch.getPasswordCurrent();
                ...
                String EnablePassword = beanSwitch.getEnablepassword();
                  ...
                  String EnablePasswordCurrent = "" + beanSwitch.getEnablePasswordCurrent();
...
<h2 style="width:100%; text-align:center;">
  <bean:message bundle="SwitchApplicationResources" key="jsp.update.title"/>
</h2> 
...
<input type="hidden" name="_update_commit_" value="true"/> 
    <table:table>
      ...
      <html:hidden property="refreshTreeRimid" value="<%= (String)request.getParameter(\"refreshTreeRimid\") %>"/>
              ...
              <table:cell>
                                                                        <html:text  property="regionswitch" size="24" value="<%= RegionSwitch %>"/>
                                                </table:cell>
              <table:cell>
