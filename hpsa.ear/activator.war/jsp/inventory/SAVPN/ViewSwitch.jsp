...
String refreshTree = (String) request.getAttribute(SwitchConstants.REFRESH_TREE);
%>

<html>
  <head>
    <title><bean:message bundle="SwitchApplicationResources" key="<%= SwitchConstants.JSP_VIEW_TITLE %>"/></title>
...
<h2 style="width:100%; text-align:center;">
  <bean:message bundle="SwitchApplicationResources" key="jsp.view.title"/>
</h2> 
