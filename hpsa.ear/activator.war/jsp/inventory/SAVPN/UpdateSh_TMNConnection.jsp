...
String formAction = "/UpdateCommitSh_TMNConnectionAction.do?datasource=" + datasource + "&rimid=" + rimid;
...
if ( pk == null || pk.equals("") ) {
  pk =    request.getParameter("connectionid") ;
}
...
<html>
  <head>
    ...
    {
      window.document.Sh_TMNConnectionForm.action = '/activator<%=moduleConfig%>/UpdateFormSh_TMNConnectionAction.do?datasource=<%= datasource %>&rimid=<%= rimid %>&_pk_=<%=pk %>&_location_=' + focusthis;
      window.document.Sh_TMNConnectionForm.submit();
    }
    function performCommit()
    {
      window.document.Sh_TMNConnectionForm.action = '/activator<%=moduleConfig%>/UpdateCommitSh_TMNConnectionAction.do?datasource=<%= datasource %>&rimid=<%= rimid %>&_pk_=<%=pk %>';
      window.document.Sh_TMNConnectionForm.submit();
    }
    function init()
    {
...
if(beanSh_TMNConnection==null)
   beanSh_TMNConnection = (com.hp.ov.activator.vpn.inventory.Sh_TMNConnection) request.getSession().getAttribute(Sh_TMNConnectionConstants.SH_TMNCONNECTION_BEAN);
...
nfB.setMaximumFractionDigits(6);
              ...
              String ConnectionID = beanSh_TMNConnection.getConnectionid();
        
            
                            
            
                
                String NetworkID1 = beanSh_TMNConnection.getNetworkid1();
        
            
                            
            
                
                String NetworkID2 = beanSh_TMNConnection.getNetworkid2();
        
            
                            
            
                
                String NE1 = beanSh_TMNConnection.getNe1();
        
            
                            
            
                
                String TP1 = beanSh_TMNConnection.getTp1();
        
            
                            
            
                
                String NE2 = beanSh_TMNConnection.getNe2();
        
            
                            
            
                
                String TP2 = beanSh_TMNConnection.getTp2();
        
            
                            
            
                
                String Marker = beanSh_TMNConnection.getMarker();
        
            
                            
            
                
                String UploadStatus = beanSh_TMNConnection.getUploadstatus();
        
            
                            
            
                
                String DBPrimaryKey = beanSh_TMNConnection.getDbprimarykey();
...
<h2 style="width:100%; text-align:center;">
  <bean:message bundle="Sh_TMNConnectionApplicationResources" key="jsp.update.title"/>
</h2> 
...
<input type="hidden" name="_update_commit_" value="true"/> 
    <table:table>
      ...
      <html:hidden property="refreshTreeRimid" value="<%= (String)request.getParameter(\"refreshTreeRimid\") %>"/>
              ...
              <table:cell>
                                                                        <html:text  property="networkid1" size="24" value="<%= NetworkID1 %>"/>
                                                </table:cell>
              <table:cell>
              ...
              <table:cell>
                                                                        <html:text  property="networkid2" size="24" value="<%= NetworkID2 %>"/>
                                                </table:cell>
              <table:cell>
              ...
              <table:cell>
                                                                        <html:text  property="ne1" size="24" value="<%= NE1 %>"/>
                                                </table:cell>
              <table:cell>
              ...
              <table:cell>
                                                                        <html:text  property="tp1" size="24" value="<%= TP1 %>"/>
                                                </table:cell>
              <table:cell>
              ...
              <table:cell>
                                                                        <html:text  property="ne2" size="24" value="<%= NE2 %>"/>
                                                </table:cell>
              <table:cell>
              ...
              <table:cell>
                                                                        <html:text  property="tp2" size="24" value="<%= TP2 %>"/>
                                                </table:cell>
              <table:cell>
