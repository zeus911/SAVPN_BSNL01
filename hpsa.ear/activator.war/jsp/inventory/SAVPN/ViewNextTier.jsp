...
String refreshTree = (String) request.getAttribute(NextTierConstants.REFRESH_TREE);
%>

<html>
  <head>
    <title><bean:message bundle="NextTierApplicationResources" key="<%= PERouterConstants.JSP_VIEW_TITLE %>"/></title>
	  ...
	  Connection con = null;
		try
		{
			...
			if (ds != null)
			{
				...
				beanPERouter = com.hp.ov.activator.vpn.inventory.PERouter.findByNetworkelementid(con,NextTierNetworkElementId);
...
<h2 style="width:100%; text-align:center;">
    <bean:message bundle="NextTierApplicationResources" key="<%= PERouterConstants.JSP_VIEW_TITLE %>"/>
</h2> 
</center>
<%
