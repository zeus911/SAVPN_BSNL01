...
String formAction = "/CreationCommitSh_L3VPNMembershipAction.do?datasource=" + datasource + "&rimid=" + rimid;
...
<html>
  <head>
    ...
    {
      window.document.Sh_L3VPNMembershipForm.action = '/activator<%=moduleConfig%>/CreationFormSh_L3VPNMembershipAction.do?datasource=<%= datasource %>&rimid=<%= rimid %>&_location_=' + focusthis;
      window.document.Sh_L3VPNMembershipForm.submit();
    }
    function performCommit()
    {
      window.document.Sh_L3VPNMembershipForm.action = '/activator<%=moduleConfig%>/CreationCommitSh_L3VPNMembershipAction.do?datasource=<%= datasource %>&rimid=<%= rimid %>';
      window.document.Sh_L3VPNMembershipForm.submit();
    }
    function init()
    {
...
<h2 style="width:100%; text-align:center;">
  <bean:message bundle="Sh_L3VPNMembershipApplicationResources" key="jsp.creation.title"/>
</h2> 
