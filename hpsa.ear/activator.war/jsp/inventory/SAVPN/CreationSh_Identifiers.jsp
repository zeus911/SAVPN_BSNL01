...
String formAction = "/CreationCommitSh_IdentifiersAction.do?datasource=" + datasource + "&rimid=" + rimid;
...
<html>
  <head>
    ...
    {
      window.document.Sh_IdentifiersForm.action = '/activator<%=moduleConfig%>/CreationFormSh_IdentifiersAction.do?datasource=<%= datasource %>&rimid=<%= rimid %>&_location_=' + focusthis;
      window.document.Sh_IdentifiersForm.submit();
    }
    function performCommit()
    {
      window.document.Sh_IdentifiersForm.action = '/activator<%=moduleConfig%>/CreationCommitSh_IdentifiersAction.do?datasource=<%= datasource %>&rimid=<%= rimid %>';
      window.document.Sh_IdentifiersForm.submit();
    }
    function init()
    {
...
<h2 style="width:100%; text-align:center;">
  <bean:message bundle="Sh_IdentifiersApplicationResources" key="jsp.creation.title"/>
</h2> 
...
<html:form action="<%= formAction %>" style="text-align:center;">
    <table:table>
      ...
      <html:hidden property="refreshTreeRimid" value="<%= (String)request.getParameter(\"refreshTreeRimid\") %>"/>
              ...
              <table:cell>
                                                                        <html:text  property="max_serviceid" size="24" value="<%= Max_ServiceId %>"/>
                                                </table:cell>
              <table:cell>
