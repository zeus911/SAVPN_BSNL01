...
String tabName = (String) request.getParameter(ServiceConstants.TAB_NAME);
...
<script>
function clearForm() {
var formObj = document.ServiceFormSearch;
...
if (element.type == 'select-one') { element.selectedIndex = -1; }
  ...
  var checkfalse=false;
                    if(document.getElementsByName("serviceid___hide")[0].checked) {
                      ...
                      if(checkfalse){
    alert("<bean:message bundle="ServiceApplicationResources" key="<%= ServiceConstants.JSP_SEARCH_NO_SHOW %>"/>");
  }else{
    window.document.ServiceFormSearch.action = '/activator<%=moduleConfig%>/SearchCommitServiceAction.do?datasource=<%= datasource %>&tab_name=<%= tabName %>&vi=<%= viParameter%>&view=<%= viewParameter %>&ndid=<%= ndidParameter %>';
    window.document.ServiceFormSearch.submit();
  }
  }
</script>
...
if (session == null || session.getValue(ServiceConstants.USER) == null) {
  response.sendRedirect(ServiceConstants.NULL_SESSION);
  return;
}
...
<h2 style="width:100%; text-align:center;">
  <bean:message bundle="ServiceApplicationResources" key="jsp.search.title"/>
</h2> 
...
<div style="color:#ff0000;">
      <html:errors bundle="ServiceApplicationResources" property="ServiceId"/>
        ...
        <html:errors bundle="ServiceApplicationResources" property="__count"/>
  <html:errors bundle="InventoryResources" property="warning"/>
</div>
<% String searchFormAction = "/SearchCommitServiceAction.do?datasource="+datasource+"&tab_name="+tabName+"&vi="+ viParameter+"&view="+ viewParameter +"&ndid="+ ndidParameter ;%>
      ...
      <table:header>
        ...
        <table:cell>
          <bean:message bundle="InventoryResources" key="description.heading"/>
            ...
            <table:cell>
              <bean:message bundle="ServiceApplicationResources" key="field.serviceid.alias"/>
            ...
            <table:cell>
              <bean:message bundle="ServiceApplicationResources" key="field.serviceid.description"/>
                          </table:cell>
          </table:row>
                                <table:row>
            <table:cell>
            ...
            <table:cell>
              <bean:message bundle="ServiceApplicationResources" key="field.customerid.alias"/>
            ...
            <table:cell>
              <bean:message bundle="ServiceApplicationResources" key="field.customerid.description"/>
                          </table:cell>
          </table:row>
                                              <table:row>
            <table:cell>
            ...
            <table:cell>
              <bean:message bundle="ServiceApplicationResources" key="field.servicename.alias"/>
            ...
            <table:cell>
              <bean:message bundle="ServiceApplicationResources" key="field.servicename.description"/>
                          </table:cell>
          </table:row>
                                <table:row>
            <table:cell>
