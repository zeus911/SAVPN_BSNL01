...
String refreshTree = (String) request.getAttribute(Sh_L3VPNConstants.REFRESH_TREE);
%>

<html>
  <head>
    <title><bean:message bundle="Sh_L3VPNApplicationResources" key="<%= Sh_L3VPNConstants.JSP_VIEW_TITLE %>"/></title>
...
<h2 style="width:100%; text-align:center;">
  <bean:message bundle="Sh_L3VPNApplicationResources" key="jsp.view.title"/>
</h2> 
