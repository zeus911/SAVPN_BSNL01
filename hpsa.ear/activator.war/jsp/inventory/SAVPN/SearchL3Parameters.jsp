...
String tabName = (String) request.getParameter(L3ParametersConstants.TAB_NAME);
...
<script>
function clearForm() {
var formObj = document.L3ParametersFormSearch;
...
if (element.type == 'select-one') { element.selectedIndex = -1; }
  ...
  var checkfalse=false;
            ...
            if(checkfalse){
    alert("<bean:message bundle="L3ParametersApplicationResources" key="<%= L3ParametersConstants.JSP_SEARCH_NO_SHOW %>"/>");
  }else{
    window.document.L3ParametersFormSearch.action = '/activator<%=moduleConfig%>/SearchCommitL3ParametersAction.do?datasource=<%= datasource %>&tab_name=<%= tabName %>&vi=<%= viParameter%>&view=<%= viewParameter %>&ndid=<%= ndidParameter %>';
    window.document.L3ParametersFormSearch.submit();
  }
  }
</script>
...
if (session == null || session.getValue(L3ParametersConstants.USER) == null) {
  response.sendRedirect(L3ParametersConstants.NULL_SESSION);
  return;
}
...
<h2 style="width:100%; text-align:center;">
  <bean:message bundle="L3ParametersApplicationResources" key="jsp.search.title"/>
</h2> 
...
<% String searchFormAction = "/SearchCommitL3ParametersAction.do?datasource="+datasource+"&tab_name="+tabName+"&vi="+ viParameter+"&view="+ viewParameter +"&ndid="+ ndidParameter ;%>
