...
String formAction = "/CreationCommitSh_TMNConnectionAction.do?datasource=" + datasource + "&rimid=" + rimid;
...
<html>
  <head>
    ...
    {
      window.document.Sh_TMNConnectionForm.action = '/activator<%=moduleConfig%>/CreationFormSh_TMNConnectionAction.do?datasource=<%= datasource %>&rimid=<%= rimid %>&_location_=' + focusthis;
      window.document.Sh_TMNConnectionForm.submit();
    }
    function performCommit()
    {
      window.document.Sh_TMNConnectionForm.action = '/activator<%=moduleConfig%>/CreationCommitSh_TMNConnectionAction.do?datasource=<%= datasource %>&rimid=<%= rimid %>';
      window.document.Sh_TMNConnectionForm.submit();
    }
    function init()
    {
...
<h2 style="width:100%; text-align:center;">
  <bean:message bundle="Sh_TMNConnectionApplicationResources" key="jsp.creation.title"/>
</h2> 
