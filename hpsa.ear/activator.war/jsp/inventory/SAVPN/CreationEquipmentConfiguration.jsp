...
String formAction = "/CreationCommitEquipmentConfigurationAction.do?datasource=" + datasource + "&rimid=" + rimid;
...
<html>
  <head>
    ...
    {
      window.document.EquipmentConfigurationForm.action = '/activator<%=moduleConfig%>/CreationFormEquipmentConfigurationAction.do?datasource=<%= datasource %>&rimid=<%= rimid %>&_location_=' + focusthis;
      window.document.EquipmentConfigurationForm.submit();
    }
    function performCommit()
    {
      window.document.EquipmentConfigurationForm.action = '/activator<%=moduleConfig%>/CreationCommitEquipmentConfigurationAction.do?datasource=<%= datasource %>&rimid=<%= rimid %>';
      window.document.EquipmentConfigurationForm.submit();
    }
    function init()
    {
...
<h2 style="width:100%; text-align:center;">
  <bean:message bundle="EquipmentConfigurationApplicationResources" key="jsp.creation.title"/>
</h2> 
...
<html:form action="<%= formAction %>" style="text-align:center;">
    <table:table>
      ...
      <html:hidden property="refreshTreeRimid" value="<%= (String)request.getParameter(\"refreshTreeRimid\") %>"/>
              ...
              <table:cell>
                                                                        <html:text  property="equipmentid" size="24" value="<%= EquipmentID %>"/>
                                                </table:cell>
              <table:cell>
              ...
              <table:cell>
                                                                        <html:text  property="timestamp" size="24" value="<%= TimeStamp %>"/>
                                                </table:cell>
              <table:cell>
              ...
              <table:cell>
                                                                        <html:textarea  property="data" cols="60" rows="10" value="<%= Data %>" style="resize:true;"/>
                                                </table:cell>
              <table:cell>
