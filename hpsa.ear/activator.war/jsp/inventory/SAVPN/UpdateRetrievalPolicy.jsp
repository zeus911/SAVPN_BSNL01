...
String formAction = "/UpdateCommitRetrievalPolicyAction.do?datasource=" + datasource + "&rimid=" + rimid;
...
if ( pk == null || pk.equals("") ) {
  pk =    request.getParameter("retrievalpolicyname") ;
}
...
<html>
  <head>
    ...
    {
      window.document.RetrievalPolicyForm.action = '/activator<%=moduleConfig%>/UpdateFormRetrievalPolicyAction.do?datasource=<%= datasource %>&rimid=<%= rimid %>&_pk_=<%=pk %>&_location_=' + focusthis;
      window.document.RetrievalPolicyForm.submit();
    }
    function performCommit()
    {
      window.document.RetrievalPolicyForm.action = '/activator<%=moduleConfig%>/UpdateCommitRetrievalPolicyAction.do?datasource=<%= datasource %>&rimid=<%= rimid %>&_pk_=<%=pk %>';
      window.document.RetrievalPolicyForm.submit();
    }
    function init()
    {
...
if(beanRetrievalPolicy==null)
   beanRetrievalPolicy = (com.hp.ov.activator.vpn.inventory.RetrievalPolicy) request.getSession().getAttribute(RetrievalPolicyConstants.RETRIEVALPOLICY_BEAN);
...
<h2 style="width:100%; text-align:center;">
  <bean:message bundle="RetrievalPolicyApplicationResources" key="jsp.update.title"/>
</h2> 
...
<input type="hidden" name="_update_commit_" value="true"/> 
    <table:table>
      ...
      <html:hidden property="refreshTreeRimid" value="<%= (String)request.getParameter(\"refreshTreeRimid\") %>"/>
              ...
              <table:cell>
                                                      <html:hidden property="retrievalpolicyname" value="<%= RetrievalPolicyName %>"/>
                                                        <html:text disabled="true" property="retrievalpolicyname" size="24" value="<%= RetrievalPolicyName %>"/>
                                                </table:cell>
              <table:cell>
