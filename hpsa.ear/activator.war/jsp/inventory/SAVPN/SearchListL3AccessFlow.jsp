...
ArrayList al = (ArrayList) session.getAttribute(request.getParameter(L3AccessFlowConstants.TAB_NAME));
String useRandomColor="1";
String mainColor ="1";

String datasource = request.getParameter(L3AccessFlowConstants.DATASOURCE);
String tabName = request.getParameter(L3AccessFlowConstants.TAB_NAME);
...
String SecondaryIPNet___hide = null;
String SecondaryNetmask___hide = null;
...
StringBuffer requestURI = new StringBuffer("/activator/jsp/inventory/SearchListL3AccessFlow.jsp?");
...
if ( form != null ) {
  ...
  SecondaryIPNet___hide = form.getSecondaryipnet___hide();
  SecondaryNetmask___hide = form.getSecondarynetmask___hide();
  ...
  if ( SecondaryIPNet___hide != null )
    requestURI.append("secondaryipnet___hide=" + SecondaryIPNet___hide);
  if ( SecondaryNetmask___hide != null )
    requestURI.append("secondarynetmask___hide=" + SecondaryNetmask___hide);
  ...
  if ( CE_based_QoS___hide != null )
    ...
    SecondaryIPNet___hide = request.getParameter("secondaryipnet___hide");
    SecondaryNetmask___hide = request.getParameter("secondarynetmask___hide");
...
<html>
  <head>
    <title><bean:message bundle="L3AccessFlowApplicationResources" key="<%= L3AccessFlowConstants.JSP_RESULTS_TITLE %>"/></title>
  ...
  <bean:message bundle="L3AccessFlowApplicationResources" key="jsp.search.results.title"/>
</h2> 

<display:table id="elementSearch" style="width:100%" requestURI="SearchCommitL3AccessFlowAction.do" name="<%= searchListName %>" pagesize="10" export="true" sort="list" partialList="true" size="resultSize" decorator="com.hp.ov.activator.mwfm.servlet.inventory.inventorytree.taglib.displaytag.decorator.InventoryBuilderTableDecorator">

<%
        if ( ServiceId___hide == null || ServiceId___hide.equals("null") ) {
%>
      <display:column property="serviceid" sortable="true" titleKey="L3AccessFlowApplicationResources:field.serviceid.alias" headerClass="tableTitle" class="tableCell"/>
<%
        }
        if ( CustomerId___hide == null || CustomerId___hide.equals("null") ) {
%>
      <display:column property="customerid" sortable="true" titleKey="L3AccessFlowApplicationResources:field.customerid.alias" headerClass="tableTitle" class="tableCell"/>
<%
        }
        if ( ServiceName___hide == null || ServiceName___hide.equals("null") ) {
%>
      <display:column property="servicename" sortable="true" titleKey="L3AccessFlowApplicationResources:field.servicename.alias" headerClass="tableTitle" class="tableCell"/>
<%
        }
        if ( InitiationDate___hide == null || InitiationDate___hide.equals("null") ) {
%>
      <display:column property="initiationdate" sortable="true" titleKey="L3AccessFlowApplicationResources:field.initiationdate.alias" headerClass="tableTitle" class="tableCell"/>
<%
        }
        if ( ActivationDate___hide == null || ActivationDate___hide.equals("null") ) {
%>
      <display:column property="activationdate" sortable="true" titleKey="L3AccessFlowApplicationResources:field.activationdate.alias" headerClass="tableTitle" class="tableCell"/>
<%
        }
        if ( ModificationDate___hide == null || ModificationDate___hide.equals("null") ) {
%>
      <display:column property="modificationdate" sortable="true" titleKey="L3AccessFlowApplicationResources:field.modificationdate.alias" headerClass="tableTitle" class="tableCell"/>
<%
        }
        if ( State___hide == null || State___hide.equals("null") ) {
%>
      <display:column property="state" sortable="true" titleKey="L3AccessFlowApplicationResources:field.state.alias" headerClass="tableTitle" class="tableCell"/>
<%
        }
        if ( Type___hide == null || Type___hide.equals("null") ) {
%>
      <display:column property="type" sortable="true" titleKey="L3AccessFlowApplicationResources:field.type.alias" headerClass="tableTitle" class="tableCell"/>
<%
        }
        if ( AddressFamily___hide == null || AddressFamily___hide.equals("null") ) {
%>
      <display:column property="addressfamily" sortable="true" titleKey="L3AccessFlowApplicationResources:field.addressfamily.alias" headerClass="tableTitle" class="tableCell"/>
<%
        }
        if ( ContactPerson___hide == null || ContactPerson___hide.equals("null") ) {
%>
      <display:column property="contactperson" sortable="true" titleKey="L3AccessFlowApplicationResources:field.contactperson.alias" headerClass="tableTitle" class="tableCell"/>
<%
        }
        if ( Comments___hide == null || Comments___hide.equals("null") ) {
%>
      <display:column property="comments" sortable="true" titleKey="L3AccessFlowApplicationResources:field.comments.alias" headerClass="tableTitle" class="tableCell"/>
<%
        }
        if ( SiteId___hide == null || SiteId___hide.equals("null") ) {
%>
      <display:column property="siteid" sortable="true" titleKey="L3AccessFlowApplicationResources:field.siteid.alias" headerClass="tableTitle" class="tableCell"/>
<%
        }
        if ( VlanId___hide == null || VlanId___hide.equals("null") ) {
%>
      <display:column property="vlanid" sortable="true" titleKey="L3AccessFlowApplicationResources:field.vlanid.alias" headerClass="tableTitle" class="tableCell"/>
<%
        }
        if ( PE_Status___hide == null || PE_Status___hide.equals("null") ) {
%>
      <display:column property="pe_status" sortable="true" titleKey="L3AccessFlowApplicationResources:field.pe_status.alias" headerClass="tableTitle" class="tableCell"/>
<%
        }
        if ( CE_Status___hide == null || CE_Status___hide.equals("null") ) {
%>
      <display:column property="ce_status" sortable="true" titleKey="L3AccessFlowApplicationResources:field.ce_status.alias" headerClass="tableTitle" class="tableCell"/>
<%
        }
        if ( AccessNW_Status___hide == null || AccessNW_Status___hide.equals("null") ) {
%>
      <display:column property="accessnw_status" sortable="true" titleKey="L3AccessFlowApplicationResources:field.accessnw_status.alias" headerClass="tableTitle" class="tableCell"/>
<%
        }
        if ( ASBR_Status___hide == null || ASBR_Status___hide.equals("null") ) {
%>
      <display:column property="asbr_status" sortable="true" titleKey="L3AccessFlowApplicationResources:field.asbr_status.alias" headerClass="tableTitle" class="tableCell"/>
<%
        }
        if ( IPNet___hide == null || IPNet___hide.equals("null") ) {
%>
      <display:column property="ipnet" sortable="true" titleKey="L3AccessFlowApplicationResources:field.ipnet.alias" headerClass="tableTitle" class="tableCell"/>
<%
        }
        if ( Netmask___hide == null || Netmask___hide.equals("null") ) {
%>
      <display:column property="netmask" sortable="true" titleKey="L3AccessFlowApplicationResources:field.netmask.alias" headerClass="tableTitle" class="tableCell"/>
<%
        }
        if ( SecondaryIPNet___hide == null || SecondaryIPNet___hide.equals("null") ) {
%>
      <display:column property="secondaryipnet" sortable="true" titleKey="L3AccessFlowApplicationResources:field.secondaryipnet.alias" headerClass="tableTitle" class="tableCell"/>
<%
        }
        if ( SecondaryNetmask___hide == null || SecondaryNetmask___hide.equals("null") ) {
%>
      <display:column property="secondarynetmask" sortable="true" titleKey="L3AccessFlowApplicationResources:field.secondarynetmask.alias" headerClass="tableTitle" class="tableCell"/>
<%
        }
        if ( Domain_id___hide == null || Domain_id___hide.equals("null") ) {
%>
      <display:column property="domain_id" sortable="true" titleKey="L3AccessFlowApplicationResources:field.domain_id.alias" headerClass="tableTitle" class="tableCell"/>
<%
        }
        if ( MDTData___hide == null || MDTData___hide.equals("null") ) {
%>
      <display:column property="mdtdata" sortable="true" titleKey="L3AccessFlowApplicationResources:field.mdtdata.alias" headerClass="tableTitle" class="tableCell"/>
<%
        }
        if ( LoopAddr___hide == null || LoopAddr___hide.equals("null") ) {
%>
      <display:column property="loopaddr" sortable="true" titleKey="L3AccessFlowApplicationResources:field.loopaddr.alias" headerClass="tableTitle" class="tableCell"/>
<%
        }
        if ( RP___hide == null || RP___hide.equals("null") ) {
%>
      <display:column property="rp" sortable="true" titleKey="L3AccessFlowApplicationResources:field.rp.alias" headerClass="tableTitle" class="tableCell"/>
<%
        }
        if ( CE_based_QoS___hide == null || CE_based_QoS___hide.equals("null") ) {
%>
      <display:column property="ce_based_qos" sortable="true" titleKey="L3AccessFlowApplicationResources:field.ce_based_qos.alias" headerClass="tableTitle" class="tableCell"/>
<%
    }
%>
</display:table>
...
String backAction = "SearchFormL3AccessFlowAction.do?datasource=" + datasource + "&tab_name=" + tabName + "&vi=" + viParameter + "&view=" + viewParameter + "&ndid=" + ndidParameter;
%>
...
%>
                ...
                <html:hidden property="netmask___hide" value="<%= form.getNetmask___hide() %>"/>
                        <html:hidden property="secondaryipnet" value="<%= form.getSecondaryipnet() %>"/>
                <html:hidden property="secondaryipnet___hide" value="<%= form.getSecondaryipnet___hide() %>"/>
                        <html:hidden property="secondarynetmask" value="<%= form.getSecondarynetmask() %>"/>
                <html:hidden property="secondarynetmask___hide" value="<%= form.getSecondarynetmask___hide() %>"/>
...
%>
                ...
                <html:hidden property="netmask___hide" value="<%= request.getParameter(\"netmask___hide\") %>"/>
                        <html:hidden property="secondaryipnet" value="<%= request.getParameter(\"secondaryipnet\") %>"/>
                <html:hidden property="secondaryipnet___hide" value="<%= request.getParameter(\"secondaryipnet___hide\") %>"/>
                        <html:hidden property="secondarynetmask" value="<%= request.getParameter(\"secondarynetmask\") %>"/>
                <html:hidden property="secondarynetmask___hide" value="<%= request.getParameter(\"secondarynetmask___hide\") %>"/>
...
%>
    <input type="submit" value="<%= backMessage %>" onclick="window.document.L3AccessFlowForm.submit()"/>
  </html:form>
