...
String formAction = "/CreationCommitAdminVPNAction.do?datasource=" + datasource + "&rimid=" + rimid;
...
<html>
  <head>
    ...
    {
      window.document.AdminVPNForm.action = '/activator<%=moduleConfig%>/CreationFormAdminVPNAction.do?datasource=<%= datasource %>&rimid=<%= rimid %>&_location_=' + focusthis;
      window.document.AdminVPNForm.submit();
    }
    function performCommit()
    {
      window.document.AdminVPNForm.action = '/activator<%=moduleConfig%>/CreationCommitAdminVPNAction.do?datasource=<%= datasource %>&rimid=<%= rimid %>';
      window.document.AdminVPNForm.submit();
    }
    function init()
    {
...
<h2 style="width:100%; text-align:center;">
  <bean:message bundle="AdminVPNApplicationResources" key="jsp.creation.title"/>
</h2> 
...
<html:form action="<%= formAction %>" style="text-align:center;">
    <table:table>
      ...
      <html:hidden property="refreshTreeRimid" value="<%= (String)request.getParameter(\"refreshTreeRimid\") %>"/>
              ...
              <table:cell>
                                                                        <html:text  property="vrfid" size="24" value="<%= VRFID %>"/>
                                                </table:cell>
              <table:cell>
