<%@page info="Update JSP for bean Sh_VPN"
...
<%
    ...
    %>
<form name="form1" method="POST" action="UpdateFormSh_VPNCustomized.jsp">
...
<%
    ...
    com.hp.ov.activator.vpn.inventory.Sh_VPN dbBean = (com.hp.ov.activator.vpn.inventory.Sh_VPN)com.hp.ov.activator.vpn.inventory.Sh_VPN.findByPrimaryKey( connection, bean.getPrimaryKey() );
          ...
          if (hashcode != ActivatorUtils.calculateHashValue(dbBean)) {
            ...
            String statement = "update sh_service set customerid='" + customerid
                + "' where serviceid in (select serviceid from sh_accessflow where siteid='"
     ...
     %>
        <b>Sh_VPN '<%= bean.getPrimaryKey() %>' stored successfully.</b>
