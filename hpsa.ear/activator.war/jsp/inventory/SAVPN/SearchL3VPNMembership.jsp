...
String tabName = (String) request.getParameter(L3VPNMembershipConstants.TAB_NAME);
...
<script>
function clearForm() {
var formObj = document.L3VPNMembershipFormSearch;
...
if (element.type == 'select-one') { element.selectedIndex = -1; }
  ...
  var checkfalse=false;
            ...
            if(checkfalse){
    alert("<bean:message bundle="L3VPNMembershipApplicationResources" key="<%= L3VPNMembershipConstants.JSP_SEARCH_NO_SHOW %>"/>");
  }else{
    window.document.L3VPNMembershipFormSearch.action = '/activator<%=moduleConfig%>/SearchCommitL3VPNMembershipAction.do?datasource=<%= datasource %>&tab_name=<%= tabName %>&vi=<%= viParameter%>&view=<%= viewParameter %>&ndid=<%= ndidParameter %>';
    window.document.L3VPNMembershipFormSearch.submit();
  }
  }
</script>
...
if (session == null || session.getValue(L3VPNMembershipConstants.USER) == null) {
  response.sendRedirect(L3VPNMembershipConstants.NULL_SESSION);
  return;
}
...
<h2 style="width:100%; text-align:center;">
  <bean:message bundle="L3VPNMembershipApplicationResources" key="jsp.search.title"/>
</h2> 
...
<% String searchFormAction = "/SearchCommitL3VPNMembershipAction.do?datasource="+datasource+"&tab_name="+tabName+"&vi="+ viParameter+"&view="+ viewParameter +"&ndid="+ ndidParameter ;%>
