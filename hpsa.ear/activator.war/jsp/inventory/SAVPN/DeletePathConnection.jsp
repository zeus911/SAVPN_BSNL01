...
<html>
  <head>
    <title><bean:message bundle="PathConnectionApplicationResources" key="<%= PathConnectionConstants.JSP_DELETE_TITLE %>"/></title>
    ...
    {
      window.document.PathConnectionForm.action = '/activator<%=moduleConfig%>/DeleteCommitPathConnectionAction.do?datasource=<%= datasource %>&rimid=<%= rimid %>';
      window.document.PathConnectionForm.submit();
    }
    function init()
    {
      var confirm = new HPSAConfirm('Confirm','<bean:message bundle="PathConnectionApplicationResources" key="delete.confirm"/>', '<bean:message bundle="InventoryResources" key="confirm.ok_button.label"/>', '<bean:message bundle="InventoryResources" key="confirm.cancel_button.label"/>');
...
nfB.setMaximumFractionDigits(6);
                  ...
                  String ConnectionID = StringFacility.replaceAllByHTMLCharacter(beanPathConnection.getConnectionid());
                        
                                  
                      String PathID = StringFacility.replaceAllByHTMLCharacter(beanPathConnection.getPathid());
...
<h2 style="width:100%; text-align:center;">
    <bean:message bundle="PathConnectionApplicationResources" key="jsp.delete.title"/>
</h2> 
...
%>
    ...
    <html:form action="/DeleteCommitPathConnectionAction.do">
    <html:hidden property="refreshTreeRimid" value="<%= (String)request.getParameter(\"refreshTreeRimid\") %>"/>
                  <html:hidden property="ordernumber" value="<%= String.valueOf(OrderNumber) %>"/>
              </html:form>
  </body>
</html>
