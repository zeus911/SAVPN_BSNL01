...
String formAction = "/CreationCommitRCAction.do?datasource=" + datasource + "&rimid=" + rimid;
...
<html>
  <head>
    ...
    {
      window.document.RCForm.action = '/activator<%=moduleConfig%>/CreationFormRCAction.do?datasource=<%= datasource %>&rimid=<%= rimid %>&_location_=' + focusthis;
      window.document.RCForm.submit();
    }
    function performCommit()
    {
      window.document.RCForm.action = '/activator<%=moduleConfig%>/CreationCommitRCAction.do?datasource=<%= datasource %>&rimid=<%= rimid %>';
      window.document.RCForm.submit();
    }
    function init()
    {
...
<h2 style="width:100%; text-align:center;">
  <bean:message bundle="RCApplicationResources" key="jsp.creation.title"/>
</h2> 
