...
String refreshTree = (String) request.getAttribute(L2FlowPointConstants.REFRESH_TREE);
%>

<html>
  <head>
    <title><bean:message bundle="L2FlowPointApplicationResources" key="<%= L2FlowPointConstants.JSP_VIEW_TITLE %>"/></title>
...
<h2 style="width:100%; text-align:center;">
  <bean:message bundle="L2FlowPointApplicationResources" key="jsp.view.title"/>
</h2> 
