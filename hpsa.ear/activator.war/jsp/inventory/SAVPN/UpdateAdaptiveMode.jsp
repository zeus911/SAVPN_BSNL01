...
String formAction = "/UpdateCommitAdaptiveModeAction.do?datasource=" + datasource + "&rimid=" + rimid;
...
<html>
  <head>
    ...
    {
      window.document.AdaptiveModeForm.action = '/activator<%=moduleConfig%>/UpdateFormAdaptiveModeAction.do?datasource=<%= datasource %>&rimid=<%= rimid %>&_pk_=<%=pk %>&_location_=' + focusthis;
      window.document.AdaptiveModeForm.submit();
    }
    function performCommit()
    {
      window.document.AdaptiveModeForm.action = '/activator<%=moduleConfig%>/UpdateCommitAdaptiveModeAction.do?datasource=<%= datasource %>&rimid=<%= rimid %>&_pk_=<%=pk %>';
      window.document.AdaptiveModeForm.submit();
    }
    function init()
    {
...
if(beanAdaptiveMode==null)
   beanAdaptiveMode = (com.hp.ov.activator.vpn.inventory.AdaptiveMode) request.getSession().getAttribute(AdaptiveModeConstants.ADAPTIVEMODE_BEAN);
...
nfB.setMaximumFractionDigits(6);
              ...
              String IDName = beanAdaptiveMode.getIdname();
...
<h2 style="width:100%; text-align:center;">
  <bean:message bundle="AdaptiveModeApplicationResources" key="jsp.update.title"/>
</h2> 
...
<input type="hidden" name="_update_commit_" value="true"/> 
    <table:table>
      ...
      <html:hidden property="refreshTreeRimid" value="<%= (String)request.getParameter(\"refreshTreeRimid\") %>"/>
              ...
              <table:cell>
                                  <html:checkbox  property="adaptivemodeenabled" value="true"/>
                  <html:hidden  property="adaptivemodeenabled" value="false"/>
                              </table:cell>
              <table:cell>
              ...
              <table:cell>
                                  <html:checkbox  property="dynamicmodeenabled" value="true"/>
                  <html:hidden  property="dynamicmodeenabled" value="false"/>
                              </table:cell>
              <table:cell>
