...
String refreshTree = (String) request.getAttribute(DLCIRangeConstants.REFRESH_TREE);
%>

<html>
  <head>
    <title><bean:message bundle="DLCIRangeApplicationResources" key="<%= DLCIRangeConstants.JSP_VIEW_TITLE %>"/></title>
...
<h2 style="width:100%; text-align:center;">
  <bean:message bundle="DLCIRangeApplicationResources" key="jsp.view.title"/>
</h2> 
