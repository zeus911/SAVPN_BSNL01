...
ArrayList al = (ArrayList) session.getAttribute(request.getParameter(Sh_L3FlowPointConstants.TAB_NAME));
String useRandomColor="1";
String mainColor ="1";

String datasource = request.getParameter(Sh_L3FlowPointConstants.DATASOURCE);
String tabName = request.getParameter(Sh_L3FlowPointConstants.TAB_NAME);
...
StringBuffer requestURI = new StringBuffer("/activator/jsp/inventory/SearchListSh_L3FlowPoint.jsp?");
...
<html>
  <head>
    <title><bean:message bundle="Sh_L3FlowPointApplicationResources" key="<%= Sh_L3FlowPointConstants.JSP_RESULTS_TITLE %>"/></title>
  ...
  <bean:message bundle="Sh_L3FlowPointApplicationResources" key="jsp.search.results.title"/>
</h2> 

<display:table id="elementSearch" style="width:100%" requestURI="SearchCommitSh_L3FlowPointAction.do" name="<%= searchListName %>" pagesize="10" export="true" sort="list" partialList="true" size="resultSize" decorator="com.hp.ov.activator.mwfm.servlet.inventory.inventorytree.taglib.displaytag.decorator.InventoryBuilderTableDecorator">

<%
        if ( TerminationPointID___hide == null || TerminationPointID___hide.equals("null") ) {
%>
      <display:column property="terminationpointid" sortable="true" titleKey="Sh_L3FlowPointApplicationResources:field.terminationpointid.alias" headerClass="tableTitle" class="tableCell"/>
<%
        }
        if ( AttachmentId___hide == null || AttachmentId___hide.equals("null") ) {
%>
      <display:column property="attachmentid" sortable="true" titleKey="Sh_L3FlowPointApplicationResources:field.attachmentid.alias" headerClass="tableTitle" class="tableCell"/>
<%
        }
        if ( QoSProfile_in___hide == null || QoSProfile_in___hide.equals("null") ) {
%>
      <display:column property="qosprofile_in" sortable="true" titleKey="Sh_L3FlowPointApplicationResources:field.qosprofile_in.alias" headerClass="tableTitle" class="tableCell"/>
<%
        }
        if ( QoSProfile_out___hide == null || QoSProfile_out___hide.equals("null") ) {
%>
      <display:column property="qosprofile_out" sortable="true" titleKey="Sh_L3FlowPointApplicationResources:field.qosprofile_out.alias" headerClass="tableTitle" class="tableCell"/>
<%
        }
        if ( RateLimit_in___hide == null || RateLimit_in___hide.equals("null") ) {
%>
      <display:column property="ratelimit_in" sortable="true" titleKey="Sh_L3FlowPointApplicationResources:field.ratelimit_in.alias" headerClass="tableTitle" class="tableCell"/>
<%
        }
        if ( RateLimit_out___hide == null || RateLimit_out___hide.equals("null") ) {
%>
      <display:column property="ratelimit_out" sortable="true" titleKey="Sh_L3FlowPointApplicationResources:field.ratelimit_out.alias" headerClass="tableTitle" class="tableCell"/>
<%
        }
        if ( Marker___hide == null || Marker___hide.equals("null") ) {
%>
      <display:column property="marker" sortable="true" titleKey="Sh_L3FlowPointApplicationResources:field.marker.alias" headerClass="tableTitle" class="tableCell"/>
<%
        }
        if ( UploadStatus___hide == null || UploadStatus___hide.equals("null") ) {
%>
      <display:column property="uploadstatus" sortable="true" titleKey="Sh_L3FlowPointApplicationResources:field.uploadstatus.alias" headerClass="tableTitle" class="tableCell"/>
<%
        }
        if ( DBPrimaryKey___hide == null || DBPrimaryKey___hide.equals("null") ) {
%>
      <display:column property="dbprimarykey" sortable="true" titleKey="Sh_L3FlowPointApplicationResources:field.dbprimarykey.alias" headerClass="tableTitle" class="tableCell"/>
<%
        }
        if ( Protocol___hide == null || Protocol___hide.equals("null") ) {
%>
      <display:column property="protocol" sortable="true" titleKey="Sh_L3FlowPointApplicationResources:field.protocol.alias" headerClass="tableTitle" class="tableCell"/>
<%
        }
        if ( Maximum_Prefix___hide == null || Maximum_Prefix___hide.equals("null") ) {
%>
      <display:column property="maximum_prefix" sortable="true" titleKey="Sh_L3FlowPointApplicationResources:field.maximum_prefix.alias" headerClass="tableTitle" class="tableCell"/>
<%
        }
        if ( StaticRoutes___hide == null || StaticRoutes___hide.equals("null") ) {
%>
      <display:column property="staticroutes" sortable="true" titleKey="Sh_L3FlowPointApplicationResources:field.staticroutes.alias" headerClass="tableTitle" class="tableCell"/>
<%
        }
        if ( OSPF_id___hide == null || OSPF_id___hide.equals("null") ) {
%>
      <display:column property="ospf_id" sortable="true" titleKey="Sh_L3FlowPointApplicationResources:field.ospf_id.alias" headerClass="tableTitle" class="tableCell"/>
<%
        }
        if ( Rip_id___hide == null || Rip_id___hide.equals("null") ) {
%>
      <display:column property="rip_id" sortable="true" titleKey="Sh_L3FlowPointApplicationResources:field.rip_id.alias" headerClass="tableTitle" class="tableCell"/>
<%
        }
        if ( VRFName___hide == null || VRFName___hide.equals("null") ) {
%>
      <display:column property="vrfname" sortable="true" titleKey="Sh_L3FlowPointApplicationResources:field.vrfname.alias" headerClass="tableTitle" class="tableCell"/>
<%
        }
        if ( PE_InterfaceIP___hide == null || PE_InterfaceIP___hide.equals("null") ) {
%>
      <display:column property="pe_interfaceip" sortable="true" titleKey="Sh_L3FlowPointApplicationResources:field.pe_interfaceip.alias" headerClass="tableTitle" class="tableCell"/>
<%
        }
        if ( CE_InterfaceIP___hide == null || CE_InterfaceIP___hide.equals("null") ) {
%>
      <display:column property="ce_interfaceip" sortable="true" titleKey="Sh_L3FlowPointApplicationResources:field.ce_interfaceip.alias" headerClass="tableTitle" class="tableCell"/>
<%
        }
        if ( mCAR___hide == null || mCAR___hide.equals("null") ) {
%>
      <display:column property="mcar" sortable="true" titleKey="Sh_L3FlowPointApplicationResources:field.mcar.alias" headerClass="tableTitle" class="tableCell"/>
<%
        }
        if ( mCoS___hide == null || mCoS___hide.equals("null") ) {
%>
      <display:column property="mcos" sortable="true" titleKey="Sh_L3FlowPointApplicationResources:field.mcos.alias" headerClass="tableTitle" class="tableCell"/>
<%
        }
        if ( LoopbackId___hide == null || LoopbackId___hide.equals("null") ) {
%>
      <display:column property="loopbackid" sortable="true" titleKey="Sh_L3FlowPointApplicationResources:field.loopbackid.alias" headerClass="tableTitle" class="tableCell"/>
<%
        }
        if ( SOO_Configured___hide == null || SOO_Configured___hide.equals("null") ) {
%>
      <display:column property="soo_configured" sortable="true" titleKey="Sh_L3FlowPointApplicationResources:field.soo_configured.alias" headerClass="tableTitle" class="tableCell"/>
<%
    }
%>
</display:table>
...
String backAction = "SearchFormSh_L3FlowPointAction.do?datasource=" + datasource + "&tab_name=" + tabName + "&vi=" + viParameter + "&view=" + viewParameter + "&ndid=" + ndidParameter;
%>
...
%>
    <input type="submit" value="<%= backMessage %>" onclick="window.document.Sh_L3FlowPointForm.submit()"/>
  </html:form>
