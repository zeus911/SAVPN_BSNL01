...
String formAction = "/CreationCommitSh_CustomerAction.do?datasource=" + datasource + "&rimid=" + rimid;
...
<html>
  <head>
    ...
    {
      window.document.Sh_CustomerForm.action = '/activator<%=moduleConfig%>/CreationFormSh_CustomerAction.do?datasource=<%= datasource %>&rimid=<%= rimid %>&_location_=' + focusthis;
      window.document.Sh_CustomerForm.submit();
    }
    function performCommit()
    {
      window.document.Sh_CustomerForm.action = '/activator<%=moduleConfig%>/CreationCommitSh_CustomerAction.do?datasource=<%= datasource %>&rimid=<%= rimid %>';
      window.document.Sh_CustomerForm.submit();
    }
    function init()
    {
...
<h2 style="width:100%; text-align:center;">
  <bean:message bundle="Sh_CustomerApplicationResources" key="jsp.creation.title"/>
</h2> 
