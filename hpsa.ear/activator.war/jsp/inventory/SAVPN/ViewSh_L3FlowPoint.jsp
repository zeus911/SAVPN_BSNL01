...
String refreshTree = (String) request.getAttribute(Sh_L3FlowPointConstants.REFRESH_TREE);
%>

<html>
  <head>
    <title><bean:message bundle="Sh_L3FlowPointApplicationResources" key="<%= Sh_L3FlowPointConstants.JSP_VIEW_TITLE %>"/></title>
...
<h2 style="width:100%; text-align:center;">
  <bean:message bundle="Sh_L3FlowPointApplicationResources" key="jsp.view.title"/>
</h2> 
