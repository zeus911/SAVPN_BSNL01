...
String formAction = "/CreationCommitASBRFlowPointAction.do?datasource=" + datasource + "&rimid=" + rimid;
...
<html>
  <head>
    ...
    {
      window.document.ASBRFlowPointForm.action = '/activator<%=moduleConfig%>/CreationFormASBRFlowPointAction.do?datasource=<%= datasource %>&rimid=<%= rimid %>&_location_=' + focusthis;
      window.document.ASBRFlowPointForm.submit();
    }
    function performCommit()
    {
      window.document.ASBRFlowPointForm.action = '/activator<%=moduleConfig%>/CreationCommitASBRFlowPointAction.do?datasource=<%= datasource %>&rimid=<%= rimid %>';
      window.document.ASBRFlowPointForm.submit();
    }
    function init()
    {
...
<h2 style="width:100%; text-align:center;">
  <bean:message bundle="ASBRFlowPointApplicationResources" key="jsp.creation.title"/>
</h2> 
