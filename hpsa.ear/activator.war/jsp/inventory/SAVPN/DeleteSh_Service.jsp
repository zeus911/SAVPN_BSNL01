...
<html>
  <head>
    <title><bean:message bundle="Sh_ServiceApplicationResources" key="<%= Sh_ServiceConstants.JSP_DELETE_TITLE %>"/></title>
    ...
    {
      window.document.Sh_ServiceForm.action = '/activator<%=moduleConfig%>/DeleteCommitSh_ServiceAction.do?datasource=<%= datasource %>&rimid=<%= rimid %>';
      window.document.Sh_ServiceForm.submit();
    }
    function init()
    {
      var confirm = new HPSAConfirm('Confirm','<bean:message bundle="Sh_ServiceApplicationResources" key="delete.confirm"/>', '<bean:message bundle="InventoryResources" key="confirm.ok_button.label"/>', '<bean:message bundle="InventoryResources" key="confirm.cancel_button.label"/>');
...
<h2 style="width:100%; text-align:center;">
    <bean:message bundle="Sh_ServiceApplicationResources" key="jsp.delete.title"/>
</h2> 
...
%>
    ...
    <html:form action="/DeleteCommitSh_ServiceAction.do">
