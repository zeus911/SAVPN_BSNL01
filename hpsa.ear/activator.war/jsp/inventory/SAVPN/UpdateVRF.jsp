...
String formAction = "/UpdateCommitVRFAction.do?datasource=" + datasource + "&rimid=" + rimid;
...
<html>
  <head>
    ...
    {
      window.document.VRFForm.action = '/activator<%=moduleConfig%>/UpdateFormVRFAction.do?datasource=<%= datasource %>&rimid=<%= rimid %>&_pk_=<%=pk %>&_location_=' + focusthis;
      window.document.VRFForm.submit();
    }
    function performCommit()
    {
      window.document.VRFForm.action = '/activator<%=moduleConfig%>/UpdateCommitVRFAction.do?datasource=<%= datasource %>&rimid=<%= rimid %>&_pk_=<%=pk %>';
      window.document.VRFForm.submit();
    }
    function init()
    {
...
if(beanVRF==null)
   beanVRF = (com.hp.ov.activator.vpn.inventory.VRF) request.getSession().getAttribute(VRFConstants.VRF_BEAN);
...
<h2 style="width:100%; text-align:center;">
  <bean:message bundle="VRFApplicationResources" key="jsp.update.title"/>
</h2> 
