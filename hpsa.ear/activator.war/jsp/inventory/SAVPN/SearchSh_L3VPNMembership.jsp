...
if(form==null) {
 form=new Sh_L3VPNMembershipForm();
} 
...
String tabName = (String) request.getParameter(Sh_L3VPNMembershipConstants.TAB_NAME);
...
<script>
function clearForm() {
var formObj = document.Sh_L3VPNMembershipFormSearch;
...
if (element.type == 'select-one') { element.selectedIndex = -1; }
  ...
  var checkfalse=false;
                    if(document.getElementsByName("vpnid___hide")[0].checked) {
                            ...
                            if(document.getElementsByName("joindate___hide")[0].checked) {
            ...
            if(checkfalse){
    alert("<bean:message bundle="Sh_L3VPNMembershipApplicationResources" key="<%= Sh_L3VPNMembershipConstants.JSP_SEARCH_NO_SHOW %>"/>");
  }else{
    window.document.Sh_L3VPNMembershipFormSearch.action = '/activator<%=moduleConfig%>/SearchCommitSh_L3VPNMembershipAction.do?datasource=<%= datasource %>&tab_name=<%= tabName %>&vi=<%= viParameter%>&view=<%= viewParameter %>&ndid=<%= ndidParameter %>';
    window.document.Sh_L3VPNMembershipFormSearch.submit();
  }
  }
</script>
...
if (session == null || session.getValue(Sh_L3VPNMembershipConstants.USER) == null) {
  response.sendRedirect(Sh_L3VPNMembershipConstants.NULL_SESSION);
  return;
}
...
<%
      String VPNId = form.getVpnid();
            ...
            String JoinDate = form.getJoindate();
            String CustomerName = form.getCustomername();
      
%>

<h2 style="width:100%; text-align:center;">
  <bean:message bundle="Sh_L3VPNMembershipApplicationResources" key="jsp.search.title"/>
</h2> 
...
<% String searchFormAction = "/SearchCommitSh_L3VPNMembershipAction.do?datasource="+datasource+"&tab_name="+tabName+"&vi="+ viParameter+"&view="+ viewParameter +"&ndid="+ ndidParameter ;%>
      ...
      <table:header>
        ...
        <table:cell>
          <bean:message bundle="InventoryResources" key="description.heading"/>
            ...
            <table:cell>
              <center>
                <html:checkbox property="joindate___hide" value="true"/>
              </center>
            </table:cell>
            ...
            <table:cell>
                              <html:text property="joindate" size="16" value="<%= JoinDate %>"/>
                                          </table:cell>
