...
String formAction = "/CreationCommitAdaptiveModeAction.do?datasource=" + datasource + "&rimid=" + rimid;
...
<html>
  <head>
    ...
    {
      window.document.AdaptiveModeForm.action = '/activator<%=moduleConfig%>/CreationFormAdaptiveModeAction.do?datasource=<%= datasource %>&rimid=<%= rimid %>&_location_=' + focusthis;
      window.document.AdaptiveModeForm.submit();
    }
    function performCommit()
    {
      window.document.AdaptiveModeForm.action = '/activator<%=moduleConfig%>/CreationCommitAdaptiveModeAction.do?datasource=<%= datasource %>&rimid=<%= rimid %>';
      window.document.AdaptiveModeForm.submit();
    }
    function init()
    {
...
<h2 style="width:100%; text-align:center;">
  <bean:message bundle="AdaptiveModeApplicationResources" key="jsp.creation.title"/>
</h2> 
