...
String formAction = "/UpdateCommitSh_RCMembershipAction.do?datasource=" + datasource + "&rimid=" + rimid;
...
if ( pk == null || pk.equals("") ) {
  pk =    request.getParameter("rcname") + "||" + request.getParameter("vrfname") + "||" + request.getParameter("ne_id") ;
}
...
<html>
  <head>
    ...
    {
      window.document.Sh_RCMembershipForm.action = '/activator<%=moduleConfig%>/UpdateFormSh_RCMembershipAction.do?datasource=<%= datasource %>&rimid=<%= rimid %>&_pk_=<%=pk %>&_location_=' + focusthis;
      window.document.Sh_RCMembershipForm.submit();
    }
    function performCommit()
    {
      window.document.Sh_RCMembershipForm.action = '/activator<%=moduleConfig%>/UpdateCommitSh_RCMembershipAction.do?datasource=<%= datasource %>&rimid=<%= rimid %>&_pk_=<%=pk %>';
      window.document.Sh_RCMembershipForm.submit();
    }
    function init()
    {
...
if(beanSh_RCMembership==null)
   beanSh_RCMembership = (com.hp.ov.activator.vpn.inventory.Sh_RCMembership) request.getSession().getAttribute(Sh_RCMembershipConstants.SH_RCMEMBERSHIP_BEAN);
...
<h2 style="width:100%; text-align:center;">
  <bean:message bundle="Sh_RCMembershipApplicationResources" key="jsp.update.title"/>
</h2> 
      ...
      <html:hidden property="refreshTreeRimid" value="<%= (String)request.getParameter(\"refreshTreeRimid\") %>"/>
              ...
              <table:cell>
                                                      <html:hidden property="ne_id" value="<%= NE_ID %>"/>
                                                        <html:text disabled="true" property="ne_id" size="24" value="<%= NE_ID %>"/>
                                                </table:cell>
              <table:cell>
              ...
              <table:cell>
                                                      <html:hidden property="vrfname" value="<%= VRFName %>"/>
                                                        <html:text disabled="true" property="vrfname" size="24" value="<%= VRFName %>"/>
                                                </table:cell>
              <table:cell>
