...
String refreshTree = (String) request.getAttribute(SchedulingPolicyConstants.REFRESH_TREE);
%>

<html>
  <head>
    <title><bean:message bundle="SchedulingPolicyApplicationResources" key="<%= SchedulingPolicyConstants.JSP_VIEW_TITLE %>"/></title>
...
<h2 style="width:100%; text-align:center;">
  <bean:message bundle="SchedulingPolicyApplicationResources" key="jsp.view.title"/>
</h2> 
