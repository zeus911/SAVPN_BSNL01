...
ArrayList al = (ArrayList) session.getAttribute(request.getParameter(L2VPNConstants.TAB_NAME));
String useRandomColor="1";
String mainColor ="1";

String datasource = request.getParameter(L2VPNConstants.DATASOURCE);
String tabName = request.getParameter(L2VPNConstants.TAB_NAME);
...
String Fixed___hide = null;
String Comments___hide = null;

StringBuffer requestURI = new StringBuffer("/activator/jsp/inventory/SearchListL2VPN.jsp?");
...
if ( form != null ) {
  ...
  Fixed___hide = form.getFixed___hide();
  ...
  if ( Fixed___hide != null )
    requestURI.append("fixed___hide=" + Fixed___hide);
  if ( Comments___hide != null )
    ...
    Fixed___hide = request.getParameter("fixed___hide");
...
<html>
  <head>
    <title><bean:message bundle="L2VPNApplicationResources" key="<%= L2VPNConstants.JSP_RESULTS_TITLE %>"/></title>
  ...
  <bean:message bundle="L2VPNApplicationResources" key="jsp.search.results.title"/>
</h2> 

<display:table id="elementSearch" style="width:100%" requestURI="SearchCommitL2VPNAction.do" name="<%= searchListName %>" pagesize="10" export="true" sort="list" partialList="true" size="resultSize" decorator="com.hp.ov.activator.mwfm.servlet.inventory.inventorytree.taglib.displaytag.decorator.InventoryBuilderTableDecorator">

<%
        if ( ServiceId___hide == null || ServiceId___hide.equals("null") ) {
%>
      <display:column property="serviceid" sortable="true" titleKey="L2VPNApplicationResources:field.serviceid.alias" headerClass="tableTitle" class="tableCell"/>
<%
        }
        if ( CustomerId___hide == null || CustomerId___hide.equals("null") ) {
%>
      <display:column property="customerid" sortable="true" titleKey="L2VPNApplicationResources:field.customerid.alias" headerClass="tableTitle" class="tableCell"/>
<%
        }
        if ( ContactPerson___hide == null || ContactPerson___hide.equals("null") ) {
%>
      <display:column property="contactperson" sortable="true" titleKey="L2VPNApplicationResources:field.contactperson.alias" headerClass="tableTitle" class="tableCell"/>
<%
        }
        if ( ServiceName___hide == null || ServiceName___hide.equals("null") ) {
%>
      <display:column property="servicename" sortable="true" titleKey="L2VPNApplicationResources:field.servicename.alias" headerClass="tableTitle" class="tableCell"/>
<%
        }
        if ( InitiationDate___hide == null || InitiationDate___hide.equals("null") ) {
%>
      <display:column property="initiationdate" sortable="true" titleKey="L2VPNApplicationResources:field.initiationdate.alias" headerClass="tableTitle" class="tableCell"/>
<%
        }
        if ( ActivationDate___hide == null || ActivationDate___hide.equals("null") ) {
%>
      <display:column property="activationdate" sortable="true" titleKey="L2VPNApplicationResources:field.activationdate.alias" headerClass="tableTitle" class="tableCell"/>
<%
        }
        if ( ModificationDate___hide == null || ModificationDate___hide.equals("null") ) {
%>
      <display:column property="modificationdate" sortable="true" titleKey="L2VPNApplicationResources:field.modificationdate.alias" headerClass="tableTitle" class="tableCell"/>
<%
        }
        if ( State___hide == null || State___hide.equals("null") ) {
%>
      <display:column property="state" sortable="true" titleKey="L2VPNApplicationResources:field.state.alias" headerClass="tableTitle" class="tableCell"/>
<%
        }
        if ( Type___hide == null || Type___hide.equals("null") ) {
%>
      <display:column property="type" sortable="true" titleKey="L2VPNApplicationResources:field.type.alias" headerClass="tableTitle" class="tableCell"/>
<%
        }
        if ( VPNTopologyType___hide == null || VPNTopologyType___hide.equals("null") ) {
%>
      <display:column property="vpntopologytype" sortable="true" titleKey="L2VPNApplicationResources:field.vpntopologytype.alias" headerClass="tableTitle" class="tableCell"/>
<%
        }
        if ( InterfaceType___hide == null || InterfaceType___hide.equals("null") ) {
%>
      <display:column property="interfacetype" sortable="true" titleKey="L2VPNApplicationResources:field.interfacetype.alias" headerClass="tableTitle" class="tableCell"/>
<%
        }
        if ( VlanId___hide == null || VlanId___hide.equals("null") ) {
%>
      <display:column property="vlanid" sortable="true" titleKey="L2VPNApplicationResources:field.vlanid.alias" headerClass="tableTitle" class="tableCell"/>
<%
        }
        if ( QoSProfile_PE___hide == null || QoSProfile_PE___hide.equals("null") ) {
%>
      <display:column property="qosprofile_pe" sortable="true" titleKey="L2VPNApplicationResources:field.qosprofile_pe.alias" headerClass="tableTitle" class="tableCell"/>
<%
        }
        if ( QoSProfile_CE___hide == null || QoSProfile_CE___hide.equals("null") ) {
%>
      <display:column property="qosprofile_ce" sortable="true" titleKey="L2VPNApplicationResources:field.qosprofile_ce.alias" headerClass="tableTitle" class="tableCell"/>
<%
        }
        if ( Fixed___hide == null || Fixed___hide.equals("null") ) {
%>
      <display:column property="fixed" sortable="true" titleKey="L2VPNApplicationResources:field.fixed.alias" headerClass="tableTitle" class="tableCell"/>
<%
        }
        if ( Comments___hide == null || Comments___hide.equals("null") ) {
%>
      <display:column property="comments" sortable="true" titleKey="L2VPNApplicationResources:field.comments.alias" headerClass="tableTitle" class="tableCell"/>
<%
    }
%>
</display:table>
...
String backAction = "SearchFormL2VPNAction.do?datasource=" + datasource + "&tab_name=" + tabName + "&vi=" + viParameter + "&view=" + viewParameter + "&ndid=" + ndidParameter;
%>
...
%>
                ...
                <html:hidden property="qosprofile_ce___hide" value="<%= form.getQosprofile_ce___hide() %>"/>
                        <html:hidden property="fixed" value="<%= form.getFixed() %>"/>
                <html:hidden property="fixed___hide" value="<%= form.getFixed___hide() %>"/>
...
%>
                ...
                <html:hidden property="qosprofile_ce___hide" value="<%= request.getParameter(\"qosprofile_ce___hide\") %>"/>
                        <html:hidden property="fixed" value="<%= request.getParameter(\"fixed\") %>"/>
                <html:hidden property="fixed___hide" value="<%= request.getParameter(\"fixed___hide\") %>"/>
...
%>
    <input type="submit" value="<%= backMessage %>" onclick="window.document.L2VPNForm.submit()"/>
  </html:form>
