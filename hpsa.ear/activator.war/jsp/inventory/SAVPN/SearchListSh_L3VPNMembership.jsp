...
ArrayList al = (ArrayList) session.getAttribute(request.getParameter(Sh_L3VPNMembershipConstants.TAB_NAME));
String useRandomColor="1";
String mainColor ="1";

String datasource = request.getParameter(Sh_L3VPNMembershipConstants.DATASOURCE);
String tabName = request.getParameter(Sh_L3VPNMembershipConstants.TAB_NAME);
...
Sh_L3VPNMembershipForm form = (Sh_L3VPNMembershipForm) request.getAttribute("Sh_L3VPNMembershipForm");
...
StringBuffer requestURI = new StringBuffer("/activator/jsp/inventory/SearchListSh_L3VPNMembership.jsp?");
...
<html>
  <head>
    <title><bean:message bundle="Sh_L3VPNMembershipApplicationResources" key="<%= Sh_L3VPNMembershipConstants.JSP_RESULTS_TITLE %>"/></title>
  ...
  <bean:message bundle="Sh_L3VPNMembershipApplicationResources" key="jsp.search.results.title"/>
</h2> 

<display:table id="elementSearch" style="width:100%" requestURI="SearchCommitSh_L3VPNMembershipAction.do" name="<%= searchListName %>" pagesize="10" export="true" sort="list" partialList="true" size="resultSize" decorator="com.hp.ov.activator.mwfm.servlet.inventory.inventorytree.taglib.displaytag.decorator.InventoryBuilderTableDecorator">

<%
        if ( VPNId___hide == null || VPNId___hide.equals("null") ) {
%>
      <display:column property="vpnid" sortable="true" titleKey="Sh_L3VPNMembershipApplicationResources:field.vpnid.alias" headerClass="tableTitle" class="tableCell"/>
<%
        }
        if ( SiteId___hide == null || SiteId___hide.equals("null") ) {
%>
      <display:column property="siteid" sortable="true" titleKey="Sh_L3VPNMembershipApplicationResources:field.siteid.alias" headerClass="tableTitle" class="tableCell"/>
<%
        }
        if ( SiteName___hide == null || SiteName___hide.equals("null") ) {
%>
      <display:column property="sitename" sortable="true" titleKey="Sh_L3VPNMembershipApplicationResources:field.sitename.alias" headerClass="tableTitle" class="tableCell"/>
<%
        }
        if ( VPNName___hide == null || VPNName___hide.equals("null") ) {
%>
      <display:column property="vpnname" sortable="true" titleKey="Sh_L3VPNMembershipApplicationResources:field.vpnname.alias" headerClass="tableTitle" class="tableCell"/>
<%
        }
        if ( Marker___hide == null || Marker___hide.equals("null") ) {
%>
      <display:column property="marker" sortable="true" titleKey="Sh_L3VPNMembershipApplicationResources:field.marker.alias" headerClass="tableTitle" class="tableCell"/>
<%
        }
        if ( UploadStatus___hide == null || UploadStatus___hide.equals("null") ) {
%>
      <display:column property="uploadstatus" sortable="true" titleKey="Sh_L3VPNMembershipApplicationResources:field.uploadstatus.alias" headerClass="tableTitle" class="tableCell"/>
<%
        }
        if ( DBPrimaryKey___hide == null || DBPrimaryKey___hide.equals("null") ) {
%>
      <display:column property="dbprimarykey" sortable="true" titleKey="Sh_L3VPNMembershipApplicationResources:field.dbprimarykey.alias" headerClass="tableTitle" class="tableCell"/>
<%
        }
        if ( JoinDate___hide == null || JoinDate___hide.equals("null") ) {
%>
      <display:column property="joindate" sortable="true" titleKey="Sh_L3VPNMembershipApplicationResources:field.joindate.alias" headerClass="tableTitle" class="tableCell"/>
<%
        }
        if ( CustomerName___hide == null || CustomerName___hide.equals("null") ) {
%>
      <display:column property="customername" sortable="true" titleKey="Sh_L3VPNMembershipApplicationResources:field.customername.alias" headerClass="tableTitle" class="tableCell"/>
<%
    }
%>
</display:table>
...
String backAction = "SearchFormSh_L3VPNMembershipAction.do?datasource=" + datasource + "&tab_name=" + tabName + "&vi=" + viParameter + "&view=" + viewParameter + "&ndid=" + ndidParameter;
%>
...
%>
    <input type="submit" value="<%= backMessage %>" onclick="window.document.Sh_L3VPNMembershipForm.submit()"/>
  </html:form>
