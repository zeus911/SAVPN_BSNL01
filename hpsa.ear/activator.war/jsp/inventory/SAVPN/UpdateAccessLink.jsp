...
String formAction = "/UpdateCommitAccessLinkAction.do?datasource=" + datasource + "&rimid=" + rimid;
...
<html>
  <head>
    ...
    {
      window.document.AccessLinkForm.action = '/activator<%=moduleConfig%>/UpdateFormAccessLinkAction.do?datasource=<%= datasource %>&rimid=<%= rimid %>&_pk_=<%=pk %>&_location_=' + focusthis;
      window.document.AccessLinkForm.submit();
    }
    function performCommit()
    {
      window.document.AccessLinkForm.action = '/activator<%=moduleConfig%>/UpdateCommitAccessLinkAction.do?datasource=<%= datasource %>&rimid=<%= rimid %>&_pk_=<%=pk %>';
      window.document.AccessLinkForm.submit();
    }
    function init()
    {
...
if(beanAccessLink==null)
   beanAccessLink = (com.hp.ov.activator.vpn.inventory.AccessLink) request.getSession().getAttribute(AccessLinkConstants.ACCESSLINK_BEAN);
...
<h2 style="width:100%; text-align:center;">
  <bean:message bundle="AccessLinkApplicationResources" key="jsp.update.title"/>
</h2> 
      ...
      <html:hidden property="refreshTreeRimid" value="<%= (String)request.getParameter(\"refreshTreeRimid\") %>"/>
              ...
              <table:cell>
                <bean:message bundle="AccessLinkApplicationResources" key="field.network.description"/>
                                      ...
                                      <table:row>
              <table:cell>  
                <bean:message bundle="AccessLinkApplicationResources" key="field.oldtype.alias"/>
                              </table:cell>
              <table:cell>
              ...
              <table:cell>
                <bean:message bundle="AccessLinkApplicationResources" key="field.oldtype.description"/>
                                                                        </table:cell>
            </table:row>
