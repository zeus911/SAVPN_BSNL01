...
String formAction = "/CreationCommitSh_PolicyMappingAction.do?datasource=" + datasource + "&rimid=" + rimid;
...
<html>
  <head>
    ...
    {
      window.document.Sh_PolicyMappingForm.action = '/activator<%=moduleConfig%>/CreationFormSh_PolicyMappingAction.do?datasource=<%= datasource %>&rimid=<%= rimid %>&_location_=' + focusthis;
      window.document.Sh_PolicyMappingForm.submit();
    }
    function performCommit()
    {
      window.document.Sh_PolicyMappingForm.action = '/activator<%=moduleConfig%>/CreationCommitSh_PolicyMappingAction.do?datasource=<%= datasource %>&rimid=<%= rimid %>';
      window.document.Sh_PolicyMappingForm.submit();
    }
    function init()
    {
...
<h2 style="width:100%; text-align:center;">
  <bean:message bundle="Sh_PolicyMappingApplicationResources" key="jsp.creation.title"/>
</h2> 
...
<html:form action="<%= formAction %>" style="text-align:center;">
    <table:table>
      ...
      <html:hidden property="refreshTreeRimid" value="<%= (String)request.getParameter(\"refreshTreeRimid\") %>"/>
              ...
              <table:cell>
                                                                        <html:text  property="tclassname" size="24" value="<%= TClassName %>"/>
                                                </table:cell>
              <table:cell>
              ...
              <table:cell>
                                                                        <html:text  property="profilename" size="24" value="<%= ProfileName %>"/>
                                                </table:cell>
              <table:cell>
