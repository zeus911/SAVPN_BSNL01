...
String refreshTree = (String) request.getAttribute(L2VCConstants.REFRESH_TREE);
%>

<html>
  <head>
    <title><bean:message bundle="L2VCApplicationResources" key="<%= L2VCConstants.JSP_VIEW_TITLE %>"/></title>
...
<h2 style="width:100%; text-align:center;">
  <bean:message bundle="L2VCApplicationResources" key="jsp.view.title"/>
</h2> 
