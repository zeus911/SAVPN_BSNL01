...
String formAction = "/CreationCommitWorkorderURLAction.do?datasource=" + datasource + "&rimid=" + rimid;
...
<html>
  <head>
    ...
    {
      window.document.WorkorderURLForm.action = '/activator<%=moduleConfig%>/CreationFormWorkorderURLAction.do?datasource=<%= datasource %>&rimid=<%= rimid %>&_location_=' + focusthis;
      window.document.WorkorderURLForm.submit();
    }
    function performCommit()
    {
      window.document.WorkorderURLForm.action = '/activator<%=moduleConfig%>/CreationCommitWorkorderURLAction.do?datasource=<%= datasource %>&rimid=<%= rimid %>';
      window.document.WorkorderURLForm.submit();
    }
    function init()
    {
...
<h2 style="width:100%; text-align:center;">
  <bean:message bundle="WorkorderURLApplicationResources" key="jsp.creation.title"/>
</h2> 
