...
String refreshTree = (String) request.getAttribute(Sh_NetworkElementConstants.REFRESH_TREE);
%>

<html>
  <head>
    <title><bean:message bundle="Sh_NetworkElementApplicationResources" key="<%= Sh_NetworkElementConstants.JSP_VIEW_TITLE %>"/></title>
...
<h2 style="width:100%; text-align:center;">
  <bean:message bundle="Sh_NetworkElementApplicationResources" key="jsp.view.title"/>
</h2> 
