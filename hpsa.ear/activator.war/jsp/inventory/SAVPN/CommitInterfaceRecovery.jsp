...
<%@ page import="java.util.*,com.hp.ov.activator.vpn.inventory.InterfaceRecovered,
...
InterfaceRecovered beanInterfaceRecoverd = new InterfaceRecovered();
...
String TargetInterface = StringFacility.replaceAllByHTMLCharacter(beanInterfaceRecovery.getTargetInterface());
int total       = 0;
int success     =0;
int failed      = 0;
int attempts    = 0;
...
String TPID = beanInterfaceRecovery.getTerminationid();
Connection con = null;
try
{
    if (ds != null)
...
while (rset.next()) {
    ...
    success     = rset.getInt("SUCCESS");
    failed      = rset.getInt("FAILED");
