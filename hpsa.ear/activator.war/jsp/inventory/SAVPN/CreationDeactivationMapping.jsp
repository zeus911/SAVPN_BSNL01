...
String formAction = "/CreationCommitDeactivationMappingAction.do?datasource=" + datasource + "&rimid=" + rimid;
...
<html>
  <head>
    ...
    {
      window.document.DeactivationMappingForm.action = '/activator<%=moduleConfig%>/CreationFormDeactivationMappingAction.do?datasource=<%= datasource %>&rimid=<%= rimid %>&_location_=' + focusthis;
      window.document.DeactivationMappingForm.submit();
    }
    function performCommit()
    {
      window.document.DeactivationMappingForm.action = '/activator<%=moduleConfig%>/CreationCommitDeactivationMappingAction.do?datasource=<%= datasource %>&rimid=<%= rimid %>';
      window.document.DeactivationMappingForm.submit();
    }
    function init()
    {
...
<h2 style="width:100%; text-align:center;">
  <bean:message bundle="DeactivationMappingApplicationResources" key="jsp.creation.title"/>
</h2> 
