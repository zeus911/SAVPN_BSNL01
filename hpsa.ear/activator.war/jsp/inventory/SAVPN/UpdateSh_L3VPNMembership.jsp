...
String formAction = "/UpdateCommitSh_L3VPNMembershipAction.do?datasource=" + datasource + "&rimid=" + rimid;
...
if ( pk == null || pk.equals("") ) {
  pk =    request.getParameter("vpnid") + "||" + request.getParameter("siteid") ;
}
...
<html>
  <head>
    <title><bean:message bundle="Sh_L3VPNMembershipApplicationResources" key="<%= Sh_L3VPNMembershipConstants.JSP_CREATION_TITLE %>"/></title>
    ...
    {
      window.document.Sh_L3VPNMembershipForm.action = '/activator<%=moduleConfig%>/UpdateFormSh_L3VPNMembershipAction.do?datasource=<%= datasource %>&rimid=<%= rimid %>&_pk_=<%=pk %>&_location_=' + focusthis;
      window.document.Sh_L3VPNMembershipForm.submit();
    }
    function performCommit()
    {
      window.document.Sh_L3VPNMembershipForm.action = '/activator<%=moduleConfig%>/UpdateCommitSh_L3VPNMembershipAction.do?datasource=<%= datasource %>&rimid=<%= rimid %>&_pk_=<%=pk %>';
      window.document.Sh_L3VPNMembershipForm.submit();
    }
    function init()
    {
...
if(beanSh_L3VPNMembership==null)
   beanSh_L3VPNMembership = (com.hp.ov.activator.vpn.inventory.Sh_L3VPNMembership) request.getSession().getAttribute(Sh_L3VPNMembershipConstants.SH_L3VPNMEMBERSHIP_BEAN);
...
nfB.setMaximumFractionDigits(6);
              ...
              String VPNId = beanSh_L3VPNMembership.getVpnid();
        
            
                            
            
                
                String SiteId = beanSh_L3VPNMembership.getSiteid();
        
            
                            
            
                
                String SiteName = beanSh_L3VPNMembership.getSitename();
        
            
                            
            
                
                String VPNName = beanSh_L3VPNMembership.getVpnname();
        
            
                            
            
                
                String Marker = beanSh_L3VPNMembership.getMarker();
        
            
                            
            
                
                String UploadStatus = beanSh_L3VPNMembership.getUploadstatus();
        
            
                            
            
                
                String DBPrimaryKey = beanSh_L3VPNMembership.getDbprimarykey();
        
            
                            
            
                
                String JoinDate = beanSh_L3VPNMembership.getJoindate();
        
            
                            
            
                
                String CustomerName = beanSh_L3VPNMembership.getCustomername();
...
<h2 style="width:100%; text-align:center;">
  <bean:message bundle="Sh_L3VPNMembershipApplicationResources" key="jsp.update.title"/>
</h2> 

<h1>
      <html:errors bundle="Sh_L3VPNMembershipApplicationResources" property="VPNId"/>
        <html:errors bundle="Sh_L3VPNMembershipApplicationResources" property="SiteId"/>
        <html:errors bundle="Sh_L3VPNMembershipApplicationResources" property="SiteName"/>
        <html:errors bundle="Sh_L3VPNMembershipApplicationResources" property="VPNName"/>
        <html:errors bundle="Sh_L3VPNMembershipApplicationResources" property="Marker"/>
        <html:errors bundle="Sh_L3VPNMembershipApplicationResources" property="UploadStatus"/>
        <html:errors bundle="Sh_L3VPNMembershipApplicationResources" property="DBPrimaryKey"/>
        <html:errors bundle="Sh_L3VPNMembershipApplicationResources" property="JoinDate"/>
        <html:errors bundle="Sh_L3VPNMembershipApplicationResources" property="CustomerName"/>
  </h1>
<script>
var allEvents = "";
