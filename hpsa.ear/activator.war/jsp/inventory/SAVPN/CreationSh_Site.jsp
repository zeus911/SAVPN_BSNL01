...
String formAction = "/CreationCommitSh_SiteAction.do?datasource=" + datasource + "&rimid=" + rimid;
...
<html>
  <head>
    ...
    {
      window.document.Sh_SiteForm.action = '/activator<%=moduleConfig%>/CreationFormSh_SiteAction.do?datasource=<%= datasource %>&rimid=<%= rimid %>&_location_=' + focusthis;
      window.document.Sh_SiteForm.submit();
    }
    function performCommit()
    {
      window.document.Sh_SiteForm.action = '/activator<%=moduleConfig%>/CreationCommitSh_SiteAction.do?datasource=<%= datasource %>&rimid=<%= rimid %>';
      window.document.Sh_SiteForm.submit();
    }
    function init()
    {
...
<h2 style="width:100%; text-align:center;">
  <bean:message bundle="Sh_SiteApplicationResources" key="jsp.creation.title"/>
</h2> 
