...
String refreshTree = (String) request.getAttribute(Sh_VRFConstants.REFRESH_TREE);
%>

<html>
  <head>
    <title><bean:message bundle="Sh_VRFApplicationResources" key="<%= Sh_VRFConstants.JSP_VIEW_TITLE %>"/></title>
...
<h2 style="width:100%; text-align:center;">
  <bean:message bundle="Sh_VRFApplicationResources" key="jsp.view.title"/>
</h2> 
