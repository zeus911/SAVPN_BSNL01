...
String refreshTree = (String) request.getAttribute(MulticastParametersConstants.REFRESH_TREE);
%>

<html>
  <head>
    <title><bean:message bundle="MulticastParametersApplicationResources" key="<%= MulticastParametersConstants.JSP_VIEW_TITLE %>"/></title>
...
<h2 style="width:100%; text-align:center;">
  <bean:message bundle="MulticastParametersApplicationResources" key="jsp.view.title"/>
</h2> 
