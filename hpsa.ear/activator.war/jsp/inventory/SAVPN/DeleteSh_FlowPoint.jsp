...
<html>
  <head>
    <title><bean:message bundle="Sh_FlowPointApplicationResources" key="<%= Sh_FlowPointConstants.JSP_DELETE_TITLE %>"/></title>
    ...
    {
      window.document.Sh_FlowPointForm.action = '/activator<%=moduleConfig%>/DeleteCommitSh_FlowPointAction.do?datasource=<%= datasource %>&rimid=<%= rimid %>';
      window.document.Sh_FlowPointForm.submit();
    }
    function init()
    {
      var confirm = new HPSAConfirm('Confirm','<bean:message bundle="Sh_FlowPointApplicationResources" key="delete.confirm"/>', '<bean:message bundle="InventoryResources" key="confirm.ok_button.label"/>', '<bean:message bundle="InventoryResources" key="confirm.cancel_button.label"/>');
...
nfB.setMaximumFractionDigits(6);
                  ...
                  String TerminationPointID = StringFacility.replaceAllByHTMLCharacter(beanSh_FlowPoint.getTerminationpointid());
                        
                                  
                      String AttachmentId = StringFacility.replaceAllByHTMLCharacter(beanSh_FlowPoint.getAttachmentid());
                        
                                  
                      String QoSProfile_in = StringFacility.replaceAllByHTMLCharacter(beanSh_FlowPoint.getQosprofile_in());
                        
                                  
                      String QoSProfile_out = StringFacility.replaceAllByHTMLCharacter(beanSh_FlowPoint.getQosprofile_out());
                        
                                  
                      String RateLimit_in = StringFacility.replaceAllByHTMLCharacter(beanSh_FlowPoint.getRatelimit_in());
                        
                                  
                      String RateLimit_out = StringFacility.replaceAllByHTMLCharacter(beanSh_FlowPoint.getRatelimit_out());
                        
                                  
                      String Marker = StringFacility.replaceAllByHTMLCharacter(beanSh_FlowPoint.getMarker());
                        
                                  
                      String UploadStatus = StringFacility.replaceAllByHTMLCharacter(beanSh_FlowPoint.getUploadstatus());
                        
                                  
                      String DBPrimaryKey = StringFacility.replaceAllByHTMLCharacter(beanSh_FlowPoint.getDbprimarykey());
                        
                                  
    
%>
<h2 style="width:100%; text-align:center;">
    <bean:message bundle="Sh_FlowPointApplicationResources" key="jsp.delete.title"/>
</h2> 
...
%>
    ...
    <html:form action="/DeleteCommitSh_FlowPointAction.do">
