...
String formAction = "/UpdateCommitSh_NetworkElementAction.do?datasource=" + datasource + "&rimid=" + rimid;
...
<html>
  <head>
    ...
    {
      window.document.Sh_NetworkElementForm.action = '/activator<%=moduleConfig%>/UpdateFormSh_NetworkElementAction.do?datasource=<%= datasource %>&rimid=<%= rimid %>&_pk_=<%=pk %>&_location_=' + focusthis;
      window.document.Sh_NetworkElementForm.submit();
    }
    function performCommit()
    {
      window.document.Sh_NetworkElementForm.action = '/activator<%=moduleConfig%>/UpdateCommitSh_NetworkElementAction.do?datasource=<%= datasource %>&rimid=<%= rimid %>&_pk_=<%=pk %>';
      window.document.Sh_NetworkElementForm.submit();
    }
    function init()
    {
...
if(beanSh_NetworkElement==null)
   beanSh_NetworkElement = (com.hp.ov.activator.vpn.inventory.Sh_NetworkElement) request.getSession().getAttribute(Sh_NetworkElementConstants.SH_NETWORKELEMENT_BEAN);
...
<h2 style="width:100%; text-align:center;">
  <bean:message bundle="Sh_NetworkElementApplicationResources" key="jsp.update.title"/>
</h2> 
