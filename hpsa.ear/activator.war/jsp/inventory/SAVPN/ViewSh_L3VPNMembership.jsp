...
String refreshTree = (String) request.getAttribute(Sh_L3VPNMembershipConstants.REFRESH_TREE);
%>

<html>
  <head>
    <title><bean:message bundle="Sh_L3VPNMembershipApplicationResources" key="<%= Sh_L3VPNMembershipConstants.JSP_VIEW_TITLE %>"/></title>
...
<h2 style="width:100%; text-align:center;">
  <bean:message bundle="Sh_L3VPNMembershipApplicationResources" key="jsp.view.title"/>
</h2> 
