...
ArrayList al = (ArrayList) session.getAttribute(request.getParameter(L2AccessFlowConstants.TAB_NAME));
String useRandomColor="1";
String mainColor ="1";

String datasource = request.getParameter(L2AccessFlowConstants.DATASOURCE);
String tabName = request.getParameter(L2AccessFlowConstants.TAB_NAME);
...
String VLANMapping___hide = null;
String InterfaceType___hide = null;

StringBuffer requestURI = new StringBuffer("/activator/jsp/inventory/SearchListL2AccessFlow.jsp?");
...
if ( form != null ) {
  ...
  VLANMapping___hide = form.getVlanmapping___hide();
  InterfaceType___hide = form.getInterfacetype___hide();
  ...
  if ( VLANMapping___hide != null )
    requestURI.append("vlanmapping___hide=" + VLANMapping___hide);
  if ( InterfaceType___hide != null )
    requestURI.append("interfacetype___hide=" + InterfaceType___hide);
    ...
    VLANMapping___hide = request.getParameter("vlanmapping___hide");
    InterfaceType___hide = request.getParameter("interfacetype___hide");
...
<html>
  <head>
    <title><bean:message bundle="L2AccessFlowApplicationResources" key="<%= L2AccessFlowConstants.JSP_RESULTS_TITLE %>"/></title>
  ...
  <bean:message bundle="L2AccessFlowApplicationResources" key="jsp.search.results.title"/>
</h2> 

<display:table id="elementSearch" style="width:100%" requestURI="SearchCommitL2AccessFlowAction.do" name="<%= searchListName %>" pagesize="10" export="true" sort="list" partialList="true" size="resultSize" decorator="com.hp.ov.activator.mwfm.servlet.inventory.inventorytree.taglib.displaytag.decorator.InventoryBuilderTableDecorator">

<%
        if ( ServiceId___hide == null || ServiceId___hide.equals("null") ) {
%>
      <display:column property="serviceid" sortable="true" titleKey="L2AccessFlowApplicationResources:field.serviceid.alias" headerClass="tableTitle" class="tableCell"/>
<%
        }
        if ( CustomerId___hide == null || CustomerId___hide.equals("null") ) {
%>
      <display:column property="customerid" sortable="true" titleKey="L2AccessFlowApplicationResources:field.customerid.alias" headerClass="tableTitle" class="tableCell"/>
<%
        }
        if ( ServiceName___hide == null || ServiceName___hide.equals("null") ) {
%>
      <display:column property="servicename" sortable="true" titleKey="L2AccessFlowApplicationResources:field.servicename.alias" headerClass="tableTitle" class="tableCell"/>
<%
        }
        if ( InitiationDate___hide == null || InitiationDate___hide.equals("null") ) {
%>
      <display:column property="initiationdate" sortable="true" titleKey="L2AccessFlowApplicationResources:field.initiationdate.alias" headerClass="tableTitle" class="tableCell"/>
<%
        }
        if ( ActivationDate___hide == null || ActivationDate___hide.equals("null") ) {
%>
      <display:column property="activationdate" sortable="true" titleKey="L2AccessFlowApplicationResources:field.activationdate.alias" headerClass="tableTitle" class="tableCell"/>
<%
        }
        if ( ModificationDate___hide == null || ModificationDate___hide.equals("null") ) {
%>
      <display:column property="modificationdate" sortable="true" titleKey="L2AccessFlowApplicationResources:field.modificationdate.alias" headerClass="tableTitle" class="tableCell"/>
<%
        }
        if ( State___hide == null || State___hide.equals("null") ) {
%>
      <display:column property="state" sortable="true" titleKey="L2AccessFlowApplicationResources:field.state.alias" headerClass="tableTitle" class="tableCell"/>
<%
        }
        if ( Type___hide == null || Type___hide.equals("null") ) {
%>
      <display:column property="type" sortable="true" titleKey="L2AccessFlowApplicationResources:field.type.alias" headerClass="tableTitle" class="tableCell"/>
<%
        }
        if ( ContactPerson___hide == null || ContactPerson___hide.equals("null") ) {
%>
      <display:column property="contactperson" sortable="true" titleKey="L2AccessFlowApplicationResources:field.contactperson.alias" headerClass="tableTitle" class="tableCell"/>
<%
        }
        if ( Comments___hide == null || Comments___hide.equals("null") ) {
%>
      <display:column property="comments" sortable="true" titleKey="L2AccessFlowApplicationResources:field.comments.alias" headerClass="tableTitle" class="tableCell"/>
<%
        }
        if ( SiteId___hide == null || SiteId___hide.equals("null") ) {
%>
      <display:column property="siteid" sortable="true" titleKey="L2AccessFlowApplicationResources:field.siteid.alias" headerClass="tableTitle" class="tableCell"/>
<%
        }
        if ( VlanId___hide == null || VlanId___hide.equals("null") ) {
%>
      <display:column property="vlanid" sortable="true" titleKey="L2AccessFlowApplicationResources:field.vlanid.alias" headerClass="tableTitle" class="tableCell"/>
<%
        }
        if ( PE_Status___hide == null || PE_Status___hide.equals("null") ) {
%>
      <display:column property="pe_status" sortable="true" titleKey="L2AccessFlowApplicationResources:field.pe_status.alias" headerClass="tableTitle" class="tableCell"/>
<%
        }
        if ( CE_Status___hide == null || CE_Status___hide.equals("null") ) {
%>
      <display:column property="ce_status" sortable="true" titleKey="L2AccessFlowApplicationResources:field.ce_status.alias" headerClass="tableTitle" class="tableCell"/>
<%
        }
        if ( AccessNW_Status___hide == null || AccessNW_Status___hide.equals("null") ) {
%>
      <display:column property="accessnw_status" sortable="true" titleKey="L2AccessFlowApplicationResources:field.accessnw_status.alias" headerClass="tableTitle" class="tableCell"/>
<%
        }
        if ( ASBR_Status___hide == null || ASBR_Status___hide.equals("null") ) {
%>
      <display:column property="asbr_status" sortable="true" titleKey="L2AccessFlowApplicationResources:field.asbr_status.alias" headerClass="tableTitle" class="tableCell"/>
<%
        }
        if ( VLANMapping___hide == null || VLANMapping___hide.equals("null") ) {
%>
      <display:column property="vlanmapping" sortable="true" titleKey="L2AccessFlowApplicationResources:field.vlanmapping.alias" headerClass="tableTitle" class="tableCell"/>
<%
        }
        if ( InterfaceType___hide == null || InterfaceType___hide.equals("null") ) {
%>
      <display:column property="interfacetype" sortable="true" titleKey="L2AccessFlowApplicationResources:field.interfacetype.alias" headerClass="tableTitle" class="tableCell"/>
<%
    }
%>
</display:table>
...
String backAction = "SearchFormL2AccessFlowAction.do?datasource=" + datasource + "&tab_name=" + tabName + "&vi=" + viParameter + "&view=" + viewParameter + "&ndid=" + ndidParameter;
%>
...
%>
                ...
                <html:hidden property="asbr_status___hide" value="<%= form.getAsbr_status___hide() %>"/>
                        <html:hidden property="vlanmapping" value="<%= form.getVlanmapping() %>"/>
                <html:hidden property="vlanmapping___hide" value="<%= form.getVlanmapping___hide() %>"/>
                        <html:hidden property="interfacetype" value="<%= form.getInterfacetype() %>"/>
                <html:hidden property="interfacetype___hide" value="<%= form.getInterfacetype___hide() %>"/>
                    <%
}
  else {    
%>
                ...
                <html:hidden property="asbr_status___hide" value="<%= request.getParameter(\"asbr_status___hide\") %>"/>
                        <html:hidden property="vlanmapping" value="<%= request.getParameter(\"vlanmapping\") %>"/>
                <html:hidden property="vlanmapping___hide" value="<%= request.getParameter(\"vlanmapping___hide\") %>"/>
                        <html:hidden property="interfacetype" value="<%= request.getParameter(\"interfacetype\") %>"/>
                <html:hidden property="interfacetype___hide" value="<%= request.getParameter(\"interfacetype___hide\") %>"/>
                    <%
  }
%>
    <input type="submit" value="<%= backMessage %>" onclick="window.document.L2AccessFlowForm.submit()"/>
  </html:form>
