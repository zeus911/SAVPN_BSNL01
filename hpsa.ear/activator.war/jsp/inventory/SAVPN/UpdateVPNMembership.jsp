...
String formAction = "/UpdateCommitVPNMembershipAction.do?datasource=" + datasource + "&rimid=" + rimid;
...
<html>
  <head>
    ...
    {
      window.document.VPNMembershipForm.action = '/activator<%=moduleConfig%>/UpdateFormVPNMembershipAction.do?datasource=<%= datasource %>&rimid=<%= rimid %>&_pk_=<%=pk %>&_location_=' + focusthis;
      window.document.VPNMembershipForm.submit();
    }
    function performCommit()
    {
      window.document.VPNMembershipForm.action = '/activator<%=moduleConfig%>/UpdateCommitVPNMembershipAction.do?datasource=<%= datasource %>&rimid=<%= rimid %>&_pk_=<%=pk %>';
      window.document.VPNMembershipForm.submit();
    }
    function init()
    {
...
if(beanVPNMembership==null)
   beanVPNMembership = (com.hp.ov.activator.vpn.inventory.VPNMembership) request.getSession().getAttribute(VPNMembershipConstants.VPNMEMBERSHIP_BEAN);
...
nfB.setMaximumFractionDigits(6);
              ...
              String VPNId = beanVPNMembership.getVpnid();
        
            
                            
            
                
                String SiteId = beanVPNMembership.getSiteid();
        
            
                            
            
                
                String SiteName = beanVPNMembership.getSitename();
        
            
                            
            
                
                String VPNName = beanVPNMembership.getVpnname();
        
            
                            
            
                
                String SiteNameId = beanVPNMembership.getSitenameid();
        
            
                            
            
                
                String VPNNameId = beanVPNMembership.getVpnnameid();
...
<h2 style="width:100%; text-align:center;">
  <bean:message bundle="VPNMembershipApplicationResources" key="jsp.update.title"/>
</h2> 
...
<h1>
      <html:errors bundle="VPNMembershipApplicationResources" property="VPNId"/>
        ...
        <html:errors bundle="VPNMembershipApplicationResources" property="SiteNameId"/>
        <html:errors bundle="VPNMembershipApplicationResources" property="VPNNameId"/>
  </h1>
<script>
var allEvents = "";
