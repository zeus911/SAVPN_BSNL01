...
String formAction = "/UpdateCommitServiceParameterAction.do?datasource=" + datasource + "&rimid=" + rimid;
...
if ( pk == null || pk.equals("") ) {
  pk =    request.getParameter("serviceid") + "||" + request.getParameter("attribute") ;
}
...
<html>
  <head>
    ...
    {
      window.document.ServiceParameterForm.action = '/activator<%=moduleConfig%>/UpdateFormServiceParameterAction.do?datasource=<%= datasource %>&rimid=<%= rimid %>&_pk_=<%=pk %>&_location_=' + focusthis;
      window.document.ServiceParameterForm.submit();
    }
    function performCommit()
    {
      window.document.ServiceParameterForm.action = '/activator<%=moduleConfig%>/UpdateCommitServiceParameterAction.do?datasource=<%= datasource %>&rimid=<%= rimid %>&_pk_=<%=pk %>';
      window.document.ServiceParameterForm.submit();
    }
    function init()
    {
...
if(beanServiceParameter==null)
   beanServiceParameter = (com.hp.ov.activator.vpn.inventory.ServiceParameter) request.getSession().getAttribute(ServiceParameterConstants.SERVICEPARAMETER_BEAN);
...
<h2 style="width:100%; text-align:center;">
  <bean:message bundle="ServiceParameterApplicationResources" key="jsp.update.title"/>
</h2> 
...
<input type="hidden" name="_update_commit_" value="true"/> 
    <table:table>
      ...
      <html:hidden property="refreshTreeRimid" value="<%= (String)request.getParameter(\"refreshTreeRimid\") %>"/>
              ...
              <table:cell>
                                                      <html:hidden property="attribute" value="<%= Attribute %>"/>
                                                        <html:text disabled="true" property="attribute" size="24" value="<%= Attribute %>"/>
                                                </table:cell>
              <table:cell>
