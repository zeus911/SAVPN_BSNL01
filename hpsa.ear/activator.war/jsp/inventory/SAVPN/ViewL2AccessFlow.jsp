...
String refreshTree = (String) request.getAttribute(L2AccessFlowConstants.REFRESH_TREE);
%>

<html>
  <head>
    <title><bean:message bundle="L2AccessFlowApplicationResources" key="<%= L2AccessFlowConstants.JSP_VIEW_TITLE %>"/></title>
...
<h2 style="width:100%; text-align:center;">
  <bean:message bundle="L2AccessFlowApplicationResources" key="jsp.view.title"/>
</h2> 
