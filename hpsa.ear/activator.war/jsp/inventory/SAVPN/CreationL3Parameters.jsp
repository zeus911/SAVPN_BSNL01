...
String formAction = "/CreationCommitL3ParametersAction.do?datasource=" + datasource + "&rimid=" + rimid;
...
<html>
  <head>
    ...
    {
      window.document.L3ParametersForm.action = '/activator<%=moduleConfig%>/CreationFormL3ParametersAction.do?datasource=<%= datasource %>&rimid=<%= rimid %>&_location_=' + focusthis;
      window.document.L3ParametersForm.submit();
    }
    function performCommit()
    {
      window.document.L3ParametersForm.action = '/activator<%=moduleConfig%>/CreationCommitL3ParametersAction.do?datasource=<%= datasource %>&rimid=<%= rimid %>';
      window.document.L3ParametersForm.submit();
    }
    function init()
    {
...
<h2 style="width:100%; text-align:center;">
  <bean:message bundle="L3ParametersApplicationResources" key="jsp.creation.title"/>
</h2> 
