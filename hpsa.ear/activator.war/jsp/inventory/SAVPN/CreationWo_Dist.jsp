...
String formAction = "/CreationCommitWo_DistAction.do?datasource=" + datasource + "&rimid=" + rimid;
...
<html>
  <head>
    ...
    {
      window.document.Wo_DistForm.action = '/activator<%=moduleConfig%>/CreationFormWo_DistAction.do?datasource=<%= datasource %>&rimid=<%= rimid %>&_location_=' + focusthis;
      window.document.Wo_DistForm.submit();
    }
    function performCommit()
    {
      window.document.Wo_DistForm.action = '/activator<%=moduleConfig%>/CreationCommitWo_DistAction.do?datasource=<%= datasource %>&rimid=<%= rimid %>';
      window.document.Wo_DistForm.submit();
    }
    function init()
    {
...
<h2 style="width:100%; text-align:center;">
  <bean:message bundle="Wo_DistApplicationResources" key="jsp.creation.title"/>
</h2> 
...
<html:form action="<%= formAction %>" style="text-align:center;">
    <table:table>
      ...
      <html:hidden property="refreshTreeRimid" value="<%= (String)request.getParameter(\"refreshTreeRimid\") %>"/>
              ...
              <table:cell>
                                                                        <html:text  property="manual" size="24" value="<%= Manual %>"/>
                                                </table:cell>
              <table:cell>
