...
String formAction = "/CreationCommitLSPParametersAction.do?datasource=" + datasource + "&rimid=" + rimid;
...
<html>
  <head>
    ...
    {
      window.document.LSPParametersForm.action = '/activator<%=moduleConfig%>/CreationFormLSPParametersAction.do?datasource=<%= datasource %>&rimid=<%= rimid %>&_location_=' + focusthis;
      window.document.LSPParametersForm.submit();
    }
    function performCommit()
    {
      window.document.LSPParametersForm.action = '/activator<%=moduleConfig%>/CreationCommitLSPParametersAction.do?datasource=<%= datasource %>&rimid=<%= rimid %>';
      window.document.LSPParametersForm.submit();
    }
    function init()
    {
...
<h2 style="width:100%; text-align:center;">
  <bean:message bundle="LSPParametersApplicationResources" key="jsp.creation.title"/>
</h2> 
...
<html:form action="<%= formAction %>" style="text-align:center;">
    <table:table>
      ...
      <html:hidden property="refreshTreeRimid" value="<%= (String)request.getParameter(\"refreshTreeRimid\") %>"/>
              ...
              <table:cell>
                                  <html:checkbox  property="lspenabled" value="true"/>
              ...
              <table:cell>
                                  <html:checkbox  property="lsptierenabled" value="true"/>
              ...
              <table:cell>
                                  <html:checkbox  property="aggregatelspenabled" value="true"/>
