...
String refreshTree = (String) request.getAttribute(Sh_CustomerMappingConstants.REFRESH_TREE);
%>

<html>
  <head>
    <title><bean:message bundle="Sh_CustomerMappingApplicationResources" key="<%= Sh_CustomerMappingConstants.JSP_VIEW_TITLE %>"/></title>
...
<h2 style="width:100%; text-align:center;">
  <bean:message bundle="Sh_CustomerMappingApplicationResources" key="jsp.view.title"/>
</h2> 
