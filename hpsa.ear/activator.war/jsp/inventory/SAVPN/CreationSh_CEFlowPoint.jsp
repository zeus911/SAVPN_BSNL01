...
String formAction = "/CreationCommitSh_CEFlowPointAction.do?datasource=" + datasource + "&rimid=" + rimid;
...
<html>
  <head>
    ...
    {
      window.document.Sh_CEFlowPointForm.action = '/activator<%=moduleConfig%>/CreationFormSh_CEFlowPointAction.do?datasource=<%= datasource %>&rimid=<%= rimid %>&_location_=' + focusthis;
      window.document.Sh_CEFlowPointForm.submit();
    }
    function performCommit()
    {
      window.document.Sh_CEFlowPointForm.action = '/activator<%=moduleConfig%>/CreationCommitSh_CEFlowPointAction.do?datasource=<%= datasource %>&rimid=<%= rimid %>';
      window.document.Sh_CEFlowPointForm.submit();
    }
    function init()
    {
...
<h2 style="width:100%; text-align:center;">
  <bean:message bundle="Sh_CEFlowPointApplicationResources" key="jsp.creation.title"/>
</h2> 
