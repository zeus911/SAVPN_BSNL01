...
String refreshTree = (String) request.getAttribute(Sh_VPNConstants.REFRESH_TREE);
%>

<html>
  <head>
    <title><bean:message bundle="Sh_VPNApplicationResources" key="<%= Sh_VPNConstants.JSP_VIEW_TITLE %>"/></title>
...
<h2 style="width:100%; text-align:center;">
  <bean:message bundle="Sh_VPNApplicationResources" key="jsp.view.title"/>
</h2> 
