...
String refreshTree = (String) request.getAttribute(ServiceParameterConstants.REFRESH_TREE);
%>

<html>
  <head>
    <title><bean:message bundle="ServiceParameterApplicationResources" key="<%= ServiceParameterConstants.JSP_VIEW_TITLE %>"/></title>
...
<h2 style="width:100%; text-align:center;">
  <bean:message bundle="ServiceParameterApplicationResources" key="jsp.view.title"/>
</h2> 
