...
<html>
  <head>
    <title><bean:message bundle="L2VPNApplicationResources" key="<%= L2VPNConstants.JSP_DELETE_TITLE %>"/></title>
    ...
    {
      window.document.L2VPNForm.action = '/activator<%=moduleConfig%>/DeleteCommitL2VPNAction.do?datasource=<%= datasource %>&rimid=<%= rimid %>';
      window.document.L2VPNForm.submit();
    }
    function init()
    {
      var confirm = new HPSAConfirm('Confirm','<bean:message bundle="L2VPNApplicationResources" key="delete.confirm"/>', '<bean:message bundle="InventoryResources" key="confirm.ok_button.label"/>', '<bean:message bundle="InventoryResources" key="confirm.cancel_button.label"/>');
...
<h2 style="width:100%; text-align:center;">
    <bean:message bundle="L2VPNApplicationResources" key="jsp.delete.title"/>
</h2> 
...
%>
    ...
    <html:form action="/DeleteCommitL2VPNAction.do">
