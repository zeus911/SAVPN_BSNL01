...
String formAction = "/CreationCommitSh_AccessFlowAction.do?datasource=" + datasource + "&rimid=" + rimid;
...
<html>
  <head>
    ...
    {
      window.document.Sh_AccessFlowForm.action = '/activator<%=moduleConfig%>/CreationFormSh_AccessFlowAction.do?datasource=<%= datasource %>&rimid=<%= rimid %>&_location_=' + focusthis;
      window.document.Sh_AccessFlowForm.submit();
    }
    function performCommit()
    {
      window.document.Sh_AccessFlowForm.action = '/activator<%=moduleConfig%>/CreationCommitSh_AccessFlowAction.do?datasource=<%= datasource %>&rimid=<%= rimid %>';
      window.document.Sh_AccessFlowForm.submit();
    }
    function init()
    {
...
<h2 style="width:100%; text-align:center;">
  <bean:message bundle="Sh_AccessFlowApplicationResources" key="jsp.creation.title"/>
</h2> 
