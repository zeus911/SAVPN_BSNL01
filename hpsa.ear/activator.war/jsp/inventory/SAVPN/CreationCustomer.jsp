...
String formAction = "/CreationCommitCustomerAction.do?datasource=" + datasource + "&rimid=" + rimid;
...
<html>
  <head>
    ...
    {
      window.document.CustomerForm.action = '/activator<%=moduleConfig%>/CreationFormCustomerAction.do?datasource=<%= datasource %>&rimid=<%= rimid %>&_location_=' + focusthis;
      window.document.CustomerForm.submit();
    }
    function performCommit()
    {
      window.document.CustomerForm.action = '/activator<%=moduleConfig%>/CreationCommitCustomerAction.do?datasource=<%= datasource %>&rimid=<%= rimid %>';
      window.document.CustomerForm.submit();
    }
    function init()
    {
...
<h2 style="width:100%; text-align:center;">
  <bean:message bundle="CustomerApplicationResources" key="jsp.creation.title"/>
</h2> 
...
<html:form action="<%= formAction %>" style="text-align:center;">
    <table:table>
      ...
      <html:hidden property="refreshTreeRimid" value="<%= (String)request.getParameter(\"refreshTreeRimid\") %>"/>
              ...
              <table:cell>
                                                                        <html:text  property="customercontact" size="24" value="<%= CustomerContact %>"/>
                                                </table:cell>
              <table:cell>
              ...
              <table:cell>
                                                                        <html:text  property="customeremail" size="24" value="<%= CustomerEmail %>"/>
                                                </table:cell>
              <table:cell>
