...
<html>
  <head>
    <title><bean:message bundle="MCASTMigrationParamApplicationResources" key="<%= MCASTMigrationParamConstants.JSP_DELETE_TITLE %>"/></title>
    ...
    {
      window.document.MCASTMigrationParamForm.action = '/activator<%=moduleConfig%>/DeleteCommitMCASTMigrationParamAction.do?datasource=<%= datasource %>&rimid=<%= rimid %>';
      window.document.MCASTMigrationParamForm.submit();
    }
    function init()
    {
      var confirm = new HPSAConfirm('Confirm','<bean:message bundle="MCASTMigrationParamApplicationResources" key="delete.confirm"/>', '<bean:message bundle="InventoryResources" key="confirm.ok_button.label"/>', '<bean:message bundle="InventoryResources" key="confirm.cancel_button.label"/>');
...
<h2 style="width:100%; text-align:center;">
    <bean:message bundle="MCASTMigrationParamApplicationResources" key="jsp.delete.title"/>
</h2> 
...
%>
    ...
    <html:form action="/DeleteCommitMCASTMigrationParamAction.do">
