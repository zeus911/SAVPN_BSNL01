...
String formAction = "/UpdateCommitISPAction.do?datasource=" + datasource + "&rimid=" + rimid;
...
<html>
  <head>
    ...
    {
      window.document.ISPForm.action = '/activator<%=moduleConfig%>/UpdateFormISPAction.do?datasource=<%= datasource %>&rimid=<%= rimid %>&_pk_=<%=pk %>&_location_=' + focusthis;
      window.document.ISPForm.submit();
    }
    function performCommit()
    {
      window.document.ISPForm.action = '/activator<%=moduleConfig%>/UpdateCommitISPAction.do?datasource=<%= datasource %>&rimid=<%= rimid %>&_pk_=<%=pk %>';
      window.document.ISPForm.submit();
    }
    function init()
    {
...
if(beanISP==null)
   beanISP = (com.hp.ov.activator.vpn.inventory.ISP) request.getSession().getAttribute(ISPConstants.ISP_BEAN);
...
<h2 style="width:100%; text-align:center;">
  <bean:message bundle="ISPApplicationResources" key="jsp.update.title"/>
</h2> 
      ...
      <html:hidden property="refreshTreeRimid" value="<%= (String)request.getParameter(\"refreshTreeRimid\") %>"/>
              ...
              <table:cell>
                                                      <html:hidden property="idname" value="<%= IDName %>"/>
                                                        <html:text disabled="true" property="idname" size="24" value="<%= IDName %>"/>
                                                </table:cell>
              <table:cell>
