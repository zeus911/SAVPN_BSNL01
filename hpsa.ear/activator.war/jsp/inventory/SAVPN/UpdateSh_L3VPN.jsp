...
String formAction = "/UpdateCommitSh_L3VPNAction.do?datasource=" + datasource + "&rimid=" + rimid;
...
<html>
  <head>
    ...
    {
      window.document.Sh_L3VPNForm.action = '/activator<%=moduleConfig%>/UpdateFormSh_L3VPNAction.do?datasource=<%= datasource %>&rimid=<%= rimid %>&_pk_=<%=pk %>&_location_=' + focusthis;
      window.document.Sh_L3VPNForm.submit();
    }
    function performCommit()
    {
      window.document.Sh_L3VPNForm.action = '/activator<%=moduleConfig%>/UpdateCommitSh_L3VPNAction.do?datasource=<%= datasource %>&rimid=<%= rimid %>&_pk_=<%=pk %>';
      window.document.Sh_L3VPNForm.submit();
    }
    function init()
    {
...
if(beanSh_L3VPN==null)
   beanSh_L3VPN = (com.hp.ov.activator.vpn.inventory.Sh_L3VPN) request.getSession().getAttribute(Sh_L3VPNConstants.SH_L3VPN_BEAN);
...
<h2 style="width:100%; text-align:center;">
  <bean:message bundle="Sh_L3VPNApplicationResources" key="jsp.update.title"/>
</h2> 
