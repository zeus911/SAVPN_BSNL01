...
String refreshTree = (String) request.getAttribute(L3ParametersConstants.REFRESH_TREE);
%>

<html>
  <head>
    <title><bean:message bundle="L3ParametersApplicationResources" key="<%= L3ParametersConstants.JSP_VIEW_TITLE %>"/></title>
...
<h2 style="width:100%; text-align:center;">
  <bean:message bundle="L3ParametersApplicationResources" key="jsp.view.title"/>
</h2> 
