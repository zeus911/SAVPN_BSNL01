...
String formAction = "/CreationCommitASBRAccessFlowAction.do?datasource=" + datasource + "&rimid=" + rimid;
...
<html>
  <head>
    ...
    {
      window.document.ASBRAccessFlowForm.action = '/activator<%=moduleConfig%>/CreationFormASBRAccessFlowAction.do?datasource=<%= datasource %>&rimid=<%= rimid %>&_location_=' + focusthis;
      window.document.ASBRAccessFlowForm.submit();
    }
    function performCommit()
    {
      window.document.ASBRAccessFlowForm.action = '/activator<%=moduleConfig%>/CreationCommitASBRAccessFlowAction.do?datasource=<%= datasource %>&rimid=<%= rimid %>';
      window.document.ASBRAccessFlowForm.submit();
    }
    function init()
    {
...
<h2 style="width:100%; text-align:center;">
  <bean:message bundle="ASBRAccessFlowApplicationResources" key="jsp.creation.title"/>
</h2> 
