...
String refreshTree = (String) request.getAttribute(FlowPointConstants.REFRESH_TREE);
%>

<html>
  <head>
    <title><bean:message bundle="FlowPointApplicationResources" key="<%= FlowPointConstants.JSP_VIEW_TITLE %>"/></title>
...
<h2 style="width:100%; text-align:center;">
  <bean:message bundle="FlowPointApplicationResources" key="jsp.view.title"/>
</h2> 
