...
<html>
  <head>
    <title><bean:message bundle="L3FlowPointApplicationResources" key="<%= L3FlowPointConstants.JSP_DELETE_TITLE %>"/></title>
    ...
    {
      window.document.L3FlowPointForm.action = '/activator<%=moduleConfig%>/DeleteCommitL3FlowPointAction.do?datasource=<%= datasource %>&rimid=<%= rimid %>';
      window.document.L3FlowPointForm.submit();
    }
    function init()
    {
      var confirm = new HPSAConfirm('Confirm','<bean:message bundle="L3FlowPointApplicationResources" key="delete.confirm"/>', '<bean:message bundle="InventoryResources" key="confirm.ok_button.label"/>', '<bean:message bundle="InventoryResources" key="confirm.cancel_button.label"/>');
...
nfB.setMaximumFractionDigits(6);
         ...
         VRRP_Group_Id = "";
                      ...
                      String UsageMode = StringFacility.replaceAllByHTMLCharacter(beanL3FlowPoint.getUsagemode());
                        
                                  
    
%>
<h2 style="width:100%; text-align:center;">
    <bean:message bundle="L3FlowPointApplicationResources" key="jsp.delete.title"/>
</h2> 
...
%>
    ...
    <html:form action="/DeleteCommitL3FlowPointAction.do">
