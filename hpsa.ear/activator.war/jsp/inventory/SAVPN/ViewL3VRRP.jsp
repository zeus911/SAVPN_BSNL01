...
String refreshTree = (String) request.getAttribute(L3VRRPConstants.REFRESH_TREE);
%>

<html>
  <head>
    <title><bean:message bundle="L3VRRPApplicationResources" key="<%= L3VRRPConstants.JSP_VIEW_TITLE %>"/></title>
...
<h2 style="width:100%; text-align:center;">
  <bean:message bundle="L3VRRPApplicationResources" key="jsp.view.title"/>
</h2> 
