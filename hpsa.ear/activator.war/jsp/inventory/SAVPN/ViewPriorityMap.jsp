...
String refreshTree = (String) request.getAttribute(PriorityMapConstants.REFRESH_TREE);
%>

<html>
  <head>
    <title><bean:message bundle="PriorityMapApplicationResources" key="<%= PriorityMapConstants.JSP_VIEW_TITLE %>"/></title>
...
<h2 style="width:100%; text-align:center;">
  <bean:message bundle="PriorityMapApplicationResources" key="jsp.view.title"/>
</h2> 
