...
String formAction = "/CreationCommitL2FlowPointAction.do?datasource=" + datasource + "&rimid=" + rimid;
...
<html>
  <head>
    ...
    {
      window.document.L2FlowPointForm.action = '/activator<%=moduleConfig%>/CreationFormL2FlowPointAction.do?datasource=<%= datasource %>&rimid=<%= rimid %>&_location_=' + focusthis;
      window.document.L2FlowPointForm.submit();
    }
    function performCommit()
    {
      window.document.L2FlowPointForm.action = '/activator<%=moduleConfig%>/CreationCommitL2FlowPointAction.do?datasource=<%= datasource %>&rimid=<%= rimid %>';
      window.document.L2FlowPointForm.submit();
    }
    function init()
    {
...
<h2 style="width:100%; text-align:center;">
  <bean:message bundle="L2FlowPointApplicationResources" key="jsp.creation.title"/>
</h2> 
