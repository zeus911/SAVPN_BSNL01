...
<html>
  <head>
    <title><bean:message bundle="RCApplicationResources" key="<%= RCConstants.JSP_DELETE_TITLE %>"/></title>
    ...
    {
      window.document.RCForm.action = '/activator<%=moduleConfig%>/DeleteCommitRCAction.do?datasource=<%= datasource %>&rimid=<%= rimid %>';
      window.document.RCForm.submit();
    }
    function init()
    {
      var confirm = new HPSAConfirm('Confirm','<bean:message bundle="RCApplicationResources" key="delete.confirm"/>', '<bean:message bundle="InventoryResources" key="confirm.ok_button.label"/>', '<bean:message bundle="InventoryResources" key="confirm.cancel_button.label"/>');
...
<h2 style="width:100%; text-align:center;">
    <bean:message bundle="RCApplicationResources" key="jsp.delete.title"/>
</h2> 
...
%>
    ...
    <html:form action="/DeleteCommitRCAction.do">
