...
String formAction = "/CreationCommitPathConnectionAction.do?datasource=" + datasource + "&rimid=" + rimid;
...
<html>
  <head>
    ...
    {
      window.document.PathConnectionForm.action = '/activator<%=moduleConfig%>/CreationFormPathConnectionAction.do?datasource=<%= datasource %>&rimid=<%= rimid %>&_location_=' + focusthis;
      window.document.PathConnectionForm.submit();
    }
    function performCommit()
    {
      window.document.PathConnectionForm.action = '/activator<%=moduleConfig%>/CreationCommitPathConnectionAction.do?datasource=<%= datasource %>&rimid=<%= rimid %>';
      window.document.PathConnectionForm.submit();
    }
    function init()
    {
...
<h2 style="width:100%; text-align:center;">
  <bean:message bundle="PathConnectionApplicationResources" key="jsp.creation.title"/>
</h2> 
...
<html:form action="<%= formAction %>" style="text-align:center;">
    <table:table>
      ...
      <html:hidden property="refreshTreeRimid" value="<%= (String)request.getParameter(\"refreshTreeRimid\") %>"/>
              ...
              <table:cell>
                                                                        <html:text  property="ordernumber" size="24" value="<%= OrderNumber %>"/>
                                                </table:cell>
              <table:cell>
