...
<html>
  <head>
    <title><bean:message bundle="AccessNetworkApplicationResources" key="<%= AccessNetworkConstants.JSP_DELETE_TITLE %>"/></title>
    ...
    {
      window.document.AccessNetworkForm.action = '/activator<%=moduleConfig%>/DeleteCommitAccessNetworkAction.do?datasource=<%= datasource %>&rimid=<%= rimid %>';
      window.document.AccessNetworkForm.submit();
    }
    function init()
    {
      var confirm = new HPSAConfirm('Confirm','<bean:message bundle="AccessNetworkApplicationResources" key="delete.confirm"/>', '<bean:message bundle="InventoryResources" key="confirm.ok_button.label"/>', '<bean:message bundle="InventoryResources" key="confirm.cancel_button.label"/>');
...
nfB.setMaximumFractionDigits(6);
      ...
      String Region_key = beanAccessNetwork.getRegion();
      ...
      String ParentNetworkId_key = beanAccessNetwork.getParentnetworkid();
...
<h2 style="width:100%; text-align:center;">
    <bean:message bundle="AccessNetworkApplicationResources" key="jsp.delete.title"/>
</h2> 
...
%>
    ...
    <html:form action="/DeleteCommitAccessNetworkAction.do">
