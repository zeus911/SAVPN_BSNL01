...
String formAction = "/CreationCommitActivePoliciesAction.do?datasource=" + datasource + "&rimid=" + rimid;
...
<html>
  <head>
    ...
    {
      window.document.ActivePoliciesForm.action = '/activator<%=moduleConfig%>/CreationFormActivePoliciesAction.do?datasource=<%= datasource %>&rimid=<%= rimid %>&_location_=' + focusthis;
      window.document.ActivePoliciesForm.submit();
    }
    function performCommit()
    {
      window.document.ActivePoliciesForm.action = '/activator<%=moduleConfig%>/CreationCommitActivePoliciesAction.do?datasource=<%= datasource %>&rimid=<%= rimid %>';
      window.document.ActivePoliciesForm.submit();
    }
    function init()
    {
...
<h2 style="width:100%; text-align:center;">
  <bean:message bundle="ActivePoliciesApplicationResources" key="jsp.creation.title"/>
</h2> 
...
<html:form action="<%= formAction %>" style="text-align:center;">
    <table:table>
      ...
      <html:hidden property="refreshTreeRimid" value="<%= (String)request.getParameter(\"refreshTreeRimid\") %>"/>
              ...
              <table:cell>
                                                                        <html:text  property="id" size="24" value="<%= ID %>"/>
                                                </table:cell>
              <table:cell>
