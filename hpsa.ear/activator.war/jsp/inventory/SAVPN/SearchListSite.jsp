...
ArrayList al = (ArrayList) session.getAttribute(request.getParameter(SiteConstants.TAB_NAME));
String useRandomColor="1";
String mainColor ="1";

String datasource = request.getParameter(SiteConstants.DATASOURCE);
String tabName = request.getParameter(SiteConstants.TAB_NAME);
...
StringBuffer requestURI = new StringBuffer("/activator/jsp/inventory/SearchListSite.jsp?");
...
<html>
  <head>
    <title><bean:message bundle="SiteApplicationResources" key="<%= SiteConstants.JSP_RESULTS_TITLE %>"/></title>
  ...
  <bean:message bundle="SiteApplicationResources" key="jsp.search.results.title"/>
</h2> 

<display:table id="elementSearch" style="width:100%" requestURI="SearchCommitSiteAction.do" name="<%= searchListName %>" pagesize="10" export="true" sort="list" partialList="true" size="resultSize" decorator="com.hp.ov.activator.mwfm.servlet.inventory.inventorytree.taglib.displaytag.decorator.InventoryBuilderTableDecorator">

<%
        if ( ServiceId___hide == null || ServiceId___hide.equals("null") ) {
%>
      <display:column property="serviceid" sortable="true" titleKey="SiteApplicationResources:field.serviceid.alias" headerClass="tableTitle" class="tableCell"/>
<%
        }
        if ( ContactPerson___hide == null || ContactPerson___hide.equals("null") ) {
%>
      <display:column property="contactperson" sortable="true" titleKey="SiteApplicationResources:field.contactperson.alias" headerClass="tableTitle" class="tableCell"/>
<%
        }
        if ( ServiceName___hide == null || ServiceName___hide.equals("null") ) {
%>
      <display:column property="servicename" sortable="true" titleKey="SiteApplicationResources:field.servicename.alias" headerClass="tableTitle" class="tableCell"/>
<%
        }
        if ( Region___hide == null || Region___hide.equals("null") ) {
%>
      <display:column property="region" sortable="true" titleKey="SiteApplicationResources:field.region.alias" headerClass="tableTitle" class="tableCell"/>
<%
        }
        if ( InitiationDate___hide == null || InitiationDate___hide.equals("null") ) {
%>
      <display:column property="initiationdate" sortable="true" titleKey="SiteApplicationResources:field.initiationdate.alias" headerClass="tableTitle" class="tableCell"/>
<%
        }
        if ( ActivationDate___hide == null || ActivationDate___hide.equals("null") ) {
%>
      <display:column property="activationdate" sortable="true" titleKey="SiteApplicationResources:field.activationdate.alias" headerClass="tableTitle" class="tableCell"/>
<%
        }
        if ( ModificationDate___hide == null || ModificationDate___hide.equals("null") ) {
%>
      <display:column property="modificationdate" sortable="true" titleKey="SiteApplicationResources:field.modificationdate.alias" headerClass="tableTitle" class="tableCell"/>
<%
        }
        if ( State___hide == null || State___hide.equals("null") ) {
%>
      <display:column property="state" sortable="true" titleKey="SiteApplicationResources:field.state.alias" headerClass="tableTitle" class="tableCell"/>
<%
        }
        if ( Type___hide == null || Type___hide.equals("null") ) {
%>
      <display:column property="type" sortable="true" titleKey="SiteApplicationResources:field.type.alias" headerClass="tableTitle" class="tableCell"/>
<%
        }
        if ( SiteOfOrigin___hide == null || SiteOfOrigin___hide.equals("null") ) {
%>
      <display:column property="siteoforigin" sortable="true" titleKey="SiteApplicationResources:field.siteoforigin.alias" headerClass="tableTitle" class="tableCell"/>
<%
        }
        if ( Managed___hide == null || Managed___hide.equals("null") ) {
%>
      <display:column property="managed" sortable="true" titleKey="SiteApplicationResources:field.managed.alias" headerClass="tableTitle" class="tableCell"/>
<%
        }
        if ( Multicast___hide == null || Multicast___hide.equals("null") ) {
%>
      <display:column property="multicast" sortable="true" titleKey="SiteApplicationResources:field.multicast.alias" headerClass="tableTitle" class="tableCell"/>
<%
        }
        if ( RemoteASN___hide == null || RemoteASN___hide.equals("null") ) {
%>
      <display:column property="remoteasn" sortable="true" titleKey="SiteApplicationResources:field.remoteasn.alias" headerClass="tableTitle" class="tableCell"/>
<%
        }
        if ( OSPF_Area___hide == null || OSPF_Area___hide.equals("null") ) {
%>
      <display:column property="ospf_area" sortable="true" titleKey="SiteApplicationResources:field.ospf_area.alias" headerClass="tableTitle" class="tableCell"/>
<%
        }
        if ( Comments___hide == null || Comments___hide.equals("null") ) {
%>
      <display:column property="comments" sortable="true" titleKey="SiteApplicationResources:field.comments.alias" headerClass="tableTitle" class="tableCell"/>
<%
        }
        if ( CustomerId___hide == null || CustomerId___hide.equals("null") ) {
%>
      <display:column property="customerid" sortable="true" titleKey="SiteApplicationResources:field.customerid.alias" headerClass="tableTitle" class="tableCell"/>
<%
        }
        if ( PostalAddress___hide == null || PostalAddress___hide.equals("null") ) {
%>
      <display:column property="postaladdress" sortable="true" titleKey="SiteApplicationResources:field.postaladdress.alias" headerClass="tableTitle" class="tableCell"/>
<%
    }
%>
</display:table>
...
String backAction = "SearchFormSiteAction.do?datasource=" + datasource + "&tab_name=" + tabName + "&vi=" + viParameter + "&view=" + viewParameter + "&ndid=" + ndidParameter;
%>
...
%>
    <input type="submit" value="<%= backMessage %>" onclick="window.document.SiteForm.submit()"/>
  </html:form>
