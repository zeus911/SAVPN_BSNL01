...
String formAction = "/UpdateCommitMemoryTypesAction.do?datasource=" + datasource + "&rimid=" + rimid;
...
if ( pk == null || pk.equals("") ) {
  pk =    request.getParameter("memorytype") + "||" + request.getParameter("os") + "||" + request.getParameter("type") ;
}
...
<html>
  <head>
    ...
    {
      window.document.MemoryTypesForm.action = '/activator<%=moduleConfig%>/UpdateFormMemoryTypesAction.do?datasource=<%= datasource %>&rimid=<%= rimid %>&_pk_=<%=pk %>&_location_=' + focusthis;
      window.document.MemoryTypesForm.submit();
    }
    function performCommit()
    {
      window.document.MemoryTypesForm.action = '/activator<%=moduleConfig%>/UpdateCommitMemoryTypesAction.do?datasource=<%= datasource %>&rimid=<%= rimid %>&_pk_=<%=pk %>';
      window.document.MemoryTypesForm.submit();
    }
    function init()
    {
...
if(beanMemoryTypes==null)
   beanMemoryTypes = (com.hp.ov.activator.vpn.inventory.MemoryTypes) request.getSession().getAttribute(MemoryTypesConstants.MEMORYTYPES_BEAN);
...
<h2 style="width:100%; text-align:center;">
  <bean:message bundle="MemoryTypesApplicationResources" key="jsp.update.title"/>
</h2> 
...
<input type="hidden" name="_update_commit_" value="true"/> 
    <table:table>
      ...
      <html:hidden property="refreshTreeRimid" value="<%= (String)request.getParameter(\"refreshTreeRimid\") %>"/>
              ...
              <table:cell>
                                                      <html:hidden property="memorytype" value="<%= MemoryType %>"/>
                                                        <html:text disabled="true" property="memorytype" size="24" value="<%= MemoryType %>"/>
                                                </table:cell>
              <table:cell>
              ...
              <table:cell>
                                                      <html:hidden property="os" value="<%= OS %>"/>
                                                        <html:select disabled="true" property="os" value="<%= OS %>" >
