...
String refreshTree = (String) request.getAttribute(InterfaceConstants.REFRESH_TREE);
%>

<html>
  <head>
    <title><bean:message bundle="InterfaceApplicationResources" key="<%= InterfaceConstants.JSP_VIEW_TITLE %>"/></title>
...
ParentIf= StringFacility.replaceAllByHTMLCharacter(ParentIf);
	...
	if(beanInterface.getVlanid() != null)
      if((beanInterface.getVlanid()).equals(Integer.MIN_VALUE))
        VLANId = "";
...
<h2 style="width:100%; text-align:center;">
  <bean:message bundle="InterfaceApplicationResources" key="jsp.view.title"/>
</h2> 
          ...
          <bean:message bundle="InventoryResources" key="description.heading"/>
            ...
            <table:cell>
                      <bean:message bundle="InterfaceApplicationResources" key="field.parentifc.description"/>
                                                    ...
                                                    <%}%>      <%if(showIPAddr && (IPAddr != null && !"".equals(IPAddr))){%>
            ...
            <table:cell>
                      <bean:message bundle="InterfaceApplicationResources" key="field.ipaddr.description"/>
                                                    ...
                                                    <%}%>      <%if(showSubtype && (Subtype != null && !"".equals(Subtype))  ){%>       
            ...
            <table:cell>
                      <bean:message bundle="InterfaceApplicationResources" key="field.subtype.description"/>
                                                    ...
                                                    <%}%>      <%if(showEncapsulation &&   (Encapsulation != null && !"".equals(Encapsulation))  ){%>             
                                 <table:row>
            <table:cell>  
            ...
            <table:cell>
                      <bean:message bundle="InterfaceApplicationResources" key="field.description.description"/>
                                                    ...
                                                    <%}%>      <%if(showIFIndex &&   (IFIndex != null && !"".equals(IFIndex)) ){%>             
                                 <table:row>
            <table:cell>  
            ...
            <table:cell>
                      <bean:message bundle="InterfaceApplicationResources" key="field.usagestate.description"/>
                                                    ...
                                                    <%}%>
<%      if(beanInterface.getVlanid() != null) {
		  if (!(beanInterface.getVlanid().equals(Integer.MIN_VALUE)) && (!beanInterface.getVlanid().equals("0"))) { 
          if ("bridge-group".equals(Type)) {
%>
    <table:row>
        <table:cell>
            Interface Id
        ...
        <table:cell>
            Interface assigned to a Bridge Group
        </table:cell>
    </table:row>
<%        } else {
%>
...
%>
                                                    <%}%>      <%if(showVLANMode  && (VLANMode != null && !"".equals(VLANMode))){%>             
                                 <table:row>
            <table:cell>  
            ...
            <table:cell>
                      <bean:message bundle="InterfaceApplicationResources" key="field.vlanmode.description"/>
                                                    ...
                                                    <%}%>      <%if(showDLCI && (DLCI != null && !"".equals(DLCI))){%>             
                                 <table:row>
            <table:cell>  
            ...
            <table:cell>
                      <bean:message bundle="InterfaceApplicationResources" key="field.dlci.description"/>
                                                    ...
                                                    <%}%>      <%if(showBundleKey  && (BundleKey != null && !"".equals(BundleKey))){%>             
                                 <table:row>
            <table:cell>  
            ...
            <table:cell>
                      <bean:message bundle="InterfaceApplicationResources" key="field.bundlekey.description"/>
                                                    ...
                                                    <%}%>      <%if(showBundleId && (BundleId != null && !"".equals(BundleId))){%>             
                                 <table:row>
            <table:cell>  
            ...
            <table:cell>
                      <bean:message bundle="InterfaceApplicationResources" key="field.bundleid.description"/>
                                                    ...
                                                    <%}%>      
<%      if (Timeslots != null && NumberOfSlots!=null && !"".equals(NumberOfSlots) && !"".equals(Timeslots) && (Integer.valueOf(beanInterface.getNumberofslots()).intValue() != 32) ) { %>
...
<%      if (!"".equals(NumberOfSlots) && Integer.valueOf(beanInterface.getNumberofslots()).intValue() != Integer.MIN_VALUE) { 
          if (Integer.valueOf(beanInterface.getNumberofslots()).intValue() == 32) { // unframed
%>
...
%>
            ...
            <table:cell>
                      <bean:message bundle="InterfaceApplicationResources" key="field.bandwidth.description"/>
                                                    ...
                                                    <%}%>      <%if(showLMIType && (LMIType != null && !"".equals(LMIType)) ){%>             
                                 <table:row>
            <table:cell>  
            ...
            <table:cell>
                      <bean:message bundle="InterfaceApplicationResources" key="field.lmitype.description"/>
                                                    ...
                                                    <%}%>      <%if(showIntfType && (IntfType != null && !"".equals(IntfType))){%>             
                                 <table:row>
            <table:cell>  
