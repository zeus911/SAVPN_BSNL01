...
String refreshTree = (String) request.getAttribute(MCASTProfileMembershipConstants.REFRESH_TREE);
%>

<html>
  <head>
    <title><bean:message bundle="MCASTProfileMembershipApplicationResources" key="<%= MCASTProfileMembershipConstants.JSP_VIEW_TITLE %>"/></title>
...
<h2 style="width:100%; text-align:center;">
  <bean:message bundle="MCASTProfileMembershipApplicationResources" key="jsp.view.title"/>
</h2> 
