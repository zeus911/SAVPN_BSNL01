...
ArrayList al = (ArrayList) session.getAttribute(request.getParameter(L3FlowPointConstants.TAB_NAME));
String useRandomColor="1";
String mainColor ="1";

String datasource = request.getParameter(L3FlowPointConstants.DATASOURCE);
String tabName = request.getParameter(L3FlowPointConstants.TAB_NAME);
...
StringBuffer requestURI = new StringBuffer("/activator/jsp/inventory/SearchListL3FlowPoint.jsp?");
...
<html>
  <head>
    <title><bean:message bundle="L3FlowPointApplicationResources" key="<%= L3FlowPointConstants.JSP_RESULTS_TITLE %>"/></title>
  ...
  <bean:message bundle="L3FlowPointApplicationResources" key="jsp.search.results.title"/>
</h2> 

<display:table id="elementSearch" style="width:100%" requestURI="SearchCommitL3FlowPointAction.do" name="<%= searchListName %>" pagesize="10" export="true" sort="list" partialList="true" size="resultSize" decorator="com.hp.ov.activator.mwfm.servlet.inventory.inventorytree.taglib.displaytag.decorator.InventoryBuilderTableDecorator">

<%
        if ( TerminationPointId___hide == null || TerminationPointId___hide.equals("null") ) {
%>
      <display:column property="terminationpointid" sortable="true" titleKey="L3FlowPointApplicationResources:field.terminationpointid.alias" headerClass="tableTitle" class="tableCell"/>
<%
        }
        if ( AttachmentId___hide == null || AttachmentId___hide.equals("null") ) {
%>
      <display:column property="attachmentid" sortable="true" titleKey="L3FlowPointApplicationResources:field.attachmentid.alias" headerClass="tableTitle" class="tableCell"/>
<%
        }
        if ( VRFName___hide == null || VRFName___hide.equals("null") ) {
%>
      <display:column property="vrfname" sortable="true" titleKey="L3FlowPointApplicationResources:field.vrfname.alias" headerClass="tableTitle" class="tableCell"/>
<%
        }
        if ( PE_InterfaceIP___hide == null || PE_InterfaceIP___hide.equals("null") ) {
%>
      <display:column property="pe_interfaceip" sortable="true" titleKey="L3FlowPointApplicationResources:field.pe_interfaceip.alias" headerClass="tableTitle" class="tableCell"/>
<%
        }
        if ( PE_InterfaceSecondaryIP___hide == null || PE_InterfaceSecondaryIP___hide.equals("null") ) {
%>
      <display:column property="pe_interfacesecondaryip" sortable="true" titleKey="L3FlowPointApplicationResources:field.pe_interfacesecondaryip.alias" headerClass="tableTitle" class="tableCell"/>
<%
        }
        if ( CE_InterfaceIP___hide == null || CE_InterfaceIP___hide.equals("null") ) {
%>
      <display:column property="ce_interfaceip" sortable="true" titleKey="L3FlowPointApplicationResources:field.ce_interfaceip.alias" headerClass="tableTitle" class="tableCell"/>
<%
        }
        if ( CE_InterfaceSecondaryIP___hide == null || CE_InterfaceSecondaryIP___hide.equals("null") ) {
%>
      <display:column property="ce_interfacesecondaryip" sortable="true" titleKey="L3FlowPointApplicationResources:field.ce_interfacesecondaryip.alias" headerClass="tableTitle" class="tableCell"/>
<%
        }
        if ( Protocol___hide == null || Protocol___hide.equals("null") ) {
%>
      <display:column property="protocol" sortable="true" titleKey="L3FlowPointApplicationResources:field.protocol.alias" headerClass="tableTitle" class="tableCell"/>
<%
        }
        if ( OSPF_id___hide == null || OSPF_id___hide.equals("null") ) {
%>
      <display:column property="ospf_id" sortable="true" titleKey="L3FlowPointApplicationResources:field.ospf_id.alias" headerClass="tableTitle" class="tableCell"/>
<%
        }
        if ( Rip_id___hide == null || Rip_id___hide.equals("null") ) {
%>
      <display:column property="rip_id" sortable="true" titleKey="L3FlowPointApplicationResources:field.rip_id.alias" headerClass="tableTitle" class="tableCell"/>
<%
        }
        if ( Maximum_Prefix___hide == null || Maximum_Prefix___hide.equals("null") ) {
%>
      <display:column property="maximum_prefix" sortable="true" titleKey="L3FlowPointApplicationResources:field.maximum_prefix.alias" headerClass="tableTitle" class="tableCell"/>
<%
        }
        if ( StaticRoutes___hide == null || StaticRoutes___hide.equals("null") ) {
%>
      <display:column property="staticroutes" sortable="true" titleKey="L3FlowPointApplicationResources:field.staticroutes.alias" headerClass="tableTitle" class="tableCell"/>
<%
        }
        if ( SOO_Configured___hide == null || SOO_Configured___hide.equals("null") ) {
%>
      <display:column property="soo_configured" sortable="true" titleKey="L3FlowPointApplicationResources:field.soo_configured.alias" headerClass="tableTitle" class="tableCell"/>
<%
        }
        if ( RateLimit_in___hide == null || RateLimit_in___hide.equals("null") ) {
%>
      <display:column property="ratelimit_in" sortable="true" titleKey="L3FlowPointApplicationResources:field.ratelimit_in.alias" headerClass="tableTitle" class="tableCell"/>
<%
        }
        if ( QoSProfile_in___hide == null || QoSProfile_in___hide.equals("null") ) {
%>
      <display:column property="qosprofile_in" sortable="true" titleKey="L3FlowPointApplicationResources:field.qosprofile_in.alias" headerClass="tableTitle" class="tableCell"/>
<%
        }
        if ( RateLimit_out___hide == null || RateLimit_out___hide.equals("null") ) {
%>
      <display:column property="ratelimit_out" sortable="true" titleKey="L3FlowPointApplicationResources:field.ratelimit_out.alias" headerClass="tableTitle" class="tableCell"/>
<%
        }
        if ( QoSProfile_out___hide == null || QoSProfile_out___hide.equals("null") ) {
%>
      <display:column property="qosprofile_out" sortable="true" titleKey="L3FlowPointApplicationResources:field.qosprofile_out.alias" headerClass="tableTitle" class="tableCell"/>
<%
        }
        if ( QoSChildEnabled___hide == null || QoSChildEnabled___hide.equals("null") ) {
%>
      <display:column property="qoschildenabled" sortable="true" titleKey="L3FlowPointApplicationResources:field.qoschildenabled.alias" headerClass="tableTitle" class="tableCell"/>
<%
        }
        if ( mCAR___hide == null || mCAR___hide.equals("null") ) {
%>
      <display:column property="mcar" sortable="true" titleKey="L3FlowPointApplicationResources:field.mcar.alias" headerClass="tableTitle" class="tableCell"/>
<%
        }
        if ( mCoS___hide == null || mCoS___hide.equals("null") ) {
%>
      <display:column property="mcos" sortable="true" titleKey="L3FlowPointApplicationResources:field.mcos.alias" headerClass="tableTitle" class="tableCell"/>
<%
        }
        if ( LoopbackId___hide == null || LoopbackId___hide.equals("null") ) {
%>
      <display:column property="loopbackid" sortable="true" titleKey="L3FlowPointApplicationResources:field.loopbackid.alias" headerClass="tableTitle" class="tableCell"/>
<%
        }
        if ( Master___hide == null || Master___hide.equals("null") ) {
%>
      <display:column property="master" sortable="true" titleKey="L3FlowPointApplicationResources:field.master.alias" headerClass="tableTitle" class="tableCell"/>
<%
        }
        if ( Priority___hide == null || Priority___hide.equals("null") ) {
%>
      <display:column property="priority" sortable="true" titleKey="L3FlowPointApplicationResources:field.priority.alias" headerClass="tableTitle" class="tableCell"/>
<%
        }
        if ( VRRP_Group_Id___hide == null || VRRP_Group_Id___hide.equals("null") ) {
%>
      <display:column property="vrrp_group_id" sortable="true" titleKey="L3FlowPointApplicationResources:field.vrrp_group_id.alias" headerClass="tableTitle" class="tableCell"/>
<%
        }
        if ( UsageMode___hide == null || UsageMode___hide.equals("null") ) {
%>
      <display:column property="usagemode" sortable="true" titleKey="L3FlowPointApplicationResources:field.usagemode.alias" headerClass="tableTitle" class="tableCell"/>
<%
    }
%>
</display:table>
...
String backAction = "SearchFormL3FlowPointAction.do?datasource=" + datasource + "&tab_name=" + tabName + "&vi=" + viParameter + "&view=" + viewParameter + "&ndid=" + ndidParameter;
%>
...
%>
    <input type="submit" value="<%= backMessage %>" onclick="window.document.L3FlowPointForm.submit()"/>
  </html:form>
