...
ArrayList al = (ArrayList) session.getAttribute(request.getParameter(Sh_PolicyMappingConstants.TAB_NAME));
String useRandomColor="1";
String mainColor ="1";

String datasource = request.getParameter(Sh_PolicyMappingConstants.DATASOURCE);
String tabName = request.getParameter(Sh_PolicyMappingConstants.TAB_NAME);
...
StringBuffer requestURI = new StringBuffer("/activator/jsp/inventory/SearchListSh_PolicyMapping.jsp?");
...
<html>
  <head>
    <title><bean:message bundle="Sh_PolicyMappingApplicationResources" key="<%= Sh_PolicyMappingConstants.JSP_RESULTS_TITLE %>"/></title>
  ...
  <bean:message bundle="Sh_PolicyMappingApplicationResources" key="jsp.search.results.title"/>
</h2> 

<display:table id="elementSearch" style="width:100%" requestURI="SearchCommitSh_PolicyMappingAction.do" name="<%= searchListName %>" pagesize="10" export="true" sort="list" partialList="true" size="resultSize" decorator="com.hp.ov.activator.mwfm.servlet.inventory.inventorytree.taglib.displaytag.decorator.InventoryBuilderTableDecorator">

<%
        if ( TClassName___hide == null || TClassName___hide.equals("null") ) {
%>
      <display:column property="tclassname" sortable="true" titleKey="Sh_PolicyMappingApplicationResources:field.tclassname.alias" headerClass="tableTitle" class="tableCell"/>
<%
        }
        if ( ProfileName___hide == null || ProfileName___hide.equals("null") ) {
%>
      <display:column property="profilename" sortable="true" titleKey="Sh_PolicyMappingApplicationResources:field.profilename.alias" headerClass="tableTitle" class="tableCell"/>
<%
        }
        if ( Exp___hide == null || Exp___hide.equals("null") ) {
%>
      <display:column property="exp" sortable="true" titleKey="Sh_PolicyMappingApplicationResources:field.exp.alias" headerClass="tableTitle" class="tableCell"/>
<%
        }
        if ( Dscp___hide == null || Dscp___hide.equals("null") ) {
%>
      <display:column property="dscp" sortable="true" titleKey="Sh_PolicyMappingApplicationResources:field.dscp.alias" headerClass="tableTitle" class="tableCell"/>
<%
        }
        if ( Percentage___hide == null || Percentage___hide.equals("null") ) {
%>
      <display:column property="percentage" sortable="true" titleKey="Sh_PolicyMappingApplicationResources:field.percentage.alias" headerClass="tableTitle" class="tableCell"/>
<%
        }
        if ( Position___hide == null || Position___hide.equals("null") ) {
%>
      <display:column property="position" sortable="true" titleKey="Sh_PolicyMappingApplicationResources:field.position.alias" headerClass="tableTitle" class="tableCell"/>
<%
        }
        if ( PLP___hide == null || PLP___hide.equals("null") ) {
%>
      <display:column property="plp" sortable="true" titleKey="Sh_PolicyMappingApplicationResources:field.plp.alias" headerClass="tableTitle" class="tableCell"/>
<%
        }
        if ( queueName___hide == null || queueName___hide.equals("null") ) {
%>
      <display:column property="queuename" sortable="true" titleKey="Sh_PolicyMappingApplicationResources:field.queuename.alias" headerClass="tableTitle" class="tableCell"/>
<%
        }
        if ( CoSName___hide == null || CoSName___hide.equals("null") ) {
%>
      <display:column property="cosname" sortable="true" titleKey="Sh_PolicyMappingApplicationResources:field.cosname.alias" headerClass="tableTitle" class="tableCell"/>
<%
        }
        if ( Marker___hide == null || Marker___hide.equals("null") ) {
%>
      <display:column property="marker" sortable="true" titleKey="Sh_PolicyMappingApplicationResources:field.marker.alias" headerClass="tableTitle" class="tableCell"/>
<%
        }
        if ( UploadStatus___hide == null || UploadStatus___hide.equals("null") ) {
%>
      <display:column property="uploadstatus" sortable="true" titleKey="Sh_PolicyMappingApplicationResources:field.uploadstatus.alias" headerClass="tableTitle" class="tableCell"/>
<%
        }
        if ( DBPrimaryKey___hide == null || DBPrimaryKey___hide.equals("null") ) {
%>
      <display:column property="dbprimarykey" sortable="true" titleKey="Sh_PolicyMappingApplicationResources:field.dbprimarykey.alias" headerClass="tableTitle" class="tableCell"/>
<%
    }
%>
</display:table>
...
String backAction = "SearchFormSh_PolicyMappingAction.do?datasource=" + datasource + "&tab_name=" + tabName + "&vi=" + viParameter + "&view=" + viewParameter + "&ndid=" + ndidParameter;
%>
...
%>
    <input type="submit" value="<%= backMessage %>" onclick="window.document.Sh_PolicyMappingForm.submit()"/>
  </html:form>
