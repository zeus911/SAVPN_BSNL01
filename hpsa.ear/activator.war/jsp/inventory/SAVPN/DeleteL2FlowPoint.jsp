...
<html>
  <head>
    <title><bean:message bundle="L2FlowPointApplicationResources" key="<%= L2FlowPointConstants.JSP_DELETE_TITLE %>"/></title>
    ...
    {
      window.document.L2FlowPointForm.action = '/activator<%=moduleConfig%>/DeleteCommitL2FlowPointAction.do?datasource=<%= datasource %>&rimid=<%= rimid %>';
      window.document.L2FlowPointForm.submit();
    }
    function init()
    {
      var confirm = new HPSAConfirm('Confirm','<bean:message bundle="L2FlowPointApplicationResources" key="delete.confirm"/>', '<bean:message bundle="InventoryResources" key="confirm.ok_button.label"/>', '<bean:message bundle="InventoryResources" key="confirm.cancel_button.label"/>');
...
nfB.setMaximumFractionDigits(6);
                  ...
                  String TerminationPointId = StringFacility.replaceAllByHTMLCharacter(beanL2FlowPoint.getTerminationpointid());
                        
                                  
                      String AttachmentId = StringFacility.replaceAllByHTMLCharacter(beanL2FlowPoint.getAttachmentid());
                        
                                  
                      String QoSProfile_in = StringFacility.replaceAllByHTMLCharacter(beanL2FlowPoint.getQosprofile_in());
                        
                                  
                      String QoSProfile_out = StringFacility.replaceAllByHTMLCharacter(beanL2FlowPoint.getQosprofile_out());
                        
                                  
                      String RateLimit_in = StringFacility.replaceAllByHTMLCharacter(beanL2FlowPoint.getRatelimit_in());
                        
                                  
                      String RateLimit_out = StringFacility.replaceAllByHTMLCharacter(beanL2FlowPoint.getRatelimit_out());
                        
                                  
                      String UsageMode = StringFacility.replaceAllByHTMLCharacter(beanL2FlowPoint.getUsagemode());
                        
                                  
                      String ConnectionId = StringFacility.replaceAllByHTMLCharacter(beanL2FlowPoint.getConnectionid());
                        
                                  
                      String ServiceType = StringFacility.replaceAllByHTMLCharacter(beanL2FlowPoint.getServicetype());
                        
                                  
                      String Facing = StringFacility.replaceAllByHTMLCharacter(beanL2FlowPoint.getFacing());
                        
                                  
    
%>
<h2 style="width:100%; text-align:center;">
    <bean:message bundle="L2FlowPointApplicationResources" key="jsp.delete.title"/>
</h2> 
...
boolean ServiceTypePass_Facing = false ;
ServiceTypePass_Facing = java.util.regex.Pattern.compile("^L2VPWS$").matcher(ServiceType).matches();
boolean showFacing = false;
  if (true && ServiceTypePass_Facing ){
showFacing = true;
}
...
%>
    ...
    <table:table>
      ...
      <%if(showTerminationPointId){%>                                <table:row>
            ...
            <table:cell>
                            <%
                  java.util.HashMap<Object,Object>  valueShowMap=new java.util.HashMap<Object,Object> ();
                                            valueShowMap.put("aEnd" ,"aEnd");
                                            valueShowMap.put("zEnd" ,"zEnd");
                                          if(Facing!=null)
                     Facing=(String)valueShowMap.get(Facing);
              %>
              <%= Facing != null? Facing : "" %>
                          </table:cell>
            <table:cell>
    ...
    <html:form action="/DeleteCommitL2FlowPointAction.do">
