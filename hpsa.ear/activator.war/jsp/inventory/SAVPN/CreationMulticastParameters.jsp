...
String formAction = "/CreationCommitMulticastParametersAction.do?datasource=" + datasource + "&rimid=" + rimid;
...
<html>
  <head>
    ...
    {
      window.document.MulticastParametersForm.action = '/activator<%=moduleConfig%>/CreationFormMulticastParametersAction.do?datasource=<%= datasource %>&rimid=<%= rimid %>&_location_=' + focusthis;
      window.document.MulticastParametersForm.submit();
    }
    function performCommit()
    {
      window.document.MulticastParametersForm.action = '/activator<%=moduleConfig%>/CreationCommitMulticastParametersAction.do?datasource=<%= datasource %>&rimid=<%= rimid %>';
      window.document.MulticastParametersForm.submit();
    }
    function init()
    {
...
<h2 style="width:100%; text-align:center;">
  <bean:message bundle="MulticastParametersApplicationResources" key="jsp.creation.title"/>
</h2> 
