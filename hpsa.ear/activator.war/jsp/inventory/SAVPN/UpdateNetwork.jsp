...
if(beanNetwork==null)
   beanNetwork = (com.hp.ov.activator.vpn.inventory.Network) request.getSession().getAttribute(NetworkConstants.NETWORK_BEAN);
      ...
      <html:hidden property="refreshTreeRimid" value="<%= (String)request.getParameter(\"refreshTreeRimid\") %>"/>
              ...
              <table:cell>
                <bean:message bundle="NetworkApplicationResources" key="field.type.description"/>
                                                    ...
                                                    <html:hidden property="isservice" value="false"/>  
<% if (Type.equals("Topology")) { %>
              ...
              <table:cell>
                                                      <html:hidden property="asnc" value="<%= ASNC %>"/>
<% if (isService) { %>
                                                        <html:text disabled="true" property="asnc" size="24" value="<%= ASNC %>"/>
<%} else {%>
...
<table:cell>
<% if (isService) { %>
<html:text disabled="true" property="asn" size="24" value="<%= ASN%>"/>
<%} else {%>
