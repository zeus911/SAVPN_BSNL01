...
String tabName = (String) request.getParameter(WorkorderURLConstants.TAB_NAME);
...
<script>
function clearForm() {
var formObj = document.WorkorderURLFormSearch;
...
if (element.type == 'select-one') { element.selectedIndex = -1; }
  ...
  var checkfalse=false;
                    if(document.getElementsByName("wodistributionid___hide")[0].checked) {
            ...
            if(checkfalse){
    alert("<bean:message bundle="WorkorderURLApplicationResources" key="<%= WorkorderURLConstants.JSP_SEARCH_NO_SHOW %>"/>");
  }else{
    window.document.WorkorderURLFormSearch.action = '/activator<%=moduleConfig%>/SearchCommitWorkorderURLAction.do?datasource=<%= datasource %>&tab_name=<%= tabName %>&vi=<%= viParameter%>&view=<%= viewParameter %>&ndid=<%= ndidParameter %>';
    window.document.WorkorderURLFormSearch.submit();
  }
  }
</script>
...
if (session == null || session.getValue(WorkorderURLConstants.USER) == null) {
  response.sendRedirect(WorkorderURLConstants.NULL_SESSION);
  return;
}
...
<%
      String WODistributionID = form.getWodistributionid();
          String WODistributionID___ = form.getWodistributionid___();
...
<h2 style="width:100%; text-align:center;">
  <bean:message bundle="WorkorderURLApplicationResources" key="jsp.search.title"/>
</h2> 
...
<% String searchFormAction = "/SearchCommitWorkorderURLAction.do?datasource="+datasource+"&tab_name="+tabName+"&vi="+ viParameter+"&view="+ viewParameter +"&ndid="+ ndidParameter ;%>
      ...
      <table:header>
        ...
        <table:cell>
          <bean:message bundle="InventoryResources" key="description.heading"/>
            ...
            <table:cell>
              <center>
                <html:checkbox property="wodistributionid___hide" value="true"/>
              </center>
            </table:cell>
            ...
            <table:cell>
                              <html:text property="wodistributionid" size="16" value="<%= WODistributionID %>"/>
                                  -
                  <html:text property="wodistributionid___" size="16" value="<%= WODistributionID___ %>"/>
                                          </table:cell>
