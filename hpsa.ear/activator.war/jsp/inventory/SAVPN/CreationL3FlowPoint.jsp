...
String formAction = "/CreationCommitL3FlowPointAction.do?datasource=" + datasource + "&rimid=" + rimid;
...
<html>
  <head>
    ...
    {
      window.document.L3FlowPointForm.action = '/activator<%=moduleConfig%>/CreationFormL3FlowPointAction.do?datasource=<%= datasource %>&rimid=<%= rimid %>&_location_=' + focusthis;
      window.document.L3FlowPointForm.submit();
    }
    function performCommit()
    {
      window.document.L3FlowPointForm.action = '/activator<%=moduleConfig%>/CreationCommitL3FlowPointAction.do?datasource=<%= datasource %>&rimid=<%= rimid %>';
      window.document.L3FlowPointForm.submit();
    }
    function init()
    {
...
<h2 style="width:100%; text-align:center;">
  <bean:message bundle="L3FlowPointApplicationResources" key="jsp.creation.title"/>
</h2> 
