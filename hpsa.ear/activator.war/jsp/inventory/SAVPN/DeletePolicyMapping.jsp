...
<html>
  <head>
    <title><bean:message bundle="PolicyMappingApplicationResources" key="<%= PolicyMappingConstants.JSP_DELETE_TITLE %>"/></title>
    ...
    {
      window.document.PolicyMappingForm.action = '/activator<%=moduleConfig%>/DeleteCommitPolicyMappingAction.do?datasource=<%= datasource %>&rimid=<%= rimid %>';
      window.document.PolicyMappingForm.submit();
    }
    function init()
    {
      var confirm = new HPSAConfirm('Confirm','<bean:message bundle="PolicyMappingApplicationResources" key="delete.confirm"/>', '<bean:message bundle="InventoryResources" key="confirm.ok_button.label"/>', '<bean:message bundle="InventoryResources" key="confirm.cancel_button.label"/>');
...
nfB.setMaximumFractionDigits(6);
                  ...
                  String TClassName = StringFacility.replaceAllByHTMLCharacter(beanPolicyMapping.getTclassname());
                        
                                  
                      String ProfileName = StringFacility.replaceAllByHTMLCharacter(beanPolicyMapping.getProfilename());
                        
                                  
                      String Exp = StringFacility.replaceAllByHTMLCharacter(beanPolicyMapping.getExp());
                        
                                  
                      String Dscp = StringFacility.replaceAllByHTMLCharacter(beanPolicyMapping.getDscp());
                        
                                  
                      String Percentage = StringFacility.replaceAllByHTMLCharacter(beanPolicyMapping.getPercentage());
                        
                                  
                      String Position = StringFacility.replaceAllByHTMLCharacter(beanPolicyMapping.getPosition());
                        
                                  
                      String PLP = StringFacility.replaceAllByHTMLCharacter(beanPolicyMapping.getPlp());
                        
                                  
                      String queueName = StringFacility.replaceAllByHTMLCharacter(beanPolicyMapping.getQueuename());
                        
                                  
                      String CoSName = StringFacility.replaceAllByHTMLCharacter(beanPolicyMapping.getCosname());
                        
                                  
    
%>
<h2 style="width:100%; text-align:center;">
    <bean:message bundle="PolicyMappingApplicationResources" key="jsp.delete.title"/>
</h2> 
...
%>
    ...
    <html:form action="/DeleteCommitPolicyMappingAction.do">
