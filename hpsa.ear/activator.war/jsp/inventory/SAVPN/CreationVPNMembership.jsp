...
String formAction = "/CreationCommitVPNMembershipAction.do?datasource=" + datasource + "&rimid=" + rimid;
...
<html>
  <head>
    ...
    {
      window.document.VPNMembershipForm.action = '/activator<%=moduleConfig%>/CreationFormVPNMembershipAction.do?datasource=<%= datasource %>&rimid=<%= rimid %>&_location_=' + focusthis;
      window.document.VPNMembershipForm.submit();
    }
    function performCommit()
    {
      window.document.VPNMembershipForm.action = '/activator<%=moduleConfig%>/CreationCommitVPNMembershipAction.do?datasource=<%= datasource %>&rimid=<%= rimid %>';
      window.document.VPNMembershipForm.submit();
    }
    function init()
    {
...
<h2 style="width:100%; text-align:center;">
  <bean:message bundle="VPNMembershipApplicationResources" key="jsp.creation.title"/>
</h2> 
