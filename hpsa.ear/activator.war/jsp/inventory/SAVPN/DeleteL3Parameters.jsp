...
<html>
  <head>
    <title><bean:message bundle="L3ParametersApplicationResources" key="<%= L3ParametersConstants.JSP_DELETE_TITLE %>"/></title>
    ...
    {
      window.document.L3ParametersForm.action = '/activator<%=moduleConfig%>/DeleteCommitL3ParametersAction.do?datasource=<%= datasource %>&rimid=<%= rimid %>';
      window.document.L3ParametersForm.submit();
    }
    function init()
    {
      var confirm = new HPSAConfirm('Confirm','<bean:message bundle="L3ParametersApplicationResources" key="delete.confirm"/>', '<bean:message bundle="InventoryResources" key="confirm.ok_button.label"/>', '<bean:message bundle="InventoryResources" key="confirm.cancel_button.label"/>');
...
nfB.setMaximumFractionDigits(6);
                  ...
                  String Name = StringFacility.replaceAllByHTMLCharacter(beanL3Parameters.getName());
                        
                                  
                      boolean Value = new Boolean(beanL3Parameters.getValue()).booleanValue();
                  
                                  
                      String Description = StringFacility.replaceAllByHTMLCharacter(beanL3Parameters.getDescription());
                        
                                  
    
%>
<h2 style="width:100%; text-align:center;">
    <bean:message bundle="L3ParametersApplicationResources" key="jsp.delete.title"/>
</h2> 
...
%>
    ...
    <html:form action="/DeleteCommitL3ParametersAction.do">
