...
String refreshTree = (String) request.getAttribute(DL_StateConstants.REFRESH_TREE);
%>

<html>
  <head>
    <title><bean:message bundle="DL_StateApplicationResources" key="<%= DL_StateConstants.JSP_VIEW_TITLE %>"/></title>
...
<h2 style="width:100%; text-align:center;">
  <bean:message bundle="DL_StateApplicationResources" key="jsp.view.title"/>
</h2> 
