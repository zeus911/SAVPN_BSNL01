...
String formAction = "/UpdateCommitElementComponentAction.do?datasource=" + datasource + "&rimid=" + rimid;
...
if ( pk == null || pk.equals("") ) {
  pk =    request.getParameter("elementcomponentid") ;
}
...
<html>
  <head>
    ...
    {
      window.document.ElementComponentForm.action = '/activator<%=moduleConfig%>/UpdateFormElementComponentAction.do?datasource=<%= datasource %>&rimid=<%= rimid %>&_pk_=<%=pk %>&_location_=' + focusthis;
      window.document.ElementComponentForm.submit();
    }
    function performCommit()
    {
      window.document.ElementComponentForm.action = '/activator<%=moduleConfig%>/UpdateCommitElementComponentAction.do?datasource=<%= datasource %>&rimid=<%= rimid %>&_pk_=<%=pk %>';
      window.document.ElementComponentForm.submit();
    }
    function init()
    {
...
if(beanElementComponent==null)
   beanElementComponent = (com.hp.ov.activator.cr.inventory.ElementComponent) request.getSession().getAttribute(ElementComponentConstants.ELEMENTCOMPONENT_BEAN);
...
<h2 style="width:100%; text-align:center;">
  <bean:message bundle="ElementComponentApplicationResources" key="jsp.update.title"/>
</h2> 
      ...
      <html:hidden property="refreshTreeRimid" value="<%= (String)request.getParameter(\"refreshTreeRimid\") %>"/>
              ...
              <table:cell>
                                                      <html:hidden property="elementcomponentid" value="<%= ElementComponentId %>"/>
                                                        <html:text disabled="true" property="elementcomponentid" size="24" value="<%= ElementComponentId %>"/>
                                                </table:cell>
              <table:cell>
              ...
              <table:cell>
                                                      <html:hidden property="parentec_id" value="<%= ParentEC_Id %>"/>
                                                        <html:select disabled="true" property="parentec_id" value="<%= ParentEC_Id %>" >
              ...
              <table:cell>
                                                      <html:hidden property="capacity" value="<%= Capacity %>"/>
                                                        <html:text disabled="true" property="capacity" size="24" value="<%= Capacity %>"/>
                                                </table:cell>
              <table:cell>
