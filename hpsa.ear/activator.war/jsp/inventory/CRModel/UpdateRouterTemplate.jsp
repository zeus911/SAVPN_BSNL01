...
String formAction = "/UpdateCommitRouterTemplateAction.do?datasource=" + datasource + "&rimid=" + rimid;
...
if ( pk == null || pk.equals("") ) {
  pk =    request.getParameter("elementtypegroupname") + "||" + request.getParameter("osversiongroup") + "||" + request.getParameter("name") ;
}
...
<html>
  <head>
    ...
    {
      window.document.RouterTemplateForm.action = '/activator<%=moduleConfig%>/UpdateFormRouterTemplateAction.do?datasource=<%= datasource %>&rimid=<%= rimid %>&_pk_=<%=pk %>&_location_=' + focusthis;
      window.document.RouterTemplateForm.submit();
    }
    function performCommit()
    {
      window.document.RouterTemplateForm.action = '/activator<%=moduleConfig%>/UpdateCommitRouterTemplateAction.do?datasource=<%= datasource %>&rimid=<%= rimid %>&_pk_=<%=pk %>';
      window.document.RouterTemplateForm.submit();
    }
    function init()
    {
...
if(beanRouterTemplate==null)
   beanRouterTemplate = (com.hp.ov.activator.cr.inventory.RouterTemplate) request.getSession().getAttribute(RouterTemplateConstants.ROUTERTEMPLATE_BEAN);
...
<h2 style="width:100%; text-align:center;">
  <bean:message bundle="RouterTemplateApplicationResources" key="jsp.update.title"/>
</h2> 
...
<input type="hidden" name="_update_commit_" value="true"/> 
    <table:table>
      ...
      <html:hidden property="refreshTreeRimid" value="<%= (String)request.getParameter(\"refreshTreeRimid\") %>"/>
              ...
              <table:cell>
                                                      <html:hidden property="elementtypegroupname" value="<%= ElementTypeGroupName %>"/>
                                                        <html:select disabled="true" property="elementtypegroupname" value="<%= ElementTypeGroupName %>" onchange="sendthis('elementtypegroupname');">
              ...
              <table:cell>
                                                      <html:hidden property="osversiongroup" value="<%= OSVersionGroup %>"/>
                                                        <html:select disabled="true" property="osversiongroup" value="<%= OSVersionGroup %>" >
