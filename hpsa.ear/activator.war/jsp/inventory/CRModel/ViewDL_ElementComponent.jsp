...
String refreshTree = (String) request.getAttribute(DL_ElementComponentConstants.REFRESH_TREE);
%>

<html>
  <head>
    <title><bean:message bundle="DL_ElementComponentApplicationResources" key="<%= DL_ElementComponentConstants.JSP_VIEW_TITLE %>"/></title>
...
<h2 style="width:100%; text-align:center;">
  <bean:message bundle="DL_ElementComponentApplicationResources" key="jsp.view.title"/>
</h2> 
