...
String formAction = "/CreationCommitPWPolicyAction.do?datasource=" + datasource + "&rimid=" + rimid;
...
<html>
  <head>
    ...
    {
      window.document.PWPolicyForm.action = '/activator<%=moduleConfig%>/CreationFormPWPolicyAction.do?datasource=<%= datasource %>&rimid=<%= rimid %>&_location_=' + focusthis;
      window.document.PWPolicyForm.submit();
    }
    function performCommit()
    {
      window.document.PWPolicyForm.action = '/activator<%=moduleConfig%>/CreationCommitPWPolicyAction.do?datasource=<%= datasource %>&rimid=<%= rimid %>';
      window.document.PWPolicyForm.submit();
    }
    function init()
    {
...
<h2 style="width:100%; text-align:center;">
  <bean:message bundle="PWPolicyApplicationResources" key="jsp.creation.title"/>
</h2> 
