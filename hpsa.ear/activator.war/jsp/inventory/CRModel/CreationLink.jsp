...
String formAction = "/CreationCommitLinkAction.do?datasource=" + datasource + "&rimid=" + rimid;
...
<html>
  <head>
    ...
    {
      window.document.LinkForm.action = '/activator<%=moduleConfig%>/CreationFormLinkAction.do?datasource=<%= datasource %>&rimid=<%= rimid %>&_location_=' + focusthis;
      window.document.LinkForm.submit();
    }
    function performCommit()
    {
      window.document.LinkForm.action = '/activator<%=moduleConfig%>/CreationCommitLinkAction.do?datasource=<%= datasource %>&rimid=<%= rimid %>';
      window.document.LinkForm.submit();
    }
    function init()
    {
...
<h2 style="width:100%; text-align:center;">
  <bean:message bundle="LinkApplicationResources" key="jsp.creation.title"/>
</h2> 
