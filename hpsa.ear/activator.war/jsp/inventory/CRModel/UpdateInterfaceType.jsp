...
String formAction = "/UpdateCommitInterfaceTypeAction.do?datasource=" + datasource + "&rimid=" + rimid;
...
if ( pk == null || pk.equals("") ) {
  pk =    request.getParameter("interfacetypename") ;
}
...
<html>
  <head>
    ...
    {
      window.document.InterfaceTypeForm.action = '/activator<%=moduleConfig%>/UpdateFormInterfaceTypeAction.do?datasource=<%= datasource %>&rimid=<%= rimid %>&_pk_=<%=pk %>&_location_=' + focusthis;
      window.document.InterfaceTypeForm.submit();
    }
    function performCommit()
    {
      window.document.InterfaceTypeForm.action = '/activator<%=moduleConfig%>/UpdateCommitInterfaceTypeAction.do?datasource=<%= datasource %>&rimid=<%= rimid %>&_pk_=<%=pk %>';
      window.document.InterfaceTypeForm.submit();
    }
    function init()
    {
...
if(beanInterfaceType==null)
   beanInterfaceType = (com.hp.ov.activator.cr.inventory.InterfaceType) request.getSession().getAttribute(InterfaceTypeConstants.INTERFACETYPE_BEAN);
...
<h2 style="width:100%; text-align:center;">
  <bean:message bundle="InterfaceTypeApplicationResources" key="jsp.update.title"/>
</h2> 
...
<input type="hidden" name="_update_commit_" value="true"/> 
    <table:table>
      ...
      <html:hidden property="refreshTreeRimid" value="<%= (String)request.getParameter(\"refreshTreeRimid\") %>"/>
              ...
              <table:cell>
                                                      <html:hidden property="interfacetypename" value="<%= InterfaceTypeName %>"/>
                                                        <html:text disabled="true" property="interfacetypename" size="24" value="<%= InterfaceTypeName %>"/>
                                                </table:cell>
              <table:cell>
