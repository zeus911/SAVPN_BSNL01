...
<html>
  <head>
    <title><bean:message bundle="DL_ElementTypeMappingApplicationResources" key="<%= DL_ElementTypeMappingConstants.JSP_DELETE_TITLE %>"/></title>
    ...
    {
      window.document.DL_ElementTypeMappingForm.action = '/activator<%=moduleConfig%>/DeleteCommitDL_ElementTypeMappingAction.do?datasource=<%= datasource %>&rimid=<%= rimid %>';
      window.document.DL_ElementTypeMappingForm.submit();
    }
    function init()
    {
      var confirm = new HPSAConfirm('Confirm','<bean:message bundle="DL_ElementTypeMappingApplicationResources" key="delete.confirm"/>', '<bean:message bundle="InventoryResources" key="confirm.ok_button.label"/>', '<bean:message bundle="InventoryResources" key="confirm.cancel_button.label"/>');
...
<h2 style="width:100%; text-align:center;">
    <bean:message bundle="DL_ElementTypeMappingApplicationResources" key="jsp.delete.title"/>
</h2> 
...
%>
    ...
    <html:form action="/DeleteCommitDL_ElementTypeMappingAction.do">
