...
String formAction = "/CreationCommitOSVersionAction.do?datasource=" + datasource + "&rimid=" + rimid;
...
<html>
  <head>
    ...
    {
      window.document.OSVersionForm.action = '/activator<%=moduleConfig%>/CreationFormOSVersionAction.do?datasource=<%= datasource %>&rimid=<%= rimid %>&_location_=' + focusthis;
      window.document.OSVersionForm.submit();
    }
    function performCommit()
    {
      window.document.OSVersionForm.action = '/activator<%=moduleConfig%>/CreationCommitOSVersionAction.do?datasource=<%= datasource %>&rimid=<%= rimid %>';
      window.document.OSVersionForm.submit();
    }
    function init()
    {
...
<h2 style="width:100%; text-align:center;">
  <bean:message bundle="OSVersionApplicationResources" key="jsp.creation.title"/>
</h2> 
...
<html:form action="<%= formAction %>" style="text-align:center;">
    <table:table>
      ...
      <html:hidden property="refreshTreeRimid" value="<%= (String)request.getParameter(\"refreshTreeRimid\") %>"/>
              ...
              <table:cell>
                                                                        <html:text  property="osversionname" size="24" value="<%= OSVersionName %>"/>
                                                </table:cell>
              <table:cell>
