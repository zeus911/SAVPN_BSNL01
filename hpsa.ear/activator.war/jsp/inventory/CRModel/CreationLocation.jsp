...
String formAction = "/CreationCommitLocationAction.do?datasource=" + datasource + "&rimid=" + rimid;
...
<html>
  <head>
    ...
    {
      window.document.LocationForm.action = '/activator<%=moduleConfig%>/CreationFormLocationAction.do?datasource=<%= datasource %>&rimid=<%= rimid %>&_location_=' + focusthis;
      window.document.LocationForm.submit();
    }
    function performCommit()
    {
      window.document.LocationForm.action = '/activator<%=moduleConfig%>/CreationCommitLocationAction.do?datasource=<%= datasource %>&rimid=<%= rimid %>';
      window.document.LocationForm.submit();
    }
    function init()
    {
...
<h2 style="width:100%; text-align:center;">
  <bean:message bundle="LocationApplicationResources" key="jsp.creation.title"/>
</h2> 
