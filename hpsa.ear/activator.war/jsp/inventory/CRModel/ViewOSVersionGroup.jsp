...
String refreshTree = (String) request.getAttribute(OSVersionGroupConstants.REFRESH_TREE);
%>

<html>
  <head>
    <title><bean:message bundle="OSVersionGroupApplicationResources" key="<%= OSVersionGroupConstants.JSP_VIEW_TITLE %>"/></title>
...
<h2 style="width:100%; text-align:center;">
  <bean:message bundle="OSVersionGroupApplicationResources" key="jsp.view.title"/>
</h2> 
