...
String refreshTree = (String) request.getAttribute(DL_NetworkConstants.REFRESH_TREE);
%>

<html>
  <head>
    <title><bean:message bundle="DL_NetworkApplicationResources" key="<%= DL_NetworkConstants.JSP_VIEW_TITLE %>"/></title>
...
<h2 style="width:100%; text-align:center;">
  <bean:message bundle="DL_NetworkApplicationResources" key="jsp.view.title"/>
</h2> 
