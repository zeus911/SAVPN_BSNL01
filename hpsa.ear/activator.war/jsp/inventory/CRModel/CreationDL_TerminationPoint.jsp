...
String formAction = "/CreationCommitDL_TerminationPointAction.do?datasource=" + datasource + "&rimid=" + rimid;
...
<html>
  <head>
    ...
    {
      window.document.DL_TerminationPointForm.action = '/activator<%=moduleConfig%>/CreationFormDL_TerminationPointAction.do?datasource=<%= datasource %>&rimid=<%= rimid %>&_location_=' + focusthis;
      window.document.DL_TerminationPointForm.submit();
    }
    function performCommit()
    {
      window.document.DL_TerminationPointForm.action = '/activator<%=moduleConfig%>/CreationCommitDL_TerminationPointAction.do?datasource=<%= datasource %>&rimid=<%= rimid %>';
      window.document.DL_TerminationPointForm.submit();
    }
    function init()
    {
...
<h2 style="width:100%; text-align:center;">
  <bean:message bundle="DL_TerminationPointApplicationResources" key="jsp.creation.title"/>
</h2> 
...
<html:form action="<%= formAction %>" style="text-align:center;">
    <table:table>
      ...
      <html:hidden property="refreshTreeRimid" value="<%= (String)request.getParameter(\"refreshTreeRimid\") %>"/>
              ...
              <table:cell>
                                                                        <html:text  property="ec_nnmi_id" size="24" value="<%= EC_NNMi_Id %>"/>
                                                </table:cell>
              <table:cell>
