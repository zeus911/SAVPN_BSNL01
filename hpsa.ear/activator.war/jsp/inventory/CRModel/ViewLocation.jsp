...
String refreshTree = (String) request.getAttribute(LocationConstants.REFRESH_TREE);
%>

<html>
  <head>
    <title><bean:message bundle="LocationApplicationResources" key="<%= LocationConstants.JSP_VIEW_TITLE %>"/></title>
...
<h2 style="width:100%; text-align:center;">
  <bean:message bundle="LocationApplicationResources" key="jsp.view.title"/>
</h2> 
