...
String formAction = "/UpdateCommitDL_ConfigurationAction.do?datasource=" + datasource + "&rimid=" + rimid;
...
<html>
  <head>
    ...
    {
      window.document.DL_ConfigurationForm.action = '/activator<%=moduleConfig%>/UpdateFormDL_ConfigurationAction.do?datasource=<%= datasource %>&rimid=<%= rimid %>&_pk_=<%=pk %>&_location_=' + focusthis;
      window.document.DL_ConfigurationForm.submit();
    }
    function performCommit()
    {
      window.document.DL_ConfigurationForm.action = '/activator<%=moduleConfig%>/UpdateCommitDL_ConfigurationAction.do?datasource=<%= datasource %>&rimid=<%= rimid %>&_pk_=<%=pk %>';
      window.document.DL_ConfigurationForm.submit();
    }
    function init()
    {
...
<h2 style="width:100%; text-align:center;">
  <bean:message bundle="DL_ConfigurationApplicationResources" key="jsp.update.title"/>
</h2> 
