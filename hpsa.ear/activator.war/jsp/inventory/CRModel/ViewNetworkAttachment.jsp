...
String refreshTree = (String) request.getAttribute(NetworkAttachmentConstants.REFRESH_TREE);
%>

<html>
  <head>
    <title><bean:message bundle="NetworkAttachmentApplicationResources" key="<%= NetworkAttachmentConstants.JSP_VIEW_TITLE %>"/></title>
...
<h2 style="width:100%; text-align:center;">
  <bean:message bundle="NetworkAttachmentApplicationResources" key="jsp.view.title"/>
</h2> 
