...
String refreshTree = (String) request.getAttribute(DL_NetworkAttachmentConstants.REFRESH_TREE);
%>

<html>
  <head>
    <title><bean:message bundle="DL_NetworkAttachmentApplicationResources" key="<%= DL_NetworkAttachmentConstants.JSP_VIEW_TITLE %>"/></title>
...
<h2 style="width:100%; text-align:center;">
  <bean:message bundle="DL_NetworkAttachmentApplicationResources" key="jsp.view.title"/>
</h2> 
