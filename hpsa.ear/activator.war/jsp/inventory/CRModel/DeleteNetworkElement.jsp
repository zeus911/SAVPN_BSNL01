...
<html>
  <head>
    <title><bean:message bundle="NetworkElementApplicationResources" key="<%= NetworkElementConstants.JSP_DELETE_TITLE %>"/></title>
    ...
    {
      window.document.NetworkElementForm.action = '/activator<%=moduleConfig%>/DeleteCommitNetworkElementAction.do?datasource=<%= datasource %>&rimid=<%= rimid %>';
      window.document.NetworkElementForm.submit();
    }
    function init()
    {
      var confirm = new HPSAConfirm('Confirm','<bean:message bundle="NetworkElementApplicationResources" key="delete.confirm"/>', '<bean:message bundle="InventoryResources" key="confirm.ok_button.label"/>', '<bean:message bundle="InventoryResources" key="confirm.cancel_button.label"/>');
...
<%
com.hp.ov.activator.cr.inventory.NetworkElement beanNetworkElement = (com.hp.ov.activator.cr.inventory.NetworkElement) request.getAttribute(NetworkElementConstants.NETWORKELEMENT_BEAN);
...
nfB.setMaximumFractionDigits(6);
      ...
      String NetworkId_key = beanNetworkElement.getNetworkid();
      ...
      String Location_key = beanNetworkElement.getLocation();
      ...
      String PWPolicy_key = beanNetworkElement.getPwpolicy();
      ...
      String Vendor_key = beanNetworkElement.getVendor();
      ...
      String OSVersion_key = beanNetworkElement.getOsversion();
      ...
      String ElementType_key = beanNetworkElement.getElementtype();
...
<h2 style="width:100%; text-align:center;">
    <bean:message bundle="NetworkElementApplicationResources" key="jsp.delete.title"/>
</h2> 
...
%>
    ...
    <html:form action="/DeleteCommitNetworkElementAction.do">
