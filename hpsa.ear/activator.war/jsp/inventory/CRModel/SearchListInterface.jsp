...
ArrayList al = (ArrayList) session.getAttribute(request.getParameter(InterfaceConstants.TAB_NAME));
String useRandomColor="1";
String mainColor ="1";

String datasource = request.getParameter(InterfaceConstants.DATASOURCE);
String tabName = request.getParameter(InterfaceConstants.TAB_NAME);
...
StringBuffer requestURI = new StringBuffer("/activator/jsp/inventory/SearchListInterface.jsp?");
...
<html>
  <head>
    <title><bean:message bundle="InterfaceApplicationResources" key="<%= InterfaceConstants.JSP_RESULTS_TITLE %>"/></title>
  ...
  <bean:message bundle="InterfaceApplicationResources" key="jsp.search.results.title"/>
</h2> 

<display:table id="elementSearch" style="width:100%" requestURI="SearchCommitInterfaceAction.do" name="<%= searchListName %>" pagesize="10" export="true" sort="list" partialList="true" size="resultSize" decorator="com.hp.ov.activator.mwfm.servlet.inventory.inventorytree.taglib.displaytag.decorator.InventoryBuilderTableDecorator">

<%
        if ( TerminationPointId___hide == null || TerminationPointId___hide.equals("null") ) {
%>
      <display:column property="terminationpointid" sortable="true" titleKey="InterfaceApplicationResources:field.terminationpointid.alias" headerClass="tableTitle" class="tableCell"/>
<%
        }
        if ( Name___hide == null || Name___hide.equals("null") ) {
%>
      <display:column property="name" sortable="true" titleKey="InterfaceApplicationResources:field.name.alias" headerClass="tableTitle" class="tableCell"/>
<%
        }
        if ( NE_Id___hide == null || NE_Id___hide.equals("null") ) {
%>
      <display:column property="ne_id" sortable="true" titleKey="InterfaceApplicationResources:field.ne_id.alias" headerClass="tableTitle" class="tableCell"/>
<%
        }
        if ( EC_Id___hide == null || EC_Id___hide.equals("null") ) {
%>
      <display:column property="ec_id" sortable="true" titleKey="InterfaceApplicationResources:field.ec_id.alias" headerClass="tableTitle" class="tableCell"/>
<%
        }
        if ( State___hide == null || State___hide.equals("null") ) {
%>
      <display:column property="state" sortable="true" titleKey="InterfaceApplicationResources:field.state.alias" headerClass="tableTitle" class="tableCell"/>
<%
        }
        if ( Type___hide == null || Type___hide.equals("null") ) {
%>
      <display:column property="type" sortable="true" titleKey="InterfaceApplicationResources:field.type.alias" headerClass="tableTitle" class="tableCell"/>
<%
        }
        if ( ParentIf___hide == null || ParentIf___hide.equals("null") ) {
%>
      <display:column property="parentif" sortable="true" titleKey="InterfaceApplicationResources:field.parentif.alias" headerClass="tableTitle" class="tableCell"/>
<%
        }
        if ( IPAddr___hide == null || IPAddr___hide.equals("null") ) {
%>
      <display:column property="ipaddr" sortable="true" titleKey="InterfaceApplicationResources:field.ipaddr.alias" headerClass="tableTitle" class="tableCell"/>
<%
        }
        if ( Subtype___hide == null || Subtype___hide.equals("null") ) {
%>
      <display:column property="subtype" sortable="true" titleKey="InterfaceApplicationResources:field.subtype.alias" headerClass="tableTitle" class="tableCell"/>
<%
        }
        if ( Encapsulation___hide == null || Encapsulation___hide.equals("null") ) {
%>
      <display:column property="encapsulation" sortable="true" titleKey="InterfaceApplicationResources:field.encapsulation.alias" headerClass="tableTitle" class="tableCell"/>
<%
        }
        if ( Description___hide == null || Description___hide.equals("null") ) {
%>
      <display:column property="description" sortable="true" titleKey="InterfaceApplicationResources:field.description.alias" headerClass="tableTitle" class="tableCell"/>
<%
        }
        if ( IFIndex___hide == null || IFIndex___hide.equals("null") ) {
%>
      <display:column property="ifindex" sortable="true" titleKey="InterfaceApplicationResources:field.ifindex.alias" headerClass="tableTitle" class="tableCell"/>
<%
        }
        if ( ActivationState___hide == null || ActivationState___hide.equals("null") ) {
%>
      <display:column property="activationstate" sortable="true" titleKey="InterfaceApplicationResources:field.activationstate.alias" headerClass="tableTitle" class="tableCell"/>
<%
        }
        if ( UsageState___hide == null || UsageState___hide.equals("null") ) {
%>
      <display:column property="usagestate" sortable="true" titleKey="InterfaceApplicationResources:field.usagestate.alias" headerClass="tableTitle" class="tableCell"/>
<%
        }
        if ( VLANId___hide == null || VLANId___hide.equals("null") ) {
%>
      <display:column property="vlanid" sortable="true" titleKey="InterfaceApplicationResources:field.vlanid.alias" headerClass="tableTitle" class="tableCell"/>
<%
        }
        if ( VLANMode___hide == null || VLANMode___hide.equals("null") ) {
%>
      <display:column property="vlanmode" sortable="true" titleKey="InterfaceApplicationResources:field.vlanmode.alias" headerClass="tableTitle" class="tableCell"/>
<%
        }
        if ( DLCI___hide == null || DLCI___hide.equals("null") ) {
%>
      <display:column property="dlci" sortable="true" titleKey="InterfaceApplicationResources:field.dlci.alias" headerClass="tableTitle" class="tableCell"/>
<%
        }
        if ( Timeslots___hide == null || Timeslots___hide.equals("null") ) {
%>
      <display:column property="timeslots" sortable="true" titleKey="InterfaceApplicationResources:field.timeslots.alias" headerClass="tableTitle" class="tableCell"/>
<%
        }
        if ( NumberOfSlots___hide == null || NumberOfSlots___hide.equals("null") ) {
%>
      <display:column property="numberofslots" sortable="true" titleKey="InterfaceApplicationResources:field.numberofslots.alias" headerClass="tableTitle" class="tableCell"/>
<%
        }
        if ( Bandwidth___hide == null || Bandwidth___hide.equals("null") ) {
%>
      <display:column property="bandwidth" sortable="true" titleKey="InterfaceApplicationResources:field.bandwidth.alias" headerClass="tableTitle" class="tableCell"/>
<%
        }
        if ( LMIType___hide == null || LMIType___hide.equals("null") ) {
%>
      <display:column property="lmitype" sortable="true" titleKey="InterfaceApplicationResources:field.lmitype.alias" headerClass="tableTitle" class="tableCell"/>
<%
        }
        if ( IntfType___hide == null || IntfType___hide.equals("null") ) {
%>
      <display:column property="intftype" sortable="true" titleKey="InterfaceApplicationResources:field.intftype.alias" headerClass="tableTitle" class="tableCell"/>
<%
        }
        if ( BundleKey___hide == null || BundleKey___hide.equals("null") ) {
%>
      <display:column property="bundlekey" sortable="true" titleKey="InterfaceApplicationResources:field.bundlekey.alias" headerClass="tableTitle" class="tableCell"/>
<%
        }
        if ( BundleId___hide == null || BundleId___hide.equals("null") ) {
%>
      <display:column property="bundleid" sortable="true" titleKey="InterfaceApplicationResources:field.bundleid.alias" headerClass="tableTitle" class="tableCell"/>
<%
        }
        if ( NNMi_UUId___hide == null || NNMi_UUId___hide.equals("null") ) {
%>
      <display:column property="nnmi_uuid" sortable="true" titleKey="InterfaceApplicationResources:field.nnmi_uuid.alias" headerClass="tableTitle" class="tableCell"/>
<%
        }
        if ( NNMi_Id___hide == null || NNMi_Id___hide.equals("null") ) {
%>
      <display:column property="nnmi_id" sortable="true" titleKey="InterfaceApplicationResources:field.nnmi_id.alias" headerClass="tableTitle" class="tableCell"/>
<%
        }
        if ( NNMi_LastUpdate___hide == null || NNMi_LastUpdate___hide.equals("null") ) {
%>
      <display:column property="nnmi_lastupdate" sortable="true" titleKey="InterfaceApplicationResources:field.nnmi_lastupdate.alias" headerClass="tableTitle" class="tableCell"/>
<%
    }
%>
</display:table>
...
String backAction = "SearchFormInterfaceAction.do?datasource=" + datasource + "&tab_name=" + tabName + "&vi=" + viParameter + "&view=" + viewParameter + "&ndid=" + ndidParameter;
%>
...
%>
    <input type="submit" value="<%= backMessage %>" onclick="window.document.InterfaceForm.submit()"/>
  </html:form>
