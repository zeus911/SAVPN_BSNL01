...
String refreshTree = (String) request.getAttribute(DL_ExecutionStateConstants.REFRESH_TREE);
%>

<html>
  <head>
    <title><bean:message bundle="DL_ExecutionStateApplicationResources" key="<%= DL_ExecutionStateConstants.JSP_VIEW_TITLE %>"/></title>
...
<h2 style="width:100%; text-align:center;">
  <bean:message bundle="DL_ExecutionStateApplicationResources" key="jsp.view.title"/>
</h2> 
