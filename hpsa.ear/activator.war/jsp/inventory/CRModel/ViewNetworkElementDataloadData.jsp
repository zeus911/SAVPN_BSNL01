...
String refreshTree = (String) request.getAttribute(NetworkElementDataloadDataConstants.REFRESH_TREE);
%>

<html>
  <head>
    <title><bean:message bundle="NetworkElementDataloadDataApplicationResources" key="<%= NetworkElementDataloadDataConstants.JSP_VIEW_TITLE %>"/></title>
...
<h2 style="width:100%; text-align:center;">
  <bean:message bundle="NetworkElementDataloadDataApplicationResources" key="jsp.view.title"/>
</h2> 
