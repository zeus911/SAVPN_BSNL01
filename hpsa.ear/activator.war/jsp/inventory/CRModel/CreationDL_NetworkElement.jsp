...
String formAction = "/CreationCommitDL_NetworkElementAction.do?datasource=" + datasource + "&rimid=" + rimid;
...
<html>
  <head>
    ...
    {
      window.document.DL_NetworkElementForm.action = '/activator<%=moduleConfig%>/CreationFormDL_NetworkElementAction.do?datasource=<%= datasource %>&rimid=<%= rimid %>&_location_=' + focusthis;
      window.document.DL_NetworkElementForm.submit();
    }
    function performCommit()
    {
      window.document.DL_NetworkElementForm.action = '/activator<%=moduleConfig%>/CreationCommitDL_NetworkElementAction.do?datasource=<%= datasource %>&rimid=<%= rimid %>';
      window.document.DL_NetworkElementForm.submit();
    }
    function init()
    {
...
<h2 style="width:100%; text-align:center;">
  <bean:message bundle="DL_NetworkElementApplicationResources" key="jsp.creation.title"/>
</h2> 
