...
String refreshTree = (String) request.getAttribute(ElementCompTypeConstants.REFRESH_TREE);
%>

<html>
  <head>
    <title><bean:message bundle="ElementCompTypeApplicationResources" key="<%= ElementCompTypeConstants.JSP_VIEW_TITLE %>"/></title>
...
<h2 style="width:100%; text-align:center;">
  <bean:message bundle="ElementCompTypeApplicationResources" key="jsp.view.title"/>
</h2> 
