...
<html>
  <head>
    <title><bean:message bundle="ElementComponentApplicationResources" key="<%= ElementComponentConstants.JSP_DELETE_TITLE %>"/></title>
    ...
    {
      window.document.ElementComponentForm.action = '/activator<%=moduleConfig%>/DeleteCommitElementComponentAction.do?datasource=<%= datasource %>&rimid=<%= rimid %>';
      window.document.ElementComponentForm.submit();
    }
    function init()
    {
      var confirm = new HPSAConfirm('Confirm','<bean:message bundle="ElementComponentApplicationResources" key="delete.confirm"/>', '<bean:message bundle="InventoryResources" key="confirm.ok_button.label"/>', '<bean:message bundle="InventoryResources" key="confirm.cancel_button.label"/>');
...
nfB.setMaximumFractionDigits(6);
      ...
      String NE_Id_key = beanElementComponent.getNe_id();
      ...
      String ParentEC_Id_key = beanElementComponent.getParentec_id();
      ParentEC_Id_key = StringFacility.replaceAllByHTMLCharacter(ParentEC_Id_key);
      ...
      String Type_key = beanElementComponent.getType();
...
<h2 style="width:100%; text-align:center;">
    <bean:message bundle="ElementComponentApplicationResources" key="jsp.delete.title"/>
</h2> 
...
%>
    ...
    <html:form action="/DeleteCommitElementComponentAction.do">
    <html:hidden property="refreshTreeRimid" value="<%= (String)request.getParameter(\"refreshTreeRimid\") %>"/>
                  <html:hidden property="elementcomponentid" value="<%= String.valueOf(ElementComponentId) %>"/>
              </html:form>
  </body>
</html>
