...
String formAction = "/CreationCommitNetworkElementAction.do?datasource=" + datasource + "&rimid=" + rimid;
...
<html>
  <head>
    ...
    {
      window.document.NetworkElementForm.action = '/activator<%=moduleConfig%>/CreationFormNetworkElementAction.do?datasource=<%= datasource %>&rimid=<%= rimid %>&_location_=' + focusthis;
      window.document.NetworkElementForm.submit();
    }
    function performCommit()
    {
      window.document.NetworkElementForm.action = '/activator<%=moduleConfig%>/CreationCommitNetworkElementAction.do?datasource=<%= datasource %>&rimid=<%= rimid %>';
      window.document.NetworkElementForm.submit();
    }
    function init()
    {
...
<h2 style="width:100%; text-align:center;">
  <bean:message bundle="NetworkElementApplicationResources" key="jsp.creation.title"/>
</h2> 
