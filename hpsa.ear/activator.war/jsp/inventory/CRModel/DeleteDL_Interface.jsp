...
<html>
  <head>
    <title><bean:message bundle="DL_InterfaceApplicationResources" key="<%= DL_InterfaceConstants.JSP_DELETE_TITLE %>"/></title>
    ...
    {
      window.document.DL_InterfaceForm.action = '/activator<%=moduleConfig%>/DeleteCommitDL_InterfaceAction.do?datasource=<%= datasource %>&rimid=<%= rimid %>';
      window.document.DL_InterfaceForm.submit();
    }
    function init()
    {
      var confirm = new HPSAConfirm('Confirm','<bean:message bundle="DL_InterfaceApplicationResources" key="delete.confirm"/>', '<bean:message bundle="InventoryResources" key="confirm.ok_button.label"/>', '<bean:message bundle="InventoryResources" key="confirm.cancel_button.label"/>');
...
<h2 style="width:100%; text-align:center;">
    <bean:message bundle="DL_InterfaceApplicationResources" key="jsp.delete.title"/>
</h2> 
...
%>
    ...
    <html:form action="/DeleteCommitDL_InterfaceAction.do">
