...
String formAction = "/CreationCommitDL_EnrichmentAction.do?datasource=" + datasource + "&rimid=" + rimid;
...
<html>
  <head>
    ...
    {
      window.document.DL_EnrichmentForm.action = '/activator<%=moduleConfig%>/CreationFormDL_EnrichmentAction.do?datasource=<%= datasource %>&rimid=<%= rimid %>&_location_=' + focusthis;
      window.document.DL_EnrichmentForm.submit();
    }
    function performCommit()
    {
      window.document.DL_EnrichmentForm.action = '/activator<%=moduleConfig%>/CreationCommitDL_EnrichmentAction.do?datasource=<%= datasource %>&rimid=<%= rimid %>';
      window.document.DL_EnrichmentForm.submit();
    }
    function init()
    {
...
<h2 style="width:100%; text-align:center;">
  <bean:message bundle="DL_EnrichmentApplicationResources" key="jsp.creation.title"/>
</h2> 
