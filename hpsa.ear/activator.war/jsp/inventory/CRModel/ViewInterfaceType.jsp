...
String refreshTree = (String) request.getAttribute(InterfaceTypeConstants.REFRESH_TREE);
%>

<html>
  <head>
    <title><bean:message bundle="InterfaceTypeApplicationResources" key="<%= InterfaceTypeConstants.JSP_VIEW_TITLE %>"/></title>
...
<h2 style="width:100%; text-align:center;">
  <bean:message bundle="InterfaceTypeApplicationResources" key="jsp.view.title"/>
</h2> 
