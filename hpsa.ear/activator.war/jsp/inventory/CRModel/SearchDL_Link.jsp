...
String tabName = (String) request.getParameter(DL_LinkConstants.TAB_NAME);
...
<script>
function clearForm() {
var formObj = document.DL_LinkFormSearch;
...
if (element.type == 'select-one') { element.selectedIndex = -1; }
  ...
  var checkfalse=false;
                    if(document.getElementsByName("nnmi_id___hide")[0].checked) {
                            ...
                            if(document.getElementsByName("ne1_nnmi_id___hide")[0].checked) {
                            if(document.getElementsByName("tp1_nnmi_id___hide")[0].checked) {
                            if(document.getElementsByName("ne2_nnmi_id___hide")[0].checked) {
                            if(document.getElementsByName("tp2_nnmi_id___hide")[0].checked) {
            ...
            if(checkfalse){
    alert("<bean:message bundle="DL_LinkApplicationResources" key="<%= DL_LinkConstants.JSP_SEARCH_NO_SHOW %>"/>");
  }else{
    window.document.DL_LinkFormSearch.action = '/activator<%=moduleConfig%>/SearchCommitDL_LinkAction.do?datasource=<%= datasource %>&tab_name=<%= tabName %>&vi=<%= viParameter%>&view=<%= viewParameter %>&ndid=<%= ndidParameter %>';
    window.document.DL_LinkFormSearch.submit();
  }
  }
</script>
...
if (session == null || session.getValue(DL_LinkConstants.USER) == null) {
  response.sendRedirect(DL_LinkConstants.NULL_SESSION);
  return;
}
...
<%
      String NNMi_Id = form.getNnmi_id();
            ...
            String NE1_NNMi_Id = form.getNe1_nnmi_id();
            String TP1_NNMi_Id = form.getTp1_nnmi_id();
            String NE2_NNMi_Id = form.getNe2_nnmi_id();
            String TP2_NNMi_Id = form.getTp2_nnmi_id();
...
<h2 style="width:100%; text-align:center;">
  <bean:message bundle="DL_LinkApplicationResources" key="jsp.search.title"/>
</h2> 
...
<% String searchFormAction = "/SearchCommitDL_LinkAction.do?datasource="+datasource+"&tab_name="+tabName+"&vi="+ viParameter+"&view="+ viewParameter +"&ndid="+ ndidParameter ;%>
      ...
      <table:header>
        ...
        <table:cell>
          <bean:message bundle="InventoryResources" key="description.heading"/>
            ...
            <table:cell>
              <center>
                <html:checkbox property="ne1_nnmi_id___hide" value="true"/>
              </center>
            </table:cell>
            ...
            <table:cell>
                              <html:text property="ne1_nnmi_id" size="16" value="<%= NE1_NNMi_Id %>"/>
                                          </table:cell>
            ...
            <table:cell>
              <center>
                <html:checkbox property="tp1_nnmi_id___hide" value="true"/>
              </center>
            </table:cell>
            ...
            <table:cell>
                              <html:text property="tp1_nnmi_id" size="16" value="<%= TP1_NNMi_Id %>"/>
                                          </table:cell>
            ...
            <table:cell>
              <center>
                <html:checkbox property="ne2_nnmi_id___hide" value="true"/>
              </center>
            </table:cell>
            ...
            <table:cell>
                              <html:text property="ne2_nnmi_id" size="16" value="<%= NE2_NNMi_Id %>"/>
                                          </table:cell>
            ...
            <table:cell>
              <center>
                <html:checkbox property="tp2_nnmi_id___hide" value="true"/>
              </center>
            </table:cell>
            ...
            <table:cell>
                              <html:text property="tp2_nnmi_id" size="16" value="<%= TP2_NNMi_Id %>"/>
                                          </table:cell>
