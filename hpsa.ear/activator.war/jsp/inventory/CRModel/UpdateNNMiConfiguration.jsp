...
String formAction = "/UpdateCommitNNMiConfigurationAction.do?datasource=" + datasource + "&rimid=" + rimid;
...
<html>
  <head>
    ...
    {
      window.document.NNMiConfigurationForm.action = '/activator<%=moduleConfig%>/UpdateFormNNMiConfigurationAction.do?datasource=<%= datasource %>&rimid=<%= rimid %>&_pk_=<%=pk %>&_location_=' + focusthis;
      window.document.NNMiConfigurationForm.submit();
    }
    function performCommit()
    {
      window.document.NNMiConfigurationForm.action = '/activator<%=moduleConfig%>/UpdateCommitNNMiConfigurationAction.do?datasource=<%= datasource %>&rimid=<%= rimid %>&_pk_=<%=pk %>';
      window.document.NNMiConfigurationForm.submit();
    }
    function init()
    {
...
if(beanNNMiConfiguration==null)
   beanNNMiConfiguration = (com.hp.ov.activator.nnm.common.NNMiConfiguration) request.getSession().getAttribute(NNMiConfigurationConstants.NNMICONFIGURATION_BEAN);
...
nfB.setMaximumFractionDigits(6);
              ...
              String Id = beanNNMiConfiguration.getId();
        
            
                            
            
                
                String Protocol = beanNNMiConfiguration.getProtocol();
        
            
                            
            
                
                String Hostname = beanNNMiConfiguration.getHostname();
        
            
                            
            
                
                String Port = beanNNMiConfiguration.getPort();
...
<h2 style="width:100%; text-align:center;">
  <bean:message bundle="NNMiConfigurationApplicationResources" key="jsp.update.title"/>
</h2> 
...
<input type="hidden" name="_update_commit_" value="true"/> 
    <table:table>
      ...
      <html:hidden property="refreshTreeRimid" value="<%= (String)request.getParameter(\"refreshTreeRimid\") %>"/>
              ...
              <table:cell>
                                                                        <html:text  property="hostname" size="24" value="<%= Hostname %>"/>
                                                </table:cell>
              <table:cell>
              ...
              <table:cell>
                                                                        <html:text  property="port" size="24" value="<%= Port %>"/>
                                                </table:cell>
              <table:cell>
              ...
              <table:cell>
                                  <html:checkbox  property="rediscover_enable" value="true"/>
                  <html:hidden  property="rediscover_enable" value="false"/>
                              </table:cell>
              <table:cell>
              ...
              <table:cell>
                                  <html:checkbox  property="customattributes_enable" value="true"/>
                  <html:hidden  property="customattributes_enable" value="false"/>
                              </table:cell>
              <table:cell>
              ...
              <table:cell>
                                  <html:checkbox  property="interfacegroup_enable" value="true"/>
                  <html:hidden  property="interfacegroup_enable" value="false"/>
                              </table:cell>
              <table:cell>
