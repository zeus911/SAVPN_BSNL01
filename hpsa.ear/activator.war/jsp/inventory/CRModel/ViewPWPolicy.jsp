...
String refreshTree = (String) request.getAttribute(PWPolicyConstants.REFRESH_TREE);
%>

<html>
  <head>
    <title><bean:message bundle="PWPolicyApplicationResources" key="<%= PWPolicyConstants.JSP_VIEW_TITLE %>"/></title>
...
<h2 style="width:100%; text-align:center;">
  <bean:message bundle="PWPolicyApplicationResources" key="jsp.view.title"/>
</h2> 
