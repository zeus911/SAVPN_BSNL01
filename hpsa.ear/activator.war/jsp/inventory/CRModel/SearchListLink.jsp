...
ArrayList al = (ArrayList) session.getAttribute(request.getParameter(LinkConstants.TAB_NAME));
String useRandomColor="1";
String mainColor ="1";

String datasource = request.getParameter(LinkConstants.DATASOURCE);
String tabName = request.getParameter(LinkConstants.TAB_NAME);
...
StringBuffer requestURI = new StringBuffer("/activator/jsp/inventory/SearchListLink.jsp?");
...
<html>
  <head>
    <title><bean:message bundle="LinkApplicationResources" key="<%= LinkConstants.JSP_RESULTS_TITLE %>"/></title>
  ...
  <bean:message bundle="LinkApplicationResources" key="jsp.search.results.title"/>
</h2> 

<display:table id="elementSearch" style="width:100%" requestURI="SearchCommitLinkAction.do" name="<%= searchListName %>" pagesize="10" export="true" sort="list" partialList="true" size="resultSize" decorator="com.hp.ov.activator.mwfm.servlet.inventory.inventorytree.taglib.displaytag.decorator.InventoryBuilderTableDecorator">

<%
        if ( LinkId___hide == null || LinkId___hide.equals("null") ) {
%>
      <display:column property="linkid" sortable="true" titleKey="LinkApplicationResources:field.linkid.alias" headerClass="tableTitle" class="tableCell"/>
<%
        }
        if ( Name___hide == null || Name___hide.equals("null") ) {
%>
      <display:column property="name" sortable="true" titleKey="LinkApplicationResources:field.name.alias" headerClass="tableTitle" class="tableCell"/>
<%
        }
        if ( NE1___hide == null || NE1___hide.equals("null") ) {
%>
      <display:column property="ne1" sortable="true" titleKey="LinkApplicationResources:field.ne1.alias" headerClass="tableTitle" class="tableCell"/>
<%
        }
        if ( TP1___hide == null || TP1___hide.equals("null") ) {
%>
      <display:column property="tp1" sortable="true" titleKey="LinkApplicationResources:field.tp1.alias" headerClass="tableTitle" class="tableCell"/>
<%
        }
        if ( Type___hide == null || Type___hide.equals("null") ) {
%>
      <display:column property="type" sortable="true" titleKey="LinkApplicationResources:field.type.alias" headerClass="tableTitle" class="tableCell"/>
<%
        }
        if ( NE2___hide == null || NE2___hide.equals("null") ) {
%>
      <display:column property="ne2" sortable="true" titleKey="LinkApplicationResources:field.ne2.alias" headerClass="tableTitle" class="tableCell"/>
<%
        }
        if ( TP2___hide == null || TP2___hide.equals("null") ) {
%>
      <display:column property="tp2" sortable="true" titleKey="LinkApplicationResources:field.tp2.alias" headerClass="tableTitle" class="tableCell"/>
<%
        }
        if ( NNMi_UUId___hide == null || NNMi_UUId___hide.equals("null") ) {
%>
      <display:column property="nnmi_uuid" sortable="true" titleKey="LinkApplicationResources:field.nnmi_uuid.alias" headerClass="tableTitle" class="tableCell"/>
<%
        }
        if ( NNMi_Id___hide == null || NNMi_Id___hide.equals("null") ) {
%>
      <display:column property="nnmi_id" sortable="true" titleKey="LinkApplicationResources:field.nnmi_id.alias" headerClass="tableTitle" class="tableCell"/>
<%
        }
        if ( NNMi_LastUpdateData___hide == null || NNMi_LastUpdateData___hide.equals("null") ) {
%>
      <display:column property="nnmi_lastupdatedata" sortable="true" titleKey="LinkApplicationResources:field.nnmi_lastupdatedata.alias" headerClass="tableTitle" class="tableCell"/>
<%
    }
%>
</display:table>
...
String backAction = "SearchFormLinkAction.do?datasource=" + datasource + "&tab_name=" + tabName + "&vi=" + viParameter + "&view=" + viewParameter + "&ndid=" + ndidParameter;
%>
...
%>
    <input type="submit" value="<%= backMessage %>" onclick="window.document.LinkForm.submit()"/>
  </html:form>
