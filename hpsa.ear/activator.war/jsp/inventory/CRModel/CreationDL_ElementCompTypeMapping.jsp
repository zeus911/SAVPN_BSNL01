...
String formAction = "/CreationCommitDL_ElementCompTypeMappingAction.do?datasource=" + datasource + "&rimid=" + rimid;
...
<html>
  <head>
    ...
    {
      window.document.DL_ElementCompTypeMappingForm.action = '/activator<%=moduleConfig%>/CreationFormDL_ElementCompTypeMappingAction.do?datasource=<%= datasource %>&rimid=<%= rimid %>&_location_=' + focusthis;
      window.document.DL_ElementCompTypeMappingForm.submit();
    }
    function performCommit()
    {
      window.document.DL_ElementCompTypeMappingForm.action = '/activator<%=moduleConfig%>/CreationCommitDL_ElementCompTypeMappingAction.do?datasource=<%= datasource %>&rimid=<%= rimid %>';
      window.document.DL_ElementCompTypeMappingForm.submit();
    }
    function init()
    {
...
<h2 style="width:100%; text-align:center;">
  <bean:message bundle="DL_ElementCompTypeMappingApplicationResources" key="jsp.creation.title"/>
</h2> 
