...
String refreshTree = (String) request.getAttribute(RouterTemplateConstants.REFRESH_TREE);
%>

<html>
  <head>
    <title><bean:message bundle="RouterTemplateApplicationResources" key="<%= RouterTemplateConstants.JSP_VIEW_TITLE %>"/></title>
...
<h2 style="width:100%; text-align:center;">
  <bean:message bundle="RouterTemplateApplicationResources" key="jsp.view.title"/>
</h2> 
