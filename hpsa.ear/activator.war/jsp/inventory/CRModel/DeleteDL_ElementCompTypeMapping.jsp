...
<html>
  <head>
    <title><bean:message bundle="DL_ElementCompTypeMappingApplicationResources" key="<%= DL_ElementCompTypeMappingConstants.JSP_DELETE_TITLE %>"/></title>
    ...
    {
      window.document.DL_ElementCompTypeMappingForm.action = '/activator<%=moduleConfig%>/DeleteCommitDL_ElementCompTypeMappingAction.do?datasource=<%= datasource %>&rimid=<%= rimid %>';
      window.document.DL_ElementCompTypeMappingForm.submit();
    }
    function init()
    {
      var confirm = new HPSAConfirm('Confirm','<bean:message bundle="DL_ElementCompTypeMappingApplicationResources" key="delete.confirm"/>', '<bean:message bundle="InventoryResources" key="confirm.ok_button.label"/>', '<bean:message bundle="InventoryResources" key="confirm.cancel_button.label"/>');
...
nfB.setMaximumFractionDigits(6);
      ...
      String ElementTypeGroupName_key = beanDL_ElementCompTypeMapping.getElementtypegroupname();
...
<h2 style="width:100%; text-align:center;">
    <bean:message bundle="DL_ElementCompTypeMappingApplicationResources" key="jsp.delete.title"/>
</h2> 
...
%>
    ...
    <html:form action="/DeleteCommitDL_ElementCompTypeMappingAction.do">
