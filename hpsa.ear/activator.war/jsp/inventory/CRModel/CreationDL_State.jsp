...
String formAction = "/CreationCommitDL_StateAction.do?datasource=" + datasource + "&rimid=" + rimid;
...
<html>
  <head>
    ...
    {
      window.document.DL_StateForm.action = '/activator<%=moduleConfig%>/CreationFormDL_StateAction.do?datasource=<%= datasource %>&rimid=<%= rimid %>&_location_=' + focusthis;
      window.document.DL_StateForm.submit();
    }
    function performCommit()
    {
      window.document.DL_StateForm.action = '/activator<%=moduleConfig%>/CreationCommitDL_StateAction.do?datasource=<%= datasource %>&rimid=<%= rimid %>';
      window.document.DL_StateForm.submit();
    }
    function init()
    {
...
<h2 style="width:100%; text-align:center;">
  <bean:message bundle="DL_StateApplicationResources" key="jsp.creation.title"/>
</h2> 
