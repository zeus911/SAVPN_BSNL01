...
String formAction = "/CreationCommitDL_InterfaceTypeMappingAction.do?datasource=" + datasource + "&rimid=" + rimid;
...
<html>
  <head>
    ...
    {
      window.document.DL_InterfaceTypeMappingForm.action = '/activator<%=moduleConfig%>/CreationFormDL_InterfaceTypeMappingAction.do?datasource=<%= datasource %>&rimid=<%= rimid %>&_location_=' + focusthis;
      window.document.DL_InterfaceTypeMappingForm.submit();
    }
    function performCommit()
    {
      window.document.DL_InterfaceTypeMappingForm.action = '/activator<%=moduleConfig%>/CreationCommitDL_InterfaceTypeMappingAction.do?datasource=<%= datasource %>&rimid=<%= rimid %>';
      window.document.DL_InterfaceTypeMappingForm.submit();
    }
    function init()
    {
...
<h2 style="width:100%; text-align:center;">
  <bean:message bundle="DL_InterfaceTypeMappingApplicationResources" key="jsp.creation.title"/>
</h2> 
