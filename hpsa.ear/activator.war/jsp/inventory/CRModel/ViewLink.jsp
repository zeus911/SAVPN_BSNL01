...
String refreshTree = (String) request.getAttribute(LinkConstants.REFRESH_TREE);
%>

<html>
  <head>
    <title><bean:message bundle="LinkApplicationResources" key="<%= LinkConstants.JSP_VIEW_TITLE %>"/></title>
...
<h2 style="width:100%; text-align:center;">
  <bean:message bundle="LinkApplicationResources" key="jsp.view.title"/>
</h2> 
