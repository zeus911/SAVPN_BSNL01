...
String refreshTree = (String) request.getAttribute(ElementTypeGroupConstants.REFRESH_TREE);
%>

<html>
  <head>
    <title><bean:message bundle="ElementTypeGroupApplicationResources" key="<%= ElementTypeGroupConstants.JSP_VIEW_TITLE %>"/></title>
...
<h2 style="width:100%; text-align:center;">
  <bean:message bundle="ElementTypeGroupApplicationResources" key="jsp.view.title"/>
</h2> 
