...
String formAction = "/CreationCommitElementCompTypeAction.do?datasource=" + datasource + "&rimid=" + rimid;
...
<html>
  <head>
    ...
    {
      window.document.ElementCompTypeForm.action = '/activator<%=moduleConfig%>/CreationFormElementCompTypeAction.do?datasource=<%= datasource %>&rimid=<%= rimid %>&_location_=' + focusthis;
      window.document.ElementCompTypeForm.submit();
    }
    function performCommit()
    {
      window.document.ElementCompTypeForm.action = '/activator<%=moduleConfig%>/CreationCommitElementCompTypeAction.do?datasource=<%= datasource %>&rimid=<%= rimid %>';
      window.document.ElementCompTypeForm.submit();
    }
    function init()
    {
...
com.hp.ov.activator.cr.inventory.ElementCompType beanElementCompType = (com.hp.ov.activator.cr.inventory.ElementCompType) request.getAttribute(ElementCompTypeConstants.ELEMENTCOMPTYPE_BEAN);
      ...
      String Type = beanElementCompType.getType();
                String ElementTypeGroupName = beanElementCompType.getElementtypegroupname();
        String ElementTypeGroupNameLabel = (String) request.getAttribute(ElementCompTypeConstants.ELEMENTTYPEGROUPNAME_LABEL);
ArrayList ElementTypeGroupNameListOfValues = (ArrayList) request.getAttribute(ElementCompTypeConstants.ELEMENTTYPEGROUPNAME_LIST_OF_VALUES);
            String ECType = beanElementCompType.getEctype();
          
%>

<h2 style="width:100%; text-align:center;">
  <bean:message bundle="ElementCompTypeApplicationResources" key="jsp.creation.title"/>
</h2> 
