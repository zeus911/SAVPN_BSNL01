...
String refreshTree = (String) request.getAttribute(IfaceUploadConfigurationConstants.REFRESH_TREE);
%>

<html>
  <head>
    <title><bean:message bundle="IfaceUploadConfigurationApplicationResources" key="<%= IfaceUploadConfigurationConstants.JSP_VIEW_TITLE %>"/></title>
...
nfB.setMaximumFractionDigits(6);
      String Id = StringFacility.replaceAllByHTMLCharacter(beanIfaceUploadConfiguration.getId());
                      boolean Demo_mode = new Boolean(beanIfaceUploadConfiguration.getDemo_mode()).booleanValue();
                      String Message_queue = StringFacility.replaceAllByHTMLCharacter(beanIfaceUploadConfiguration.getMessage_queue());
                %>
<h2 style="width:100%; text-align:center;">
  <bean:message bundle="IfaceUploadConfigurationApplicationResources" key="jsp.view.title"/>
</h2> 
        ...
        <table:cell>
          <bean:message bundle="InventoryResources" key="description.heading"/>
            ...
            <table:cell>
                            ...
                            <%= Message_queue != null? Message_queue : "" %>
                          </table:cell>
            <table:cell>
