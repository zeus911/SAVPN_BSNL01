...
String formAction = "/CreationCommitDL_ElementTypeMappingAction.do?datasource=" + datasource + "&rimid=" + rimid;
...
<html>
  <head>
    ...
    {
      window.document.DL_ElementTypeMappingForm.action = '/activator<%=moduleConfig%>/CreationFormDL_ElementTypeMappingAction.do?datasource=<%= datasource %>&rimid=<%= rimid %>&_location_=' + focusthis;
      window.document.DL_ElementTypeMappingForm.submit();
    }
    function performCommit()
    {
      window.document.DL_ElementTypeMappingForm.action = '/activator<%=moduleConfig%>/CreationCommitDL_ElementTypeMappingAction.do?datasource=<%= datasource %>&rimid=<%= rimid %>';
      window.document.DL_ElementTypeMappingForm.submit();
    }
    function init()
    {
...
<h2 style="width:100%; text-align:center;">
  <bean:message bundle="DL_ElementTypeMappingApplicationResources" key="jsp.creation.title"/>
</h2> 
