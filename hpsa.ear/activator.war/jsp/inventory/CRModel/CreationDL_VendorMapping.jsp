...
String formAction = "/CreationCommitDL_VendorMappingAction.do?datasource=" + datasource + "&rimid=" + rimid;
...
<html>
  <head>
    ...
    {
      window.document.DL_VendorMappingForm.action = '/activator<%=moduleConfig%>/CreationFormDL_VendorMappingAction.do?datasource=<%= datasource %>&rimid=<%= rimid %>&_location_=' + focusthis;
      window.document.DL_VendorMappingForm.submit();
    }
    function performCommit()
    {
      window.document.DL_VendorMappingForm.action = '/activator<%=moduleConfig%>/CreationCommitDL_VendorMappingAction.do?datasource=<%= datasource %>&rimid=<%= rimid %>';
      window.document.DL_VendorMappingForm.submit();
    }
    function init()
    {
...
<h2 style="width:100%; text-align:center;">
  <bean:message bundle="DL_VendorMappingApplicationResources" key="jsp.creation.title"/>
</h2> 
...
<html:form action="<%= formAction %>" style="text-align:center;">
    <table:table>
      ...
      <html:hidden property="refreshTreeRimid" value="<%= (String)request.getParameter(\"refreshTreeRimid\") %>"/>
              ...
              <table:cell>
                                                                        <html:text  property="nnmi_vendor" size="24" value="<%= NNMi_Vendor %>"/>
                                                </table:cell>
              <table:cell>
