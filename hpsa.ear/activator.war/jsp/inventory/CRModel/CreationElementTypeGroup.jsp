...
String formAction = "/CreationCommitElementTypeGroupAction.do?datasource=" + datasource + "&rimid=" + rimid;
...
<html>
  <head>
    ...
    {
      window.document.ElementTypeGroupForm.action = '/activator<%=moduleConfig%>/CreationFormElementTypeGroupAction.do?datasource=<%= datasource %>&rimid=<%= rimid %>&_location_=' + focusthis;
      window.document.ElementTypeGroupForm.submit();
    }
    function performCommit()
    {
      window.document.ElementTypeGroupForm.action = '/activator<%=moduleConfig%>/CreationCommitElementTypeGroupAction.do?datasource=<%= datasource %>&rimid=<%= rimid %>';
      window.document.ElementTypeGroupForm.submit();
    }
    function init()
    {
...
<h2 style="width:100%; text-align:center;">
  <bean:message bundle="ElementTypeGroupApplicationResources" key="jsp.creation.title"/>
</h2> 
