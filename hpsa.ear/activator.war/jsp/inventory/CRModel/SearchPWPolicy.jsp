...
String tabName = (String) request.getParameter(PWPolicyConstants.TAB_NAME);
...
<script>
function clearForm() {
var formObj = document.PWPolicyFormSearch;
...
if (element.type == 'select-one') { element.selectedIndex = -1; }
  ...
  var checkfalse=false;
                    if(document.getElementsByName("pwpolicyid___hide")[0].checked) {
                            ...
                            if(document.getElementsByName("username___hide")[0].checked) {
                                ...
                                if(checkfalse){
    alert("<bean:message bundle="PWPolicyApplicationResources" key="<%= PWPolicyConstants.JSP_SEARCH_NO_SHOW %>"/>");
  }else{
    window.document.PWPolicyFormSearch.action = '/activator<%=moduleConfig%>/SearchCommitPWPolicyAction.do?datasource=<%= datasource %>&tab_name=<%= tabName %>&vi=<%= viParameter%>&view=<%= viewParameter %>&ndid=<%= ndidParameter %>';
    window.document.PWPolicyFormSearch.submit();
  }
  }
</script>
...
if (session == null || session.getValue(PWPolicyConstants.USER) == null) {
  response.sendRedirect(PWPolicyConstants.NULL_SESSION);
  return;
}
...
<%
      String PWPolicyId = form.getPwpolicyid();
...
<h2 style="width:100%; text-align:center;">
  <bean:message bundle="PWPolicyApplicationResources" key="jsp.search.title"/>
</h2> 
...
<% String searchFormAction = "/SearchCommitPWPolicyAction.do?datasource="+datasource+"&tab_name="+tabName+"&vi="+ viParameter+"&view="+ viewParameter +"&ndid="+ ndidParameter ;%>
      ...
      <table:header>
        ...
        <table:cell>
          <bean:message bundle="InventoryResources" key="description.heading"/>
            ...
            <table:cell>
              <center>
                <html:checkbox property="pwpolicyid___hide" value="true"/>
              </center>
            </table:cell>
            ...
            <table:cell>
                              <html:text property="pwpolicyid" size="16" value="<%= PWPolicyId %>"/>
                                          </table:cell>
