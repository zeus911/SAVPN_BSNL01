...
<h2 style="width:100%; text-align:center;">
  <bean:message bundle="DL_LinkApplicationResources" key="jsp.update.title"/>
</h2> 
      ...
      <html:hidden property="refreshTreeRimid" value="<%= (String)request.getParameter(\"refreshTreeRimid\") %>"/>
              ...
              <table:cell>
                                                      <html:hidden property="ne1_nnmi_id" value="<%= NE1_NNMi_Id %>"/>
                                                        <html:text disabled="true" property="ne1_nnmi_id" size="24" value="<%= NE1_NNMi_Id %>"/>
                                                </table:cell>
              <table:cell>
              ...
              <table:cell>
                                                      <html:hidden property="tp1_nnmi_id" value="<%= TP1_NNMi_Id %>"/>
                                                        <html:text disabled="true" property="tp1_nnmi_id" size="24" value="<%= TP1_NNMi_Id %>"/>
                                                </table:cell>
              <table:cell>
              ...
              <table:cell>
                                                      <html:hidden property="ne2_nnmi_id" value="<%= NE2_NNMi_Id %>"/>
                                                        <html:text disabled="true" property="ne2_nnmi_id" size="24" value="<%= NE2_NNMi_Id %>"/>
                                                </table:cell>
              <table:cell>
              ...
              <table:cell>
                                                      <html:hidden property="tp2_nnmi_id" value="<%= TP2_NNMi_Id %>"/>
                                                        <html:text disabled="true" property="tp2_nnmi_id" size="24" value="<%= TP2_NNMi_Id %>"/>
                                                </table:cell>
              <table:cell>
