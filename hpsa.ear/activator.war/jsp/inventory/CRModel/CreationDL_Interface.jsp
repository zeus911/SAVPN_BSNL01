...
String formAction = "/CreationCommitDL_InterfaceAction.do?datasource=" + datasource + "&rimid=" + rimid;
...
<html>
  <head>
    ...
    {
      window.document.DL_InterfaceForm.action = '/activator<%=moduleConfig%>/CreationFormDL_InterfaceAction.do?datasource=<%= datasource %>&rimid=<%= rimid %>&_location_=' + focusthis;
      window.document.DL_InterfaceForm.submit();
    }
    function performCommit()
    {
      window.document.DL_InterfaceForm.action = '/activator<%=moduleConfig%>/CreationCommitDL_InterfaceAction.do?datasource=<%= datasource %>&rimid=<%= rimid %>';
      window.document.DL_InterfaceForm.submit();
    }
    function init()
    {
...
<h2 style="width:100%; text-align:center;">
  <bean:message bundle="DL_InterfaceApplicationResources" key="jsp.creation.title"/>
</h2> 
