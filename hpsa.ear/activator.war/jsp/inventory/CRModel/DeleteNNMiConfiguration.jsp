...
<html>
  <head>
    <title><bean:message bundle="NNMiConfigurationApplicationResources" key="<%= NNMiConfigurationConstants.JSP_DELETE_TITLE %>"/></title>
    ...
    {
      window.document.NNMiConfigurationForm.action = '/activator<%=moduleConfig%>/DeleteCommitNNMiConfigurationAction.do?datasource=<%= datasource %>&rimid=<%= rimid %>';
      window.document.NNMiConfigurationForm.submit();
    }
    function init()
    {
      var confirm = new HPSAConfirm('Confirm','<bean:message bundle="NNMiConfigurationApplicationResources" key="delete.confirm"/>', '<bean:message bundle="InventoryResources" key="confirm.ok_button.label"/>', '<bean:message bundle="InventoryResources" key="confirm.cancel_button.label"/>');
...
<h2 style="width:100%; text-align:center;">
    <bean:message bundle="NNMiConfigurationApplicationResources" key="jsp.delete.title"/>
</h2> 
...
%>
    ...
    <html:form action="/DeleteCommitNNMiConfigurationAction.do">
