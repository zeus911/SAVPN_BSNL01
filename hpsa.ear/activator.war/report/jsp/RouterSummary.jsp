...
%>
	...
	<table width="16%" align="right" border="0">
		...
		<tr>
			<td align="left" width="50%"
				style="font-family: Verdana, Helvetica, Arial, Sans-serif; font-size: 9pt;">
				<%if(startIndex != 0) {%> <a
				href="RouterSummary.jsp?startIndex=<%=startIndex-numRecordsPerPage%>&txtnumrec=<%=numRecordsPerPage%>"><b>Previous</b></a>
			...
			<td align="left" width="50%"
				style="font-family: Verdana, Helvetica, Arial, Sans-serif; font-size: 9pt;">
				<%if(startIndex + numRecordsPerPage < numRows){%> <a
				href="RouterSummary.jsp?startIndex=<%=startIndex+numRecordsPerPage %>&txtnumrec=<%=numRecordsPerPage%>"><b>Next</b></a>
	...
	<table align="right" cellpadding='1' cellspacing='10' border='0'>
		<tr>
          ...
          <a href="ToExcelRouterSummary.jsp?exportToExcel=YES" style="font-size: 10pt; font-family: Verdana, Helvetica, Arial, Sans-serif;"><b>Export to Excel</b></a>
