...
###############################################################################
#
# $Source: /tmp/vpn/SA_VPN_SP/jboss/server/default/deploy/crmportal.sar/crm.war/forms/Createlayer3-VPN.xsl,v $
# $Revision: 1.8 $
		...
		<msg msg_id="{$messageid}">
			...
			<body>
				<Service Service_id="{$serviceid}">
					<VPN VPN_type="L3VPN" VPN_Address_family="{$AddressFamily}">
						<VPN_name>
