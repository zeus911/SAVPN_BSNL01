...
<%try {
	...
	existingPrefixList = (String)serviceParameters.get("PREFIX_Routes");
  } catch (Exception e) { %>
    <B><bean:message key="err.staticroutes" /></B>: <%= e.getMessage () %>.
<%  return;
  } 
  if (existingPrefixList != null && !existingPrefixList.equals(""))
	      { %>
    <tr height="30">
...
<%  StringTokenizer routes = new StringTokenizer(existingPrefixList, ",");
...
<% } %>
   ...
   <input type="hidden" name="Remove_Prefix_List" value="true">
