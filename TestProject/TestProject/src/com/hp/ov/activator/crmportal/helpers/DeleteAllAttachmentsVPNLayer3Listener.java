...
public class DeleteAllAttachmentsVPNLayer3Listener implements StateListener
{
	...
	public int proccedState(Connection connection, String serviceId, String state, String data) throws Exception 
	{
		...
		try 
		{
			...
			// Find the last attachment that still exists
			...
			{			
				...
				ServiceUtils.saveOrUpdateParameter(connection, attachment.getServiceid(), Constants.PARAMETER_LAST_COMMIT, DeleteAllAttachmentsAttachmentLayer3Listener.class.getName());
				...
				catch (IOException e) 
				{
					...
					{
						logger.error("Exception in DeleteAllAttachmentsVPNLayer3Listener listener" + ex);
					}
				}
