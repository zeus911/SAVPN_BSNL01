...
public class ModifyQoSBulkAttachmentLayer2Listener implements StateListener
{
	...
	public int proccedState(Connection connection, String serviceId, String state, String data) throws Exception 
	{
		...
		if (state.indexOf("Ok") > -1)
		{
			...
			catch (IOException e) 
			{
				...
				{
					logger.error("Exception in ModifyQoSBulkAttachmentLayer2Listener listener" + ex);
				}
			}
		}
